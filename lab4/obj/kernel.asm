...
ffffffffc020004c:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004e:	6af040ef          	jal	ra,ffffffffc0204efc <memset>
...
ffffffffc020005a:	f0258593          	addi	a1,a1,-254 # ffffffffc0204f58 <etext+0x2>
ffffffffc020005e:	00005517          	auipc	a0,0x5
ffffffffc0200062:	f1a50513          	addi	a0,a0,-230 # ffffffffc0204f78 <etext+0x22>
...
ffffffffc020007e:	68a040ef          	jal	ra,ffffffffc0204708 <proc_init>
...
ffffffffc0200092:	06b040ef          	jal	ra,ffffffffc02048fc <cpu_idle>
...
ffffffffc02000b2:	ed250513          	addi	a0,a0,-302 # ffffffffc0204f80 <etext+0x2a>
...
ffffffffc0200180:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200182:	151040ef          	jal	ra,ffffffffc0204ad2 <vprintfmt>
    return cnt;
}
...
ffffffffc02001b4:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001b6:	11d040ef          	jal	ra,ffffffffc0204ad2 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc02001dc:	de050513          	addi	a0,a0,-544 # ffffffffc0204fb8 <etext+0x62>
void print_kerninfo(void) {
...
ffffffffc02001f2:	dea50513          	addi	a0,a0,-534 # ffffffffc0204fd8 <etext+0x82>
ffffffffc02001f6:	f99ff0ef          	jal	ra,ffffffffc020018e <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc02001fa:	00005597          	auipc	a1,0x5
ffffffffc02001fe:	d5c58593          	addi	a1,a1,-676 # ffffffffc0204f56 <etext>
ffffffffc0200202:	00005517          	auipc	a0,0x5
ffffffffc0200206:	df650513          	addi	a0,a0,-522 # ffffffffc0204ff8 <etext+0xa2>
...
ffffffffc020021a:	e0250513          	addi	a0,a0,-510 # ffffffffc0205018 <etext+0xc2>
...
ffffffffc020022e:	e0e50513          	addi	a0,a0,-498 # ffffffffc0205038 <etext+0xe2>
...
ffffffffc020025c:	e0050513          	addi	a0,a0,-512 # ffffffffc0205058 <etext+0x102>
}
...
ffffffffc020026c:	d2060613          	addi	a2,a2,-736 # ffffffffc0204f88 <etext+0x32>
ffffffffc0200270:	04d00593          	li	a1,77
ffffffffc0200274:	00005517          	auipc	a0,0x5
ffffffffc0200278:	d2c50513          	addi	a0,a0,-724 # ffffffffc0204fa0 <etext+0x4a>
void print_stackframe(void) {
...
ffffffffc0200288:	ee460613          	addi	a2,a2,-284 # ffffffffc0205168 <commands+0xe0>
ffffffffc020028c:	00005597          	auipc	a1,0x5
ffffffffc0200290:	efc58593          	addi	a1,a1,-260 # ffffffffc0205188 <commands+0x100>
ffffffffc0200294:	00005517          	auipc	a0,0x5
ffffffffc0200298:	efc50513          	addi	a0,a0,-260 # ffffffffc0205190 <commands+0x108>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02002a6:	efe60613          	addi	a2,a2,-258 # ffffffffc02051a0 <commands+0x118>
ffffffffc02002aa:	00005597          	auipc	a1,0x5
ffffffffc02002ae:	f1e58593          	addi	a1,a1,-226 # ffffffffc02051c8 <commands+0x140>
ffffffffc02002b2:	00005517          	auipc	a0,0x5
ffffffffc02002b6:	ede50513          	addi	a0,a0,-290 # ffffffffc0205190 <commands+0x108>
ffffffffc02002ba:	ed5ff0ef          	jal	ra,ffffffffc020018e <cprintf>
ffffffffc02002be:	00005617          	auipc	a2,0x5
ffffffffc02002c2:	f1a60613          	addi	a2,a2,-230 # ffffffffc02051d8 <commands+0x150>
ffffffffc02002c6:	00005597          	auipc	a1,0x5
ffffffffc02002ca:	f3258593          	addi	a1,a1,-206 # ffffffffc02051f8 <commands+0x170>
ffffffffc02002ce:	00005517          	auipc	a0,0x5
ffffffffc02002d2:	ec250513          	addi	a0,a0,-318 # ffffffffc0205190 <commands+0x108>
...
ffffffffc020030c:	dc850513          	addi	a0,a0,-568 # ffffffffc02050d0 <commands+0x48>
kmonitor(struct trapframe *tf) {
...
ffffffffc020032e:	dce50513          	addi	a0,a0,-562 # ffffffffc02050f8 <commands+0x70>
...
ffffffffc0200350:	d3cc8c93          	addi	s9,s9,-708 # ffffffffc0205088 <commands>
        if ((buf = readline("K> ")) != NULL) {
ffffffffc0200354:	00005997          	auipc	s3,0x5
ffffffffc0200358:	dcc98993          	addi	s3,s3,-564 # ffffffffc0205120 <commands+0x98>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020035c:	00005917          	auipc	s2,0x5
ffffffffc0200360:	dcc90913          	addi	s2,s2,-564 # ffffffffc0205128 <commands+0xa0>
        if (argc == MAXARGS - 1) {
ffffffffc0200364:	4a3d                	li	s4,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200366:	00005b17          	auipc	s6,0x5
ffffffffc020036a:	dcab0b13          	addi	s6,s6,-566 # ffffffffc0205130 <commands+0xa8>
    if (argc == 0) {
ffffffffc020036e:	00005a97          	auipc	s5,0x5
ffffffffc0200372:	e1aa8a93          	addi	s5,s5,-486 # ffffffffc0205188 <commands+0x100>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc020038c:	353040ef          	jal	ra,ffffffffc0204ede <strchr>
...
ffffffffc02003a6:	ce6d0d13          	addi	s10,s10,-794 # ffffffffc0205088 <commands>
    if (argc == 0) {
...
ffffffffc02003b0:	305040ef          	jal	ra,ffffffffc0204eb4 <strcmp>
...
ffffffffc02003c4:	2f1040ef          	jal	ra,ffffffffc0204eb4 <strcmp>
...
ffffffffc020042a:	2b5040ef          	jal	ra,ffffffffc0204ede <strchr>
...
ffffffffc0200446:	d0e50513          	addi	a0,a0,-754 # ffffffffc0205150 <commands+0xc8>
...
ffffffffc0200486:	d8650513          	addi	a0,a0,-634 # ffffffffc0205208 <commands+0x180>
    va_start(ap, fmt);
...
ffffffffc020049c:	cf850513          	addi	a0,a0,-776 # ffffffffc0206190 <default_pmm_manager+0x500>
...
ffffffffc02004da:	d5250513          	addi	a0,a0,-686 # ffffffffc0205228 <commands+0x1a0>
    ticks = 0;
...
ffffffffc020059e:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc02005a0:	16f040ef          	jal	ra,ffffffffc0204f0e <memcpy>
    return 0;
}
...
ffffffffc02005c4:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02005c6:	149040ef          	jal	ra,ffffffffc0204f0e <memcpy>
    return 0;
}
...
ffffffffc0200614:	f1050513          	addi	a0,a0,-240 # ffffffffc0205520 <commands+0x498>
...
ffffffffc020063e:	f0660613          	addi	a2,a2,-250 # ffffffffc0205540 <commands+0x4b8>
ffffffffc0200642:	06200593          	li	a1,98
ffffffffc0200646:	00005517          	auipc	a0,0x5
ffffffffc020064a:	f1250513          	addi	a0,a0,-238 # ffffffffc0205558 <commands+0x4d0>
...
ffffffffc0200678:	efc50513          	addi	a0,a0,-260 # ffffffffc0205570 <commands+0x4e8>
void print_regs(struct pushregs *gpr) {
...
ffffffffc0200688:	f0450513          	addi	a0,a0,-252 # ffffffffc0205588 <commands+0x500>
...
ffffffffc0200696:	f0e50513          	addi	a0,a0,-242 # ffffffffc02055a0 <commands+0x518>
...
ffffffffc02006a4:	f1850513          	addi	a0,a0,-232 # ffffffffc02055b8 <commands+0x530>
...
ffffffffc02006b2:	f2250513          	addi	a0,a0,-222 # ffffffffc02055d0 <commands+0x548>
...
ffffffffc02006c0:	f2c50513          	addi	a0,a0,-212 # ffffffffc02055e8 <commands+0x560>
...
ffffffffc02006ce:	f3650513          	addi	a0,a0,-202 # ffffffffc0205600 <commands+0x578>
...
ffffffffc02006dc:	f4050513          	addi	a0,a0,-192 # ffffffffc0205618 <commands+0x590>
...
ffffffffc02006ea:	f4a50513          	addi	a0,a0,-182 # ffffffffc0205630 <commands+0x5a8>
...
ffffffffc02006f8:	f5450513          	addi	a0,a0,-172 # ffffffffc0205648 <commands+0x5c0>
...
ffffffffc0200706:	f5e50513          	addi	a0,a0,-162 # ffffffffc0205660 <commands+0x5d8>
...
ffffffffc0200714:	f6850513          	addi	a0,a0,-152 # ffffffffc0205678 <commands+0x5f0>
...
ffffffffc0200722:	f7250513          	addi	a0,a0,-142 # ffffffffc0205690 <commands+0x608>
...
ffffffffc0200730:	f7c50513          	addi	a0,a0,-132 # ffffffffc02056a8 <commands+0x620>
...
ffffffffc020073e:	f8650513          	addi	a0,a0,-122 # ffffffffc02056c0 <commands+0x638>
...
ffffffffc020074c:	f9050513          	addi	a0,a0,-112 # ffffffffc02056d8 <commands+0x650>
...
ffffffffc020075a:	f9a50513          	addi	a0,a0,-102 # ffffffffc02056f0 <commands+0x668>
...
ffffffffc0200768:	fa450513          	addi	a0,a0,-92 # ffffffffc0205708 <commands+0x680>
...
ffffffffc0200776:	fae50513          	addi	a0,a0,-82 # ffffffffc0205720 <commands+0x698>
...
ffffffffc0200784:	fb850513          	addi	a0,a0,-72 # ffffffffc0205738 <commands+0x6b0>
...
ffffffffc0200792:	fc250513          	addi	a0,a0,-62 # ffffffffc0205750 <commands+0x6c8>
...
ffffffffc02007a0:	fcc50513          	addi	a0,a0,-52 # ffffffffc0205768 <commands+0x6e0>
...
ffffffffc02007ae:	fd650513          	addi	a0,a0,-42 # ffffffffc0205780 <commands+0x6f8>
...
ffffffffc02007bc:	fe050513          	addi	a0,a0,-32 # ffffffffc0205798 <commands+0x710>
...
ffffffffc02007ca:	fea50513          	addi	a0,a0,-22 # ffffffffc02057b0 <commands+0x728>
...
ffffffffc02007d8:	ff450513          	addi	a0,a0,-12 # ffffffffc02057c8 <commands+0x740>
...
ffffffffc02007e6:	ffe50513          	addi	a0,a0,-2 # ffffffffc02057e0 <commands+0x758>
...
ffffffffc02007f4:	00850513          	addi	a0,a0,8 # ffffffffc02057f8 <commands+0x770>
...
ffffffffc0200802:	01250513          	addi	a0,a0,18 # ffffffffc0205810 <commands+0x788>
...
ffffffffc0200810:	01c50513          	addi	a0,a0,28 # ffffffffc0205828 <commands+0x7a0>
...
ffffffffc020081e:	02650513          	addi	a0,a0,38 # ffffffffc0205840 <commands+0x7b8>
...
ffffffffc0200830:	02c50513          	addi	a0,a0,44 # ffffffffc0205858 <commands+0x7d0>
}
...
ffffffffc0200846:	02e50513          	addi	a0,a0,46 # ffffffffc0205870 <commands+0x7e8>
void print_trapframe(struct trapframe *tf) {
...
ffffffffc020085e:	02e50513          	addi	a0,a0,46 # ffffffffc0205888 <commands+0x800>
...
ffffffffc020086e:	03650513          	addi	a0,a0,54 # ffffffffc02058a0 <commands+0x818>
...
ffffffffc020087e:	03e50513          	addi	a0,a0,62 # ffffffffc02058b8 <commands+0x830>
...
ffffffffc0200892:	04250513          	addi	a0,a0,66 # ffffffffc02058d0 <commands+0x848>
}
...
ffffffffc02008b0:	99870713          	addi	a4,a4,-1640 # ffffffffc0205244 <commands+0x1bc>
...
ffffffffc02008c2:	c1250513          	addi	a0,a0,-1006 # ffffffffc02054d0 <commands+0x448>
ffffffffc02008c6:	8c9ff06f          	j	ffffffffc020018e <cprintf>
            cprintf("Hypervisor software interrupt\n");
ffffffffc02008ca:	00005517          	auipc	a0,0x5
ffffffffc02008ce:	be650513          	addi	a0,a0,-1050 # ffffffffc02054b0 <commands+0x428>
ffffffffc02008d2:	8bdff06f          	j	ffffffffc020018e <cprintf>
            cprintf("User software interrupt\n");
ffffffffc02008d6:	00005517          	auipc	a0,0x5
ffffffffc02008da:	b9a50513          	addi	a0,a0,-1126 # ffffffffc0205470 <commands+0x3e8>
ffffffffc02008de:	8b1ff06f          	j	ffffffffc020018e <cprintf>
            cprintf("Supervisor software interrupt\n");
ffffffffc02008e2:	00005517          	auipc	a0,0x5
ffffffffc02008e6:	bae50513          	addi	a0,a0,-1106 # ffffffffc0205490 <commands+0x408>
...
ffffffffc02008f2:	c1250513          	addi	a0,a0,-1006 # ffffffffc0205500 <commands+0x478>
...
ffffffffc0200934:	bc050513          	addi	a0,a0,-1088 # ffffffffc02054f0 <commands+0x468>
}
...
ffffffffc020094c:	92c70713          	addi	a4,a4,-1748 # ffffffffc0205274 <commands+0x1ec>
...
ffffffffc0200968:	af450513          	addi	a0,a0,-1292 # ffffffffc0205458 <commands+0x3d0>
...
ffffffffc020098a:	93250513          	addi	a0,a0,-1742 # ffffffffc02052b8 <commands+0x230>
}
...
ffffffffc02009e4:	97860613          	addi	a2,a2,-1672 # ffffffffc0205358 <commands+0x2d0>
ffffffffc02009e8:	0b300593          	li	a1,179
ffffffffc02009ec:	00005517          	auipc	a0,0x5
ffffffffc02009f0:	b6c50513          	addi	a0,a0,-1172 # ffffffffc0205558 <commands+0x4d0>
ffffffffc02009f4:	a5dff0ef          	jal	ra,ffffffffc0200450 <__panic>
            cprintf("AMO address misaligned\n");
ffffffffc02009f8:	00005517          	auipc	a0,0x5
ffffffffc02009fc:	98050513          	addi	a0,a0,-1664 # ffffffffc0205378 <commands+0x2f0>
ffffffffc0200a00:	b779                	j	ffffffffc020098e <exception_handler+0x50>
            cprintf("Store/AMO access fault\n");
ffffffffc0200a02:	00005517          	auipc	a0,0x5
ffffffffc0200a06:	98e50513          	addi	a0,a0,-1650 # ffffffffc0205390 <commands+0x308>
...
ffffffffc0200a8e:	8ce60613          	addi	a2,a2,-1842 # ffffffffc0205358 <commands+0x2d0>
ffffffffc0200a92:	0d300593          	li	a1,211
ffffffffc0200a96:	00005517          	auipc	a0,0x5
ffffffffc0200a9a:	ac250513          	addi	a0,a0,-1342 # ffffffffc0205558 <commands+0x4d0>
...
ffffffffc0200abe:	89e60613          	addi	a2,a2,-1890 # ffffffffc0205358 <commands+0x2d0>
ffffffffc0200ac2:	0da00593          	li	a1,218
ffffffffc0200ac6:	00005517          	auipc	a0,0x5
ffffffffc0200aca:	a9250513          	addi	a0,a0,-1390 # ffffffffc0205558 <commands+0x4d0>
...
ffffffffc0200c68:	42c70713          	addi	a4,a4,1068 # ffffffffc0207090 <nbase>
...
ffffffffc0200ef0:	9fc68693          	addi	a3,a3,-1540 # ffffffffc02058e8 <commands+0x860>
ffffffffc0200ef4:	00005617          	auipc	a2,0x5
ffffffffc0200ef8:	a0460613          	addi	a2,a2,-1532 # ffffffffc02058f8 <commands+0x870>
ffffffffc0200efc:	0f000593          	li	a1,240
ffffffffc0200f00:	00005517          	auipc	a0,0x5
ffffffffc0200f04:	a1050513          	addi	a0,a0,-1520 # ffffffffc0205910 <commands+0x888>
ffffffffc0200f08:	d48ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0200f0c:	00005697          	auipc	a3,0x5
ffffffffc0200f10:	a9c68693          	addi	a3,a3,-1380 # ffffffffc02059a8 <commands+0x920>
ffffffffc0200f14:	00005617          	auipc	a2,0x5
ffffffffc0200f18:	9e460613          	addi	a2,a2,-1564 # ffffffffc02058f8 <commands+0x870>
ffffffffc0200f1c:	0bd00593          	li	a1,189
ffffffffc0200f20:	00005517          	auipc	a0,0x5
ffffffffc0200f24:	9f050513          	addi	a0,a0,-1552 # ffffffffc0205910 <commands+0x888>
ffffffffc0200f28:	d28ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0200f2c:	00005697          	auipc	a3,0x5
ffffffffc0200f30:	aa468693          	addi	a3,a3,-1372 # ffffffffc02059d0 <commands+0x948>
ffffffffc0200f34:	00005617          	auipc	a2,0x5
ffffffffc0200f38:	9c460613          	addi	a2,a2,-1596 # ffffffffc02058f8 <commands+0x870>
ffffffffc0200f3c:	0be00593          	li	a1,190
ffffffffc0200f40:	00005517          	auipc	a0,0x5
ffffffffc0200f44:	9d050513          	addi	a0,a0,-1584 # ffffffffc0205910 <commands+0x888>
ffffffffc0200f48:	d08ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0200f4c:	00005697          	auipc	a3,0x5
ffffffffc0200f50:	ac468693          	addi	a3,a3,-1340 # ffffffffc0205a10 <commands+0x988>
ffffffffc0200f54:	00005617          	auipc	a2,0x5
ffffffffc0200f58:	9a460613          	addi	a2,a2,-1628 # ffffffffc02058f8 <commands+0x870>
ffffffffc0200f5c:	0c000593          	li	a1,192
ffffffffc0200f60:	00005517          	auipc	a0,0x5
ffffffffc0200f64:	9b050513          	addi	a0,a0,-1616 # ffffffffc0205910 <commands+0x888>
ffffffffc0200f68:	ce8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(!list_empty(&free_list));
ffffffffc0200f6c:	00005697          	auipc	a3,0x5
ffffffffc0200f70:	b2c68693          	addi	a3,a3,-1236 # ffffffffc0205a98 <commands+0xa10>
ffffffffc0200f74:	00005617          	auipc	a2,0x5
ffffffffc0200f78:	98460613          	addi	a2,a2,-1660 # ffffffffc02058f8 <commands+0x870>
ffffffffc0200f7c:	0d900593          	li	a1,217
ffffffffc0200f80:	00005517          	auipc	a0,0x5
ffffffffc0200f84:	99050513          	addi	a0,a0,-1648 # ffffffffc0205910 <commands+0x888>
ffffffffc0200f88:	cc8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200f8c:	00005697          	auipc	a3,0x5
ffffffffc0200f90:	9bc68693          	addi	a3,a3,-1604 # ffffffffc0205948 <commands+0x8c0>
ffffffffc0200f94:	00005617          	auipc	a2,0x5
ffffffffc0200f98:	96460613          	addi	a2,a2,-1692 # ffffffffc02058f8 <commands+0x870>
ffffffffc0200f9c:	0d200593          	li	a1,210
ffffffffc0200fa0:	00005517          	auipc	a0,0x5
ffffffffc0200fa4:	97050513          	addi	a0,a0,-1680 # ffffffffc0205910 <commands+0x888>
ffffffffc0200fa8:	ca8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(nr_free == 3);
ffffffffc0200fac:	00005697          	auipc	a3,0x5
ffffffffc0200fb0:	adc68693          	addi	a3,a3,-1316 # ffffffffc0205a88 <commands+0xa00>
ffffffffc0200fb4:	00005617          	auipc	a2,0x5
ffffffffc0200fb8:	94460613          	addi	a2,a2,-1724 # ffffffffc02058f8 <commands+0x870>
ffffffffc0200fbc:	0d000593          	li	a1,208
ffffffffc0200fc0:	00005517          	auipc	a0,0x5
ffffffffc0200fc4:	95050513          	addi	a0,a0,-1712 # ffffffffc0205910 <commands+0x888>
ffffffffc0200fc8:	c88ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200fcc:	00005697          	auipc	a3,0x5
ffffffffc0200fd0:	aa468693          	addi	a3,a3,-1372 # ffffffffc0205a70 <commands+0x9e8>
ffffffffc0200fd4:	00005617          	auipc	a2,0x5
ffffffffc0200fd8:	92460613          	addi	a2,a2,-1756 # ffffffffc02058f8 <commands+0x870>
ffffffffc0200fdc:	0cb00593          	li	a1,203
ffffffffc0200fe0:	00005517          	auipc	a0,0x5
ffffffffc0200fe4:	93050513          	addi	a0,a0,-1744 # ffffffffc0205910 <commands+0x888>
ffffffffc0200fe8:	c68ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc0200fec:	00005697          	auipc	a3,0x5
ffffffffc0200ff0:	a6468693          	addi	a3,a3,-1436 # ffffffffc0205a50 <commands+0x9c8>
ffffffffc0200ff4:	00005617          	auipc	a2,0x5
ffffffffc0200ff8:	90460613          	addi	a2,a2,-1788 # ffffffffc02058f8 <commands+0x870>
ffffffffc0200ffc:	0c200593          	li	a1,194
ffffffffc0201000:	00005517          	auipc	a0,0x5
ffffffffc0201004:	91050513          	addi	a0,a0,-1776 # ffffffffc0205910 <commands+0x888>
ffffffffc0201008:	c48ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(p0 != NULL);
ffffffffc020100c:	00005697          	auipc	a3,0x5
ffffffffc0201010:	ad468693          	addi	a3,a3,-1324 # ffffffffc0205ae0 <commands+0xa58>
ffffffffc0201014:	00005617          	auipc	a2,0x5
ffffffffc0201018:	8e460613          	addi	a2,a2,-1820 # ffffffffc02058f8 <commands+0x870>
ffffffffc020101c:	0f800593          	li	a1,248
ffffffffc0201020:	00005517          	auipc	a0,0x5
ffffffffc0201024:	8f050513          	addi	a0,a0,-1808 # ffffffffc0205910 <commands+0x888>
ffffffffc0201028:	c28ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(nr_free == 0);
ffffffffc020102c:	00005697          	auipc	a3,0x5
ffffffffc0201030:	aa468693          	addi	a3,a3,-1372 # ffffffffc0205ad0 <commands+0xa48>
ffffffffc0201034:	00005617          	auipc	a2,0x5
ffffffffc0201038:	8c460613          	addi	a2,a2,-1852 # ffffffffc02058f8 <commands+0x870>
ffffffffc020103c:	0df00593          	li	a1,223
ffffffffc0201040:	00005517          	auipc	a0,0x5
ffffffffc0201044:	8d050513          	addi	a0,a0,-1840 # ffffffffc0205910 <commands+0x888>
ffffffffc0201048:	c08ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(alloc_page() == NULL);
ffffffffc020104c:	00005697          	auipc	a3,0x5
ffffffffc0201050:	a2468693          	addi	a3,a3,-1500 # ffffffffc0205a70 <commands+0x9e8>
ffffffffc0201054:	00005617          	auipc	a2,0x5
ffffffffc0201058:	8a460613          	addi	a2,a2,-1884 # ffffffffc02058f8 <commands+0x870>
ffffffffc020105c:	0dd00593          	li	a1,221
ffffffffc0201060:	00005517          	auipc	a0,0x5
ffffffffc0201064:	8b050513          	addi	a0,a0,-1872 # ffffffffc0205910 <commands+0x888>
ffffffffc0201068:	be8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc020106c:	00005697          	auipc	a3,0x5
ffffffffc0201070:	a4468693          	addi	a3,a3,-1468 # ffffffffc0205ab0 <commands+0xa28>
ffffffffc0201074:	00005617          	auipc	a2,0x5
ffffffffc0201078:	88460613          	addi	a2,a2,-1916 # ffffffffc02058f8 <commands+0x870>
ffffffffc020107c:	0dc00593          	li	a1,220
ffffffffc0201080:	00005517          	auipc	a0,0x5
ffffffffc0201084:	89050513          	addi	a0,a0,-1904 # ffffffffc0205910 <commands+0x888>
ffffffffc0201088:	bc8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc020108c:	00005697          	auipc	a3,0x5
ffffffffc0201090:	8bc68693          	addi	a3,a3,-1860 # ffffffffc0205948 <commands+0x8c0>
ffffffffc0201094:	00005617          	auipc	a2,0x5
ffffffffc0201098:	86460613          	addi	a2,a2,-1948 # ffffffffc02058f8 <commands+0x870>
ffffffffc020109c:	0b900593          	li	a1,185
ffffffffc02010a0:	00005517          	auipc	a0,0x5
ffffffffc02010a4:	87050513          	addi	a0,a0,-1936 # ffffffffc0205910 <commands+0x888>
ffffffffc02010a8:	ba8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02010ac:	00005697          	auipc	a3,0x5
ffffffffc02010b0:	9c468693          	addi	a3,a3,-1596 # ffffffffc0205a70 <commands+0x9e8>
ffffffffc02010b4:	00005617          	auipc	a2,0x5
ffffffffc02010b8:	84460613          	addi	a2,a2,-1980 # ffffffffc02058f8 <commands+0x870>
ffffffffc02010bc:	0d600593          	li	a1,214
ffffffffc02010c0:	00005517          	auipc	a0,0x5
ffffffffc02010c4:	85050513          	addi	a0,a0,-1968 # ffffffffc0205910 <commands+0x888>
ffffffffc02010c8:	b88ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc02010cc:	00005697          	auipc	a3,0x5
ffffffffc02010d0:	8bc68693          	addi	a3,a3,-1860 # ffffffffc0205988 <commands+0x900>
ffffffffc02010d4:	00005617          	auipc	a2,0x5
ffffffffc02010d8:	82460613          	addi	a2,a2,-2012 # ffffffffc02058f8 <commands+0x870>
ffffffffc02010dc:	0d400593          	li	a1,212
ffffffffc02010e0:	00005517          	auipc	a0,0x5
ffffffffc02010e4:	83050513          	addi	a0,a0,-2000 # ffffffffc0205910 <commands+0x888>
ffffffffc02010e8:	b68ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc02010ec:	00005697          	auipc	a3,0x5
ffffffffc02010f0:	87c68693          	addi	a3,a3,-1924 # ffffffffc0205968 <commands+0x8e0>
ffffffffc02010f4:	00005617          	auipc	a2,0x5
ffffffffc02010f8:	80460613          	addi	a2,a2,-2044 # ffffffffc02058f8 <commands+0x870>
ffffffffc02010fc:	0d300593          	li	a1,211
ffffffffc0201100:	00005517          	auipc	a0,0x5
ffffffffc0201104:	81050513          	addi	a0,a0,-2032 # ffffffffc0205910 <commands+0x888>
ffffffffc0201108:	b48ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc020110c:	00005697          	auipc	a3,0x5
ffffffffc0201110:	87c68693          	addi	a3,a3,-1924 # ffffffffc0205988 <commands+0x900>
ffffffffc0201114:	00004617          	auipc	a2,0x4
ffffffffc0201118:	7e460613          	addi	a2,a2,2020 # ffffffffc02058f8 <commands+0x870>
ffffffffc020111c:	0bb00593          	li	a1,187
ffffffffc0201120:	00004517          	auipc	a0,0x4
ffffffffc0201124:	7f050513          	addi	a0,a0,2032 # ffffffffc0205910 <commands+0x888>
ffffffffc0201128:	b28ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(count == 0);
ffffffffc020112c:	00005697          	auipc	a3,0x5
ffffffffc0201130:	b0468693          	addi	a3,a3,-1276 # ffffffffc0205c30 <commands+0xba8>
ffffffffc0201134:	00004617          	auipc	a2,0x4
ffffffffc0201138:	7c460613          	addi	a2,a2,1988 # ffffffffc02058f8 <commands+0x870>
ffffffffc020113c:	12500593          	li	a1,293
ffffffffc0201140:	00004517          	auipc	a0,0x4
ffffffffc0201144:	7d050513          	addi	a0,a0,2000 # ffffffffc0205910 <commands+0x888>
ffffffffc0201148:	b08ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(nr_free == 0);
ffffffffc020114c:	00005697          	auipc	a3,0x5
ffffffffc0201150:	98468693          	addi	a3,a3,-1660 # ffffffffc0205ad0 <commands+0xa48>
ffffffffc0201154:	00004617          	auipc	a2,0x4
ffffffffc0201158:	7a460613          	addi	a2,a2,1956 # ffffffffc02058f8 <commands+0x870>
ffffffffc020115c:	11a00593          	li	a1,282
ffffffffc0201160:	00004517          	auipc	a0,0x4
ffffffffc0201164:	7b050513          	addi	a0,a0,1968 # ffffffffc0205910 <commands+0x888>
ffffffffc0201168:	ae8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(alloc_page() == NULL);
ffffffffc020116c:	00005697          	auipc	a3,0x5
ffffffffc0201170:	90468693          	addi	a3,a3,-1788 # ffffffffc0205a70 <commands+0x9e8>
ffffffffc0201174:	00004617          	auipc	a2,0x4
ffffffffc0201178:	78460613          	addi	a2,a2,1924 # ffffffffc02058f8 <commands+0x870>
ffffffffc020117c:	11800593          	li	a1,280
ffffffffc0201180:	00004517          	auipc	a0,0x4
ffffffffc0201184:	79050513          	addi	a0,a0,1936 # ffffffffc0205910 <commands+0x888>
ffffffffc0201188:	ac8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc020118c:	00005697          	auipc	a3,0x5
ffffffffc0201190:	8a468693          	addi	a3,a3,-1884 # ffffffffc0205a30 <commands+0x9a8>
ffffffffc0201194:	00004617          	auipc	a2,0x4
ffffffffc0201198:	76460613          	addi	a2,a2,1892 # ffffffffc02058f8 <commands+0x870>
ffffffffc020119c:	0c100593          	li	a1,193
ffffffffc02011a0:	00004517          	auipc	a0,0x4
ffffffffc02011a4:	77050513          	addi	a0,a0,1904 # ffffffffc0205910 <commands+0x888>
ffffffffc02011a8:	aa8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc02011ac:	00005697          	auipc	a3,0x5
ffffffffc02011b0:	a4468693          	addi	a3,a3,-1468 # ffffffffc0205bf0 <commands+0xb68>
ffffffffc02011b4:	00004617          	auipc	a2,0x4
ffffffffc02011b8:	74460613          	addi	a2,a2,1860 # ffffffffc02058f8 <commands+0x870>
ffffffffc02011bc:	11200593          	li	a1,274
ffffffffc02011c0:	00004517          	auipc	a0,0x4
ffffffffc02011c4:	75050513          	addi	a0,a0,1872 # ffffffffc0205910 <commands+0x888>
ffffffffc02011c8:	a88ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc02011cc:	00005697          	auipc	a3,0x5
ffffffffc02011d0:	a0468693          	addi	a3,a3,-1532 # ffffffffc0205bd0 <commands+0xb48>
ffffffffc02011d4:	00004617          	auipc	a2,0x4
ffffffffc02011d8:	72460613          	addi	a2,a2,1828 # ffffffffc02058f8 <commands+0x870>
ffffffffc02011dc:	11000593          	li	a1,272
ffffffffc02011e0:	00004517          	auipc	a0,0x4
ffffffffc02011e4:	73050513          	addi	a0,a0,1840 # ffffffffc0205910 <commands+0x888>
ffffffffc02011e8:	a68ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc02011ec:	00005697          	auipc	a3,0x5
ffffffffc02011f0:	9bc68693          	addi	a3,a3,-1604 # ffffffffc0205ba8 <commands+0xb20>
ffffffffc02011f4:	00004617          	auipc	a2,0x4
ffffffffc02011f8:	70460613          	addi	a2,a2,1796 # ffffffffc02058f8 <commands+0x870>
ffffffffc02011fc:	10e00593          	li	a1,270
ffffffffc0201200:	00004517          	auipc	a0,0x4
ffffffffc0201204:	71050513          	addi	a0,a0,1808 # ffffffffc0205910 <commands+0x888>
ffffffffc0201208:	a48ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc020120c:	00005697          	auipc	a3,0x5
ffffffffc0201210:	97468693          	addi	a3,a3,-1676 # ffffffffc0205b80 <commands+0xaf8>
ffffffffc0201214:	00004617          	auipc	a2,0x4
ffffffffc0201218:	6e460613          	addi	a2,a2,1764 # ffffffffc02058f8 <commands+0x870>
ffffffffc020121c:	10d00593          	li	a1,269
ffffffffc0201220:	00004517          	auipc	a0,0x4
ffffffffc0201224:	6f050513          	addi	a0,a0,1776 # ffffffffc0205910 <commands+0x888>
ffffffffc0201228:	a28ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(p0 + 2 == p1);
ffffffffc020122c:	00005697          	auipc	a3,0x5
ffffffffc0201230:	94468693          	addi	a3,a3,-1724 # ffffffffc0205b70 <commands+0xae8>
ffffffffc0201234:	00004617          	auipc	a2,0x4
ffffffffc0201238:	6c460613          	addi	a2,a2,1732 # ffffffffc02058f8 <commands+0x870>
ffffffffc020123c:	10800593          	li	a1,264
ffffffffc0201240:	00004517          	auipc	a0,0x4
ffffffffc0201244:	6d050513          	addi	a0,a0,1744 # ffffffffc0205910 <commands+0x888>
ffffffffc0201248:	a08ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(alloc_page() == NULL);
ffffffffc020124c:	00005697          	auipc	a3,0x5
ffffffffc0201250:	82468693          	addi	a3,a3,-2012 # ffffffffc0205a70 <commands+0x9e8>
ffffffffc0201254:	00004617          	auipc	a2,0x4
ffffffffc0201258:	6a460613          	addi	a2,a2,1700 # ffffffffc02058f8 <commands+0x870>
ffffffffc020125c:	10700593          	li	a1,263
ffffffffc0201260:	00004517          	auipc	a0,0x4
ffffffffc0201264:	6b050513          	addi	a0,a0,1712 # ffffffffc0205910 <commands+0x888>
ffffffffc0201268:	9e8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc020126c:	00005697          	auipc	a3,0x5
ffffffffc0201270:	8e468693          	addi	a3,a3,-1820 # ffffffffc0205b50 <commands+0xac8>
ffffffffc0201274:	00004617          	auipc	a2,0x4
ffffffffc0201278:	68460613          	addi	a2,a2,1668 # ffffffffc02058f8 <commands+0x870>
ffffffffc020127c:	10600593          	li	a1,262
ffffffffc0201280:	00004517          	auipc	a0,0x4
ffffffffc0201284:	69050513          	addi	a0,a0,1680 # ffffffffc0205910 <commands+0x888>
ffffffffc0201288:	9c8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc020128c:	00005697          	auipc	a3,0x5
ffffffffc0201290:	89468693          	addi	a3,a3,-1900 # ffffffffc0205b20 <commands+0xa98>
ffffffffc0201294:	00004617          	auipc	a2,0x4
ffffffffc0201298:	66460613          	addi	a2,a2,1636 # ffffffffc02058f8 <commands+0x870>
ffffffffc020129c:	10500593          	li	a1,261
ffffffffc02012a0:	00004517          	auipc	a0,0x4
ffffffffc02012a4:	67050513          	addi	a0,a0,1648 # ffffffffc0205910 <commands+0x888>
ffffffffc02012a8:	9a8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc02012ac:	00005697          	auipc	a3,0x5
ffffffffc02012b0:	85c68693          	addi	a3,a3,-1956 # ffffffffc0205b08 <commands+0xa80>
ffffffffc02012b4:	00004617          	auipc	a2,0x4
ffffffffc02012b8:	64460613          	addi	a2,a2,1604 # ffffffffc02058f8 <commands+0x870>
ffffffffc02012bc:	10400593          	li	a1,260
ffffffffc02012c0:	00004517          	auipc	a0,0x4
ffffffffc02012c4:	65050513          	addi	a0,a0,1616 # ffffffffc0205910 <commands+0x888>
ffffffffc02012c8:	988ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02012cc:	00004697          	auipc	a3,0x4
ffffffffc02012d0:	7a468693          	addi	a3,a3,1956 # ffffffffc0205a70 <commands+0x9e8>
ffffffffc02012d4:	00004617          	auipc	a2,0x4
ffffffffc02012d8:	62460613          	addi	a2,a2,1572 # ffffffffc02058f8 <commands+0x870>
ffffffffc02012dc:	0fe00593          	li	a1,254
ffffffffc02012e0:	00004517          	auipc	a0,0x4
ffffffffc02012e4:	63050513          	addi	a0,a0,1584 # ffffffffc0205910 <commands+0x888>
ffffffffc02012e8:	968ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(!PageProperty(p0));
ffffffffc02012ec:	00005697          	auipc	a3,0x5
ffffffffc02012f0:	80468693          	addi	a3,a3,-2044 # ffffffffc0205af0 <commands+0xa68>
ffffffffc02012f4:	00004617          	auipc	a2,0x4
ffffffffc02012f8:	60460613          	addi	a2,a2,1540 # ffffffffc02058f8 <commands+0x870>
ffffffffc02012fc:	0f900593          	li	a1,249
ffffffffc0201300:	00004517          	auipc	a0,0x4
ffffffffc0201304:	61050513          	addi	a0,a0,1552 # ffffffffc0205910 <commands+0x888>
ffffffffc0201308:	948ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc020130c:	00005697          	auipc	a3,0x5
ffffffffc0201310:	90468693          	addi	a3,a3,-1788 # ffffffffc0205c10 <commands+0xb88>
ffffffffc0201314:	00004617          	auipc	a2,0x4
ffffffffc0201318:	5e460613          	addi	a2,a2,1508 # ffffffffc02058f8 <commands+0x870>
ffffffffc020131c:	11700593          	li	a1,279
ffffffffc0201320:	00004517          	auipc	a0,0x4
ffffffffc0201324:	5f050513          	addi	a0,a0,1520 # ffffffffc0205910 <commands+0x888>
ffffffffc0201328:	928ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(total == 0);
ffffffffc020132c:	00005697          	auipc	a3,0x5
ffffffffc0201330:	91468693          	addi	a3,a3,-1772 # ffffffffc0205c40 <commands+0xbb8>
ffffffffc0201334:	00004617          	auipc	a2,0x4
ffffffffc0201338:	5c460613          	addi	a2,a2,1476 # ffffffffc02058f8 <commands+0x870>
ffffffffc020133c:	12600593          	li	a1,294
ffffffffc0201340:	00004517          	auipc	a0,0x4
ffffffffc0201344:	5d050513          	addi	a0,a0,1488 # ffffffffc0205910 <commands+0x888>
ffffffffc0201348:	908ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(total == nr_free_pages());
ffffffffc020134c:	00004697          	auipc	a3,0x4
ffffffffc0201350:	5dc68693          	addi	a3,a3,1500 # ffffffffc0205928 <commands+0x8a0>
ffffffffc0201354:	00004617          	auipc	a2,0x4
ffffffffc0201358:	5a460613          	addi	a2,a2,1444 # ffffffffc02058f8 <commands+0x870>
ffffffffc020135c:	0f300593          	li	a1,243
ffffffffc0201360:	00004517          	auipc	a0,0x4
ffffffffc0201364:	5b050513          	addi	a0,a0,1456 # ffffffffc0205910 <commands+0x888>
ffffffffc0201368:	8e8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc020136c:	00004697          	auipc	a3,0x4
ffffffffc0201370:	5fc68693          	addi	a3,a3,1532 # ffffffffc0205968 <commands+0x8e0>
ffffffffc0201374:	00004617          	auipc	a2,0x4
ffffffffc0201378:	58460613          	addi	a2,a2,1412 # ffffffffc02058f8 <commands+0x870>
ffffffffc020137c:	0ba00593          	li	a1,186
ffffffffc0201380:	00004517          	auipc	a0,0x4
ffffffffc0201384:	59050513          	addi	a0,a0,1424 # ffffffffc0205910 <commands+0x888>
...
ffffffffc02014f0:	76468693          	addi	a3,a3,1892 # ffffffffc0205c50 <commands+0xbc8>
ffffffffc02014f4:	00004617          	auipc	a2,0x4
ffffffffc02014f8:	40460613          	addi	a2,a2,1028 # ffffffffc02058f8 <commands+0x870>
ffffffffc02014fc:	08300593          	li	a1,131
ffffffffc0201500:	00004517          	auipc	a0,0x4
ffffffffc0201504:	41050513          	addi	a0,a0,1040 # ffffffffc0205910 <commands+0x888>
ffffffffc0201508:	f49fe0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(n > 0);
ffffffffc020150c:	00004697          	auipc	a3,0x4
ffffffffc0201510:	76c68693          	addi	a3,a3,1900 # ffffffffc0205c78 <commands+0xbf0>
ffffffffc0201514:	00004617          	auipc	a2,0x4
ffffffffc0201518:	3e460613          	addi	a2,a2,996 # ffffffffc02058f8 <commands+0x870>
ffffffffc020151c:	08000593          	li	a1,128
ffffffffc0201520:	00004517          	auipc	a0,0x4
ffffffffc0201524:	3f050513          	addi	a0,a0,1008 # ffffffffc0205910 <commands+0x888>
...
ffffffffc02015c8:	6b468693          	addi	a3,a3,1716 # ffffffffc0205c78 <commands+0xbf0>
ffffffffc02015cc:	00004617          	auipc	a2,0x4
ffffffffc02015d0:	32c60613          	addi	a2,a2,812 # ffffffffc02058f8 <commands+0x870>
ffffffffc02015d4:	06200593          	li	a1,98
ffffffffc02015d8:	00004517          	auipc	a0,0x4
ffffffffc02015dc:	33850513          	addi	a0,a0,824 # ffffffffc0205910 <commands+0x888>
default_alloc_pages(size_t n) {
...
ffffffffc02016b0:	5d468693          	addi	a3,a3,1492 # ffffffffc0205c80 <commands+0xbf8>
ffffffffc02016b4:	00004617          	auipc	a2,0x4
ffffffffc02016b8:	24460613          	addi	a2,a2,580 # ffffffffc02058f8 <commands+0x870>
ffffffffc02016bc:	04900593          	li	a1,73
ffffffffc02016c0:	00004517          	auipc	a0,0x4
ffffffffc02016c4:	25050513          	addi	a0,a0,592 # ffffffffc0205910 <commands+0x888>
ffffffffc02016c8:	d89fe0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(n > 0);
ffffffffc02016cc:	00004697          	auipc	a3,0x4
ffffffffc02016d0:	5ac68693          	addi	a3,a3,1452 # ffffffffc0205c78 <commands+0xbf0>
ffffffffc02016d4:	00004617          	auipc	a2,0x4
ffffffffc02016d8:	22460613          	addi	a2,a2,548 # ffffffffc02058f8 <commands+0x870>
ffffffffc02016dc:	04600593          	li	a1,70
ffffffffc02016e0:	00004517          	auipc	a0,0x4
ffffffffc02016e4:	23050513          	addi	a0,a0,560 # ffffffffc0205910 <commands+0x888>
...
ffffffffc0201820:	87478793          	addi	a5,a5,-1932 # ffffffffc0207090 <nbase>
...
ffffffffc0201862:	48260613          	addi	a2,a2,1154 # ffffffffc0205ce0 <default_pmm_manager+0x50>
ffffffffc0201866:	06900593          	li	a1,105
ffffffffc020186a:	00004517          	auipc	a0,0x4
ffffffffc020186e:	49e50513          	addi	a0,a0,1182 # ffffffffc0205d08 <default_pmm_manager+0x78>
...
ffffffffc020195e:	42668693          	addi	a3,a3,1062 # ffffffffc0205d80 <default_pmm_manager+0xf0>
ffffffffc0201962:	00004617          	auipc	a2,0x4
ffffffffc0201966:	f9660613          	addi	a2,a2,-106 # ffffffffc02058f8 <commands+0x870>
ffffffffc020196a:	06300593          	li	a1,99
ffffffffc020196e:	00004517          	auipc	a0,0x4
ffffffffc0201972:	43250513          	addi	a0,a0,1074 # ffffffffc0205da0 <default_pmm_manager+0x110>
...
ffffffffc0201980:	43c50513          	addi	a0,a0,1084 # ffffffffc0205db8 <default_pmm_manager+0x128>
kmalloc_init(void) {
...
ffffffffc0201990:	3d450513          	addi	a0,a0,980 # ffffffffc0205d60 <default_pmm_manager+0xd0>
}
...
ffffffffc0201ad8:	5bc78793          	addi	a5,a5,1468 # ffffffffc0207090 <nbase>
...
ffffffffc0201b4e:	1ce60613          	addi	a2,a2,462 # ffffffffc0205d18 <default_pmm_manager+0x88>
ffffffffc0201b52:	06e00593          	li	a1,110
ffffffffc0201b56:	00004517          	auipc	a0,0x4
ffffffffc0201b5a:	1b250513          	addi	a0,a0,434 # ffffffffc0205d08 <default_pmm_manager+0x78>
ffffffffc0201b5e:	8f3fe0ef          	jal	ra,ffffffffc0200450 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0201b62:	00004617          	auipc	a2,0x4
ffffffffc0201b66:	1de60613          	addi	a2,a2,478 # ffffffffc0205d40 <default_pmm_manager+0xb0>
ffffffffc0201b6a:	06200593          	li	a1,98
ffffffffc0201b6e:	00004517          	auipc	a0,0x4
ffffffffc0201b72:	19a50513          	addi	a0,a0,410 # ffffffffc0205d08 <default_pmm_manager+0x78>
...
ffffffffc0201b80:	1c460613          	addi	a2,a2,452 # ffffffffc0205d40 <default_pmm_manager+0xb0>
ffffffffc0201b84:	06200593          	li	a1,98
ffffffffc0201b88:	00004517          	auipc	a0,0x4
ffffffffc0201b8c:	18050513          	addi	a0,a0,384 # ffffffffc0205d08 <default_pmm_manager+0x78>
pa2page(uintptr_t pa) {
...
ffffffffc0201d2a:	1d2030ef          	jal	ra,ffffffffc0204efc <memset>
    return page - pages + nbase;
...
ffffffffc0201dbc:	140030ef          	jal	ra,ffffffffc0204efc <memset>
    return page - pages + nbase;
...
ffffffffc0201e16:	ece60613          	addi	a2,a2,-306 # ffffffffc0205ce0 <default_pmm_manager+0x50>
ffffffffc0201e1a:	0e400593          	li	a1,228
ffffffffc0201e1e:	00004517          	auipc	a0,0x4
ffffffffc0201e22:	fb250513          	addi	a0,a0,-78 # ffffffffc0205dd0 <default_pmm_manager+0x140>
ffffffffc0201e26:	e2afe0ef          	jal	ra,ffffffffc0200450 <__panic>
    return &((pte_t *)KADDR(PDE_ADDR(*pdep0)))[PTX(la)];
ffffffffc0201e2a:	00004617          	auipc	a2,0x4
ffffffffc0201e2e:	eb660613          	addi	a2,a2,-330 # ffffffffc0205ce0 <default_pmm_manager+0x50>
ffffffffc0201e32:	0ef00593          	li	a1,239
ffffffffc0201e36:	00004517          	auipc	a0,0x4
ffffffffc0201e3a:	f9a50513          	addi	a0,a0,-102 # ffffffffc0205dd0 <default_pmm_manager+0x140>
...
ffffffffc0201e48:	e9c60613          	addi	a2,a2,-356 # ffffffffc0205ce0 <default_pmm_manager+0x50>
ffffffffc0201e4c:	0ec00593          	li	a1,236
ffffffffc0201e50:	00004517          	auipc	a0,0x4
ffffffffc0201e54:	f8050513          	addi	a0,a0,-128 # ffffffffc0205dd0 <default_pmm_manager+0x140>
...
ffffffffc0201e62:	e8260613          	addi	a2,a2,-382 # ffffffffc0205ce0 <default_pmm_manager+0x50>
ffffffffc0201e66:	0e100593          	li	a1,225
ffffffffc0201e6a:	00004517          	auipc	a0,0x4
ffffffffc0201e6e:	f6650513          	addi	a0,a0,-154 # ffffffffc0205dd0 <default_pmm_manager+0x140>
...
ffffffffc020200e:	c8678793          	addi	a5,a5,-890 # ffffffffc0205c90 <default_pmm_manager>
...
ffffffffc020201a:	de250513          	addi	a0,a0,-542 # ffffffffc0205df8 <default_pmm_manager+0x168>
void pmm_init(void) {
...
ffffffffc0202064:	db050513          	addi	a0,a0,-592 # ffffffffc0205e10 <default_pmm_manager+0x180>
    va_pa_offset = KERNBASE - 0x80200000;
...
ffffffffc0202088:	da450513          	addi	a0,a0,-604 # ffffffffc0205e28 <default_pmm_manager+0x198>
...
ffffffffc0202132:	d2250513          	addi	a0,a0,-734 # ffffffffc0205e50 <default_pmm_manager+0x1c0>
...
ffffffffc020214c:	d2050513          	addi	a0,a0,-736 # ffffffffc0205e68 <default_pmm_manager+0x1d8>
...
ffffffffc02023a2:	dda50513          	addi	a0,a0,-550 # ffffffffc0206178 <default_pmm_manager+0x4e8>
...
ffffffffc020244e:	e6658593          	addi	a1,a1,-410 # ffffffffc02062b0 <default_pmm_manager+0x620>
ffffffffc0202452:	10000513          	li	a0,256
ffffffffc0202456:	24d020ef          	jal	ra,ffffffffc0204ea2 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc020245a:	100b0593          	addi	a1,s6,256
ffffffffc020245e:	10000513          	li	a0,256
ffffffffc0202462:	253020ef          	jal	ra,ffffffffc0204eb4 <strcmp>
...
ffffffffc0202496:	10068023          	sb	zero,256(a3) # fffffffffffff100 <end+0x3fde8b08>
    assert(strlen((const char *)0x100) == 0);
ffffffffc020249a:	1c5020ef          	jal	ra,ffffffffc0204e5e <strlen>
...
ffffffffc0202522:	e0a50513          	addi	a0,a0,-502 # ffffffffc0206328 <default_pmm_manager+0x698>
...
ffffffffc020254c:	c5068693          	addi	a3,a3,-944 # ffffffffc0206198 <default_pmm_manager+0x508>
ffffffffc0202550:	00003617          	auipc	a2,0x3
ffffffffc0202554:	3a860613          	addi	a2,a2,936 # ffffffffc02058f8 <commands+0x870>
ffffffffc0202558:	19d00593          	li	a1,413
ffffffffc020255c:	00004517          	auipc	a0,0x4
ffffffffc0202560:	87450513          	addi	a0,a0,-1932 # ffffffffc0205dd0 <default_pmm_manager+0x140>
...
ffffffffc020256e:	77660613          	addi	a2,a2,1910 # ffffffffc0205ce0 <default_pmm_manager+0x50>
ffffffffc0202572:	19d00593          	li	a1,413
ffffffffc0202576:	00004517          	auipc	a0,0x4
ffffffffc020257a:	85a50513          	addi	a0,a0,-1958 # ffffffffc0205dd0 <default_pmm_manager+0x140>
ffffffffc020257e:	ed3fd0ef          	jal	ra,ffffffffc0200450 <__panic>
        assert(PTE_ADDR(*ptep) == i);
ffffffffc0202582:	00004697          	auipc	a3,0x4
ffffffffc0202586:	c5668693          	addi	a3,a3,-938 # ffffffffc02061d8 <default_pmm_manager+0x548>
ffffffffc020258a:	00003617          	auipc	a2,0x3
ffffffffc020258e:	36e60613          	addi	a2,a2,878 # ffffffffc02058f8 <commands+0x870>
ffffffffc0202592:	19e00593          	li	a1,414
ffffffffc0202596:	00004517          	auipc	a0,0x4
ffffffffc020259a:	83a50513          	addi	a0,a0,-1990 # ffffffffc0205dd0 <default_pmm_manager+0x140>
...
ffffffffc02025aa:	73a60613          	addi	a2,a2,1850 # ffffffffc0205ce0 <default_pmm_manager+0x50>
ffffffffc02025ae:	06900593          	li	a1,105
ffffffffc02025b2:	00003517          	auipc	a0,0x3
ffffffffc02025b6:	75650513          	addi	a0,a0,1878 # ffffffffc0205d08 <default_pmm_manager+0x78>
ffffffffc02025ba:	e97fd0ef          	jal	ra,ffffffffc0200450 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc02025be:	00004617          	auipc	a2,0x4
ffffffffc02025c2:	9aa60613          	addi	a2,a2,-1622 # ffffffffc0205f68 <default_pmm_manager+0x2d8>
ffffffffc02025c6:	07400593          	li	a1,116
ffffffffc02025ca:	00003517          	auipc	a0,0x3
ffffffffc02025ce:	73e50513          	addi	a0,a0,1854 # ffffffffc0205d08 <default_pmm_manager+0x78>
ffffffffc02025d2:	e7ffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(boot_pgdir != NULL && (uint32_t)PGOFF(boot_pgdir) == 0);
ffffffffc02025d6:	00004697          	auipc	a3,0x4
ffffffffc02025da:	8d268693          	addi	a3,a3,-1838 # ffffffffc0205ea8 <default_pmm_manager+0x218>
ffffffffc02025de:	00003617          	auipc	a2,0x3
ffffffffc02025e2:	31a60613          	addi	a2,a2,794 # ffffffffc02058f8 <commands+0x870>
ffffffffc02025e6:	16100593          	li	a1,353
ffffffffc02025ea:	00003517          	auipc	a0,0x3
ffffffffc02025ee:	7e650513          	addi	a0,a0,2022 # ffffffffc0205dd0 <default_pmm_manager+0x140>
ffffffffc02025f2:	e5ffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02025f6:	00004697          	auipc	a3,0x4
ffffffffc02025fa:	99a68693          	addi	a3,a3,-1638 # ffffffffc0205f90 <default_pmm_manager+0x300>
ffffffffc02025fe:	00003617          	auipc	a2,0x3
ffffffffc0202602:	2fa60613          	addi	a2,a2,762 # ffffffffc02058f8 <commands+0x870>
ffffffffc0202606:	17d00593          	li	a1,381
ffffffffc020260a:	00003517          	auipc	a0,0x3
ffffffffc020260e:	7c650513          	addi	a0,a0,1990 # ffffffffc0205dd0 <default_pmm_manager+0x140>
ffffffffc0202612:	e3ffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0202616:	00004697          	auipc	a3,0x4
ffffffffc020261a:	bf268693          	addi	a3,a3,-1038 # ffffffffc0206208 <default_pmm_manager+0x578>
ffffffffc020261e:	00003617          	auipc	a2,0x3
ffffffffc0202622:	2da60613          	addi	a2,a2,730 # ffffffffc02058f8 <commands+0x870>
ffffffffc0202626:	1a500593          	li	a1,421
ffffffffc020262a:	00003517          	auipc	a0,0x3
ffffffffc020262e:	7a650513          	addi	a0,a0,1958 # ffffffffc0205dd0 <default_pmm_manager+0x140>
ffffffffc0202632:	e1ffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc0202636:	00004697          	auipc	a3,0x4
ffffffffc020263a:	9ea68693          	addi	a3,a3,-1558 # ffffffffc0206020 <default_pmm_manager+0x390>
ffffffffc020263e:	00003617          	auipc	a2,0x3
ffffffffc0202642:	2ba60613          	addi	a2,a2,698 # ffffffffc02058f8 <commands+0x870>
ffffffffc0202646:	17c00593          	li	a1,380
ffffffffc020264a:	00003517          	auipc	a0,0x3
ffffffffc020264e:	78650513          	addi	a0,a0,1926 # ffffffffc0205dd0 <default_pmm_manager+0x140>
ffffffffc0202652:	dfffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202656:	00004697          	auipc	a3,0x4
ffffffffc020265a:	a9268693          	addi	a3,a3,-1390 # ffffffffc02060e8 <default_pmm_manager+0x458>
ffffffffc020265e:	00003617          	auipc	a2,0x3
ffffffffc0202662:	29a60613          	addi	a2,a2,666 # ffffffffc02058f8 <commands+0x870>
ffffffffc0202666:	17b00593          	li	a1,379
ffffffffc020266a:	00003517          	auipc	a0,0x3
ffffffffc020266e:	76650513          	addi	a0,a0,1894 # ffffffffc0205dd0 <default_pmm_manager+0x140>
ffffffffc0202672:	ddffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_ref(p1) == 2);
ffffffffc0202676:	00004697          	auipc	a3,0x4
ffffffffc020267a:	a5a68693          	addi	a3,a3,-1446 # ffffffffc02060d0 <default_pmm_manager+0x440>
ffffffffc020267e:	00003617          	auipc	a2,0x3
ffffffffc0202682:	27a60613          	addi	a2,a2,634 # ffffffffc02058f8 <commands+0x870>
ffffffffc0202686:	17a00593          	li	a1,378
ffffffffc020268a:	00003517          	auipc	a0,0x3
ffffffffc020268e:	74650513          	addi	a0,a0,1862 # ffffffffc0205dd0 <default_pmm_manager+0x140>
ffffffffc0202692:	dbffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_insert(boot_pgdir, p1, PGSIZE, 0) == 0);
ffffffffc0202696:	00004697          	auipc	a3,0x4
ffffffffc020269a:	a0a68693          	addi	a3,a3,-1526 # ffffffffc02060a0 <default_pmm_manager+0x410>
ffffffffc020269e:	00003617          	auipc	a2,0x3
ffffffffc02026a2:	25a60613          	addi	a2,a2,602 # ffffffffc02058f8 <commands+0x870>
ffffffffc02026a6:	17900593          	li	a1,377
ffffffffc02026aa:	00003517          	auipc	a0,0x3
ffffffffc02026ae:	72650513          	addi	a0,a0,1830 # ffffffffc0205dd0 <default_pmm_manager+0x140>
ffffffffc02026b2:	d9ffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_ref(p2) == 1);
ffffffffc02026b6:	00004697          	auipc	a3,0x4
ffffffffc02026ba:	9d268693          	addi	a3,a3,-1582 # ffffffffc0206088 <default_pmm_manager+0x3f8>
ffffffffc02026be:	00003617          	auipc	a2,0x3
ffffffffc02026c2:	23a60613          	addi	a2,a2,570 # ffffffffc02058f8 <commands+0x870>
ffffffffc02026c6:	17700593          	li	a1,375
ffffffffc02026ca:	00003517          	auipc	a0,0x3
ffffffffc02026ce:	70650513          	addi	a0,a0,1798 # ffffffffc0205dd0 <default_pmm_manager+0x140>
ffffffffc02026d2:	d7ffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(boot_pgdir[0] & PTE_U);
ffffffffc02026d6:	00004697          	auipc	a3,0x4
ffffffffc02026da:	99a68693          	addi	a3,a3,-1638 # ffffffffc0206070 <default_pmm_manager+0x3e0>
ffffffffc02026de:	00003617          	auipc	a2,0x3
ffffffffc02026e2:	21a60613          	addi	a2,a2,538 # ffffffffc02058f8 <commands+0x870>
ffffffffc02026e6:	17600593          	li	a1,374
ffffffffc02026ea:	00003517          	auipc	a0,0x3
ffffffffc02026ee:	6e650513          	addi	a0,a0,1766 # ffffffffc0205dd0 <default_pmm_manager+0x140>
ffffffffc02026f2:	d5ffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(*ptep & PTE_W);
ffffffffc02026f6:	00004697          	auipc	a3,0x4
ffffffffc02026fa:	96a68693          	addi	a3,a3,-1686 # ffffffffc0206060 <default_pmm_manager+0x3d0>
ffffffffc02026fe:	00003617          	auipc	a2,0x3
ffffffffc0202702:	1fa60613          	addi	a2,a2,506 # ffffffffc02058f8 <commands+0x870>
ffffffffc0202706:	17500593          	li	a1,373
ffffffffc020270a:	00003517          	auipc	a0,0x3
ffffffffc020270e:	6c650513          	addi	a0,a0,1734 # ffffffffc0205dd0 <default_pmm_manager+0x140>
ffffffffc0202712:	d3ffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(*ptep & PTE_U);
ffffffffc0202716:	00004697          	auipc	a3,0x4
ffffffffc020271a:	93a68693          	addi	a3,a3,-1734 # ffffffffc0206050 <default_pmm_manager+0x3c0>
ffffffffc020271e:	00003617          	auipc	a2,0x3
ffffffffc0202722:	1da60613          	addi	a2,a2,474 # ffffffffc02058f8 <commands+0x870>
ffffffffc0202726:	17400593          	li	a1,372
ffffffffc020272a:	00003517          	auipc	a0,0x3
ffffffffc020272e:	6a650513          	addi	a0,a0,1702 # ffffffffc0205dd0 <default_pmm_manager+0x140>
ffffffffc0202732:	d1ffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc0202736:	00004697          	auipc	a3,0x4
ffffffffc020273a:	8ea68693          	addi	a3,a3,-1814 # ffffffffc0206020 <default_pmm_manager+0x390>
ffffffffc020273e:	00003617          	auipc	a2,0x3
ffffffffc0202742:	1ba60613          	addi	a2,a2,442 # ffffffffc02058f8 <commands+0x870>
ffffffffc0202746:	17300593          	li	a1,371
ffffffffc020274a:	00003517          	auipc	a0,0x3
ffffffffc020274e:	68650513          	addi	a0,a0,1670 # ffffffffc0205dd0 <default_pmm_manager+0x140>
ffffffffc0202752:	cfffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_insert(boot_pgdir, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc0202756:	00004697          	auipc	a3,0x4
ffffffffc020275a:	89268693          	addi	a3,a3,-1902 # ffffffffc0205fe8 <default_pmm_manager+0x358>
ffffffffc020275e:	00003617          	auipc	a2,0x3
ffffffffc0202762:	19a60613          	addi	a2,a2,410 # ffffffffc02058f8 <commands+0x870>
ffffffffc0202766:	17200593          	li	a1,370
ffffffffc020276a:	00003517          	auipc	a0,0x3
ffffffffc020276e:	66650513          	addi	a0,a0,1638 # ffffffffc0205dd0 <default_pmm_manager+0x140>
ffffffffc0202772:	cdffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(get_pte(boot_pgdir, PGSIZE, 0) == ptep);
ffffffffc0202776:	00004697          	auipc	a3,0x4
ffffffffc020277a:	84a68693          	addi	a3,a3,-1974 # ffffffffc0205fc0 <default_pmm_manager+0x330>
ffffffffc020277e:	00003617          	auipc	a2,0x3
ffffffffc0202782:	17a60613          	addi	a2,a2,378 # ffffffffc02058f8 <commands+0x870>
ffffffffc0202786:	16f00593          	li	a1,367
ffffffffc020278a:	00003517          	auipc	a0,0x3
ffffffffc020278e:	64650513          	addi	a0,a0,1606 # ffffffffc0205dd0 <default_pmm_manager+0x140>
...
ffffffffc020279c:	54860613          	addi	a2,a2,1352 # ffffffffc0205ce0 <default_pmm_manager+0x50>
ffffffffc02027a0:	16e00593          	li	a1,366
ffffffffc02027a4:	00003517          	auipc	a0,0x3
ffffffffc02027a8:	62c50513          	addi	a0,a0,1580 # ffffffffc0205dd0 <default_pmm_manager+0x140>
...
ffffffffc02027b6:	52e60613          	addi	a2,a2,1326 # ffffffffc0205ce0 <default_pmm_manager+0x50>
ffffffffc02027ba:	06900593          	li	a1,105
ffffffffc02027be:	00003517          	auipc	a0,0x3
ffffffffc02027c2:	54a50513          	addi	a0,a0,1354 # ffffffffc0205d08 <default_pmm_manager+0x78>
ffffffffc02027c6:	c8bfd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_ref(pde2page(boot_pgdir[0])) == 1);
ffffffffc02027ca:	00004697          	auipc	a3,0x4
ffffffffc02027ce:	96668693          	addi	a3,a3,-1690 # ffffffffc0206130 <default_pmm_manager+0x4a0>
ffffffffc02027d2:	00003617          	auipc	a2,0x3
ffffffffc02027d6:	12660613          	addi	a2,a2,294 # ffffffffc02058f8 <commands+0x870>
ffffffffc02027da:	18800593          	li	a1,392
ffffffffc02027de:	00003517          	auipc	a0,0x3
ffffffffc02027e2:	5f250513          	addi	a0,a0,1522 # ffffffffc0205dd0 <default_pmm_manager+0x140>
ffffffffc02027e6:	c6bfd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc02027ea:	00004697          	auipc	a3,0x4
ffffffffc02027ee:	8fe68693          	addi	a3,a3,-1794 # ffffffffc02060e8 <default_pmm_manager+0x458>
ffffffffc02027f2:	00003617          	auipc	a2,0x3
ffffffffc02027f6:	10660613          	addi	a2,a2,262 # ffffffffc02058f8 <commands+0x870>
ffffffffc02027fa:	18600593          	li	a1,390
ffffffffc02027fe:	00003517          	auipc	a0,0x3
ffffffffc0202802:	5d250513          	addi	a0,a0,1490 # ffffffffc0205dd0 <default_pmm_manager+0x140>
ffffffffc0202806:	c4bfd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_ref(p1) == 0);
ffffffffc020280a:	00004697          	auipc	a3,0x4
ffffffffc020280e:	90e68693          	addi	a3,a3,-1778 # ffffffffc0206118 <default_pmm_manager+0x488>
ffffffffc0202812:	00003617          	auipc	a2,0x3
ffffffffc0202816:	0e660613          	addi	a2,a2,230 # ffffffffc02058f8 <commands+0x870>
ffffffffc020281a:	18500593          	li	a1,389
ffffffffc020281e:	00003517          	auipc	a0,0x3
ffffffffc0202822:	5b250513          	addi	a0,a0,1458 # ffffffffc0205dd0 <default_pmm_manager+0x140>
ffffffffc0202826:	c2bfd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_ref(p) == 2);
ffffffffc020282a:	00004697          	auipc	a3,0x4
ffffffffc020282e:	a6e68693          	addi	a3,a3,-1426 # ffffffffc0206298 <default_pmm_manager+0x608>
ffffffffc0202832:	00003617          	auipc	a2,0x3
ffffffffc0202836:	0c660613          	addi	a2,a2,198 # ffffffffc02058f8 <commands+0x870>
ffffffffc020283a:	1a800593          	li	a1,424
ffffffffc020283e:	00003517          	auipc	a0,0x3
ffffffffc0202842:	59250513          	addi	a0,a0,1426 # ffffffffc0205dd0 <default_pmm_manager+0x140>
ffffffffc0202846:	c0bfd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc020284a:	00004697          	auipc	a3,0x4
ffffffffc020284e:	a0e68693          	addi	a3,a3,-1522 # ffffffffc0206258 <default_pmm_manager+0x5c8>
ffffffffc0202852:	00003617          	auipc	a2,0x3
ffffffffc0202856:	0a660613          	addi	a2,a2,166 # ffffffffc02058f8 <commands+0x870>
ffffffffc020285a:	1a700593          	li	a1,423
ffffffffc020285e:	00003517          	auipc	a0,0x3
ffffffffc0202862:	57250513          	addi	a0,a0,1394 # ffffffffc0205dd0 <default_pmm_manager+0x140>
ffffffffc0202866:	bebfd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_ref(p) == 1);
ffffffffc020286a:	00004697          	auipc	a3,0x4
ffffffffc020286e:	9d668693          	addi	a3,a3,-1578 # ffffffffc0206240 <default_pmm_manager+0x5b0>
ffffffffc0202872:	00003617          	auipc	a2,0x3
ffffffffc0202876:	08660613          	addi	a2,a2,134 # ffffffffc02058f8 <commands+0x870>
ffffffffc020287a:	1a600593          	li	a1,422
ffffffffc020287e:	00003517          	auipc	a0,0x3
ffffffffc0202882:	55250513          	addi	a0,a0,1362 # ffffffffc0205dd0 <default_pmm_manager+0x140>
...
ffffffffc0202890:	45460613          	addi	a2,a2,1108 # ffffffffc0205ce0 <default_pmm_manager+0x50>
ffffffffc0202894:	16d00593          	li	a1,365
ffffffffc0202898:	00003517          	auipc	a0,0x3
ffffffffc020289c:	53850513          	addi	a0,a0,1336 # ffffffffc0205dd0 <default_pmm_manager+0x140>
ffffffffc02028a0:	bb1fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    uintptr_t freemem = PADDR((uintptr_t)pages + sizeof(struct Page) * (npage - nbase));
ffffffffc02028a4:	00003617          	auipc	a2,0x3
ffffffffc02028a8:	47460613          	addi	a2,a2,1140 # ffffffffc0205d18 <default_pmm_manager+0x88>
ffffffffc02028ac:	07f00593          	li	a1,127
ffffffffc02028b0:	00003517          	auipc	a0,0x3
ffffffffc02028b4:	52050513          	addi	a0,a0,1312 # ffffffffc0205dd0 <default_pmm_manager+0x140>
ffffffffc02028b8:	b99fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc02028bc:	00004697          	auipc	a3,0x4
ffffffffc02028c0:	a0c68693          	addi	a3,a3,-1524 # ffffffffc02062c8 <default_pmm_manager+0x638>
ffffffffc02028c4:	00003617          	auipc	a2,0x3
ffffffffc02028c8:	03460613          	addi	a2,a2,52 # ffffffffc02058f8 <commands+0x870>
ffffffffc02028cc:	1ac00593          	li	a1,428
ffffffffc02028d0:	00003517          	auipc	a0,0x3
ffffffffc02028d4:	50050513          	addi	a0,a0,1280 # ffffffffc0205dd0 <default_pmm_manager+0x140>
ffffffffc02028d8:	b79fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc02028dc:	00004697          	auipc	a3,0x4
ffffffffc02028e0:	87c68693          	addi	a3,a3,-1924 # ffffffffc0206158 <default_pmm_manager+0x4c8>
ffffffffc02028e4:	00003617          	auipc	a2,0x3
ffffffffc02028e8:	01460613          	addi	a2,a2,20 # ffffffffc02058f8 <commands+0x870>
ffffffffc02028ec:	1b800593          	li	a1,440
ffffffffc02028f0:	00003517          	auipc	a0,0x3
ffffffffc02028f4:	4e050513          	addi	a0,a0,1248 # ffffffffc0205dd0 <default_pmm_manager+0x140>
ffffffffc02028f8:	b59fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc02028fc:	00003697          	auipc	a3,0x3
ffffffffc0202900:	6ac68693          	addi	a3,a3,1708 # ffffffffc0205fa8 <default_pmm_manager+0x318>
ffffffffc0202904:	00003617          	auipc	a2,0x3
ffffffffc0202908:	ff460613          	addi	a2,a2,-12 # ffffffffc02058f8 <commands+0x870>
ffffffffc020290c:	16b00593          	li	a1,363
ffffffffc0202910:	00003517          	auipc	a0,0x3
ffffffffc0202914:	4c050513          	addi	a0,a0,1216 # ffffffffc0205dd0 <default_pmm_manager+0x140>
ffffffffc0202918:	b39fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc020291c:	00003697          	auipc	a3,0x3
ffffffffc0202920:	67468693          	addi	a3,a3,1652 # ffffffffc0205f90 <default_pmm_manager+0x300>
ffffffffc0202924:	00003617          	auipc	a2,0x3
ffffffffc0202928:	fd460613          	addi	a2,a2,-44 # ffffffffc02058f8 <commands+0x870>
ffffffffc020292c:	16a00593          	li	a1,362
ffffffffc0202930:	00003517          	auipc	a0,0x3
ffffffffc0202934:	4a050513          	addi	a0,a0,1184 # ffffffffc0205dd0 <default_pmm_manager+0x140>
ffffffffc0202938:	b19fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(get_page(boot_pgdir, 0x0, NULL) == NULL);
ffffffffc020293c:	00003697          	auipc	a3,0x3
ffffffffc0202940:	5a468693          	addi	a3,a3,1444 # ffffffffc0205ee0 <default_pmm_manager+0x250>
ffffffffc0202944:	00003617          	auipc	a2,0x3
ffffffffc0202948:	fb460613          	addi	a2,a2,-76 # ffffffffc02058f8 <commands+0x870>
ffffffffc020294c:	16200593          	li	a1,354
ffffffffc0202950:	00003517          	auipc	a0,0x3
ffffffffc0202954:	48050513          	addi	a0,a0,1152 # ffffffffc0205dd0 <default_pmm_manager+0x140>
ffffffffc0202958:	af9fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((ptep = get_pte(boot_pgdir, 0x0, 0)) != NULL);
ffffffffc020295c:	00003697          	auipc	a3,0x3
ffffffffc0202960:	5dc68693          	addi	a3,a3,1500 # ffffffffc0205f38 <default_pmm_manager+0x2a8>
ffffffffc0202964:	00003617          	auipc	a2,0x3
ffffffffc0202968:	f9460613          	addi	a2,a2,-108 # ffffffffc02058f8 <commands+0x870>
ffffffffc020296c:	16900593          	li	a1,361
ffffffffc0202970:	00003517          	auipc	a0,0x3
ffffffffc0202974:	46050513          	addi	a0,a0,1120 # ffffffffc0205dd0 <default_pmm_manager+0x140>
ffffffffc0202978:	ad9fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_insert(boot_pgdir, p1, 0x0, 0) == 0);
ffffffffc020297c:	00003697          	auipc	a3,0x3
ffffffffc0202980:	58c68693          	addi	a3,a3,1420 # ffffffffc0205f08 <default_pmm_manager+0x278>
ffffffffc0202984:	00003617          	auipc	a2,0x3
ffffffffc0202988:	f7460613          	addi	a2,a2,-140 # ffffffffc02058f8 <commands+0x870>
ffffffffc020298c:	16600593          	li	a1,358
ffffffffc0202990:	00003517          	auipc	a0,0x3
ffffffffc0202994:	44050513          	addi	a0,a0,1088 # ffffffffc0205dd0 <default_pmm_manager+0x140>
ffffffffc0202998:	ab9fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc020299c:	00003697          	auipc	a3,0x3
ffffffffc02029a0:	74c68693          	addi	a3,a3,1868 # ffffffffc02060e8 <default_pmm_manager+0x458>
ffffffffc02029a4:	00003617          	auipc	a2,0x3
ffffffffc02029a8:	f5460613          	addi	a2,a2,-172 # ffffffffc02058f8 <commands+0x870>
ffffffffc02029ac:	18200593          	li	a1,386
ffffffffc02029b0:	00003517          	auipc	a0,0x3
ffffffffc02029b4:	42050513          	addi	a0,a0,1056 # ffffffffc0205dd0 <default_pmm_manager+0x140>
ffffffffc02029b8:	a99fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc02029bc:	00003697          	auipc	a3,0x3
ffffffffc02029c0:	5ec68693          	addi	a3,a3,1516 # ffffffffc0205fa8 <default_pmm_manager+0x318>
ffffffffc02029c4:	00003617          	auipc	a2,0x3
ffffffffc02029c8:	f3460613          	addi	a2,a2,-204 # ffffffffc02058f8 <commands+0x870>
ffffffffc02029cc:	18100593          	li	a1,385
ffffffffc02029d0:	00003517          	auipc	a0,0x3
ffffffffc02029d4:	40050513          	addi	a0,a0,1024 # ffffffffc0205dd0 <default_pmm_manager+0x140>
ffffffffc02029d8:	a79fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc02029dc:	00003697          	auipc	a3,0x3
ffffffffc02029e0:	72468693          	addi	a3,a3,1828 # ffffffffc0206100 <default_pmm_manager+0x470>
ffffffffc02029e4:	00003617          	auipc	a2,0x3
ffffffffc02029e8:	f1460613          	addi	a2,a2,-236 # ffffffffc02058f8 <commands+0x870>
ffffffffc02029ec:	17e00593          	li	a1,382
ffffffffc02029f0:	00003517          	auipc	a0,0x3
ffffffffc02029f4:	3e050513          	addi	a0,a0,992 # ffffffffc0205dd0 <default_pmm_manager+0x140>
ffffffffc02029f8:	a59fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc02029fc:	00004697          	auipc	a3,0x4
ffffffffc0202a00:	90468693          	addi	a3,a3,-1788 # ffffffffc0206300 <default_pmm_manager+0x670>
ffffffffc0202a04:	00003617          	auipc	a2,0x3
ffffffffc0202a08:	ef460613          	addi	a2,a2,-268 # ffffffffc02058f8 <commands+0x870>
ffffffffc0202a0c:	1af00593          	li	a1,431
ffffffffc0202a10:	00003517          	auipc	a0,0x3
ffffffffc0202a14:	3c050513          	addi	a0,a0,960 # ffffffffc0205dd0 <default_pmm_manager+0x140>
ffffffffc0202a18:	a39fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc0202a1c:	00003697          	auipc	a3,0x3
ffffffffc0202a20:	73c68693          	addi	a3,a3,1852 # ffffffffc0206158 <default_pmm_manager+0x4c8>
ffffffffc0202a24:	00003617          	auipc	a2,0x3
ffffffffc0202a28:	ed460613          	addi	a2,a2,-300 # ffffffffc02058f8 <commands+0x870>
ffffffffc0202a2c:	19000593          	li	a1,400
ffffffffc0202a30:	00003517          	auipc	a0,0x3
ffffffffc0202a34:	3a050513          	addi	a0,a0,928 # ffffffffc0205dd0 <default_pmm_manager+0x140>
ffffffffc0202a38:	a19fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(boot_pgdir[0] == 0);
ffffffffc0202a3c:	00003697          	auipc	a3,0x3
ffffffffc0202a40:	7b468693          	addi	a3,a3,1972 # ffffffffc02061f0 <default_pmm_manager+0x560>
ffffffffc0202a44:	00003617          	auipc	a2,0x3
ffffffffc0202a48:	eb460613          	addi	a2,a2,-332 # ffffffffc02058f8 <commands+0x870>
ffffffffc0202a4c:	1a100593          	li	a1,417
ffffffffc0202a50:	00003517          	auipc	a0,0x3
ffffffffc0202a54:	38050513          	addi	a0,a0,896 # ffffffffc0205dd0 <default_pmm_manager+0x140>
ffffffffc0202a58:	9f9fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc0202a5c:	00003697          	auipc	a3,0x3
ffffffffc0202a60:	42c68693          	addi	a3,a3,1068 # ffffffffc0205e88 <default_pmm_manager+0x1f8>
ffffffffc0202a64:	00003617          	auipc	a2,0x3
ffffffffc0202a68:	e9460613          	addi	a2,a2,-364 # ffffffffc02058f8 <commands+0x870>
ffffffffc0202a6c:	16000593          	li	a1,352
ffffffffc0202a70:	00003517          	auipc	a0,0x3
ffffffffc0202a74:	36050513          	addi	a0,a0,864 # ffffffffc0205dd0 <default_pmm_manager+0x140>
ffffffffc0202a78:	9d9fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    boot_cr3 = PADDR(boot_pgdir);
ffffffffc0202a7c:	00003617          	auipc	a2,0x3
ffffffffc0202a80:	29c60613          	addi	a2,a2,668 # ffffffffc0205d18 <default_pmm_manager+0x88>
ffffffffc0202a84:	0c300593          	li	a1,195
ffffffffc0202a88:	00003517          	auipc	a0,0x3
ffffffffc0202a8c:	34850513          	addi	a0,a0,840 # ffffffffc0205dd0 <default_pmm_manager+0x140>
...
ffffffffc0202b04:	2e068693          	addi	a3,a3,736 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc0202b08:	00003617          	auipc	a2,0x3
ffffffffc0202b0c:	df060613          	addi	a2,a2,-528 # ffffffffc02058f8 <commands+0x870>
ffffffffc0202b10:	14800593          	li	a1,328
ffffffffc0202b14:	00003517          	auipc	a0,0x3
ffffffffc0202b18:	2bc50513          	addi	a0,a0,700 # ffffffffc0205dd0 <default_pmm_manager+0x140>
...
ffffffffc0202b46:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc0202b48:	570010ef          	jal	ra,ffffffffc02040b8 <swapfs_init>
...
ffffffffc0202baa:	82250513          	addi	a0,a0,-2014 # ffffffffc02063c8 <default_pmm_manager+0x738>
    return listelm->next;
...
ffffffffc0202c08:	7dc50513          	addi	a0,a0,2012 # ffffffffc02063e0 <default_pmm_manager+0x750>
...
ffffffffc0202c62:	7f250513          	addi	a0,a0,2034 # ffffffffc0206450 <default_pmm_manager+0x7c0>
...
ffffffffc0202c7e:	82650513          	addi	a0,a0,-2010 # ffffffffc02064a0 <default_pmm_manager+0x810>
...
ffffffffc0202cfe:	82e50513          	addi	a0,a0,-2002 # ffffffffc0206528 <default_pmm_manager+0x898>
...
ffffffffc0202dd6:	2bed8d93          	addi	s11,s11,702 # ffffffffc0207090 <nbase>
...
ffffffffc0202e3e:	79650513          	addi	a0,a0,1942 # ffffffffc02065d0 <default_pmm_manager+0x940>
...
ffffffffc0202f2e:	6f650513          	addi	a0,a0,1782 # ffffffffc0206620 <default_pmm_manager+0x990>
...
ffffffffc0202f44:	9a868693          	addi	a3,a3,-1624 # ffffffffc02058e8 <commands+0x860>
ffffffffc0202f48:	00003617          	auipc	a2,0x3
ffffffffc0202f4c:	9b060613          	addi	a2,a2,-1616 # ffffffffc02058f8 <commands+0x870>
ffffffffc0202f50:	0bd00593          	li	a1,189
ffffffffc0202f54:	00003517          	auipc	a0,0x3
ffffffffc0202f58:	46450513          	addi	a0,a0,1124 # ffffffffc02063b8 <default_pmm_manager+0x728>
ffffffffc0202f5c:	cf4fd0ef          	jal	ra,ffffffffc0200450 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0202f60:	00003617          	auipc	a2,0x3
ffffffffc0202f64:	de060613          	addi	a2,a2,-544 # ffffffffc0205d40 <default_pmm_manager+0xb0>
ffffffffc0202f68:	06200593          	li	a1,98
ffffffffc0202f6c:	00003517          	auipc	a0,0x3
ffffffffc0202f70:	d9c50513          	addi	a0,a0,-612 # ffffffffc0205d08 <default_pmm_manager+0x78>
ffffffffc0202f74:	cdcfd0ef          	jal	ra,ffffffffc0200450 <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0202f78:	00003697          	auipc	a3,0x3
ffffffffc0202f7c:	63068693          	addi	a3,a3,1584 # ffffffffc02065a8 <default_pmm_manager+0x918>
ffffffffc0202f80:	00003617          	auipc	a2,0x3
ffffffffc0202f84:	97860613          	addi	a2,a2,-1672 # ffffffffc02058f8 <commands+0x870>
ffffffffc0202f88:	0fd00593          	li	a1,253
ffffffffc0202f8c:	00003517          	auipc	a0,0x3
ffffffffc0202f90:	42c50513          	addi	a0,a0,1068 # ffffffffc02063b8 <default_pmm_manager+0x728>
ffffffffc0202f94:	cbcfd0ef          	jal	ra,ffffffffc0200450 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0202f98:	00003617          	auipc	a2,0x3
ffffffffc0202f9c:	fd060613          	addi	a2,a2,-48 # ffffffffc0205f68 <default_pmm_manager+0x2d8>
ffffffffc0202fa0:	07400593          	li	a1,116
ffffffffc0202fa4:	00003517          	auipc	a0,0x3
ffffffffc0202fa8:	d6450513          	addi	a0,a0,-668 # ffffffffc0205d08 <default_pmm_manager+0x78>
ffffffffc0202fac:	ca4fd0ef          	jal	ra,ffffffffc0200450 <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc0202fb0:	00003697          	auipc	a3,0x3
ffffffffc0202fb4:	53068693          	addi	a3,a3,1328 # ffffffffc02064e0 <default_pmm_manager+0x850>
ffffffffc0202fb8:	00003617          	auipc	a2,0x3
ffffffffc0202fbc:	94060613          	addi	a2,a2,-1728 # ffffffffc02058f8 <commands+0x870>
ffffffffc0202fc0:	0de00593          	li	a1,222
ffffffffc0202fc4:	00003517          	auipc	a0,0x3
ffffffffc0202fc8:	3f450513          	addi	a0,a0,1012 # ffffffffc02063b8 <default_pmm_manager+0x728>
ffffffffc0202fcc:	c84fd0ef          	jal	ra,ffffffffc0200450 <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0202fd0:	00003697          	auipc	a3,0x3
ffffffffc0202fd4:	4f868693          	addi	a3,a3,1272 # ffffffffc02064c8 <default_pmm_manager+0x838>
ffffffffc0202fd8:	00003617          	auipc	a2,0x3
ffffffffc0202fdc:	92060613          	addi	a2,a2,-1760 # ffffffffc02058f8 <commands+0x870>
ffffffffc0202fe0:	0dd00593          	li	a1,221
ffffffffc0202fe4:	00003517          	auipc	a0,0x3
ffffffffc0202fe8:	3d450513          	addi	a0,a0,980 # ffffffffc02063b8 <default_pmm_manager+0x728>
ffffffffc0202fec:	c64fd0ef          	jal	ra,ffffffffc0200450 <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc0202ff0:	00003697          	auipc	a3,0x3
ffffffffc0202ff4:	5a068693          	addi	a3,a3,1440 # ffffffffc0206590 <default_pmm_manager+0x900>
ffffffffc0202ff8:	00003617          	auipc	a2,0x3
ffffffffc0202ffc:	90060613          	addi	a2,a2,-1792 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203000:	0fc00593          	li	a1,252
ffffffffc0203004:	00003517          	auipc	a0,0x3
ffffffffc0203008:	3b450513          	addi	a0,a0,948 # ffffffffc02063b8 <default_pmm_manager+0x728>
ffffffffc020300c:	c44fd0ef          	jal	ra,ffffffffc0200450 <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0203010:	00003617          	auipc	a2,0x3
ffffffffc0203014:	38860613          	addi	a2,a2,904 # ffffffffc0206398 <default_pmm_manager+0x708>
ffffffffc0203018:	02a00593          	li	a1,42
ffffffffc020301c:	00003517          	auipc	a0,0x3
ffffffffc0203020:	39c50513          	addi	a0,a0,924 # ffffffffc02063b8 <default_pmm_manager+0x728>
ffffffffc0203024:	c2cfd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(pgfault_num==2);
ffffffffc0203028:	00003697          	auipc	a3,0x3
ffffffffc020302c:	53868693          	addi	a3,a3,1336 # ffffffffc0206560 <default_pmm_manager+0x8d0>
ffffffffc0203030:	00003617          	auipc	a2,0x3
ffffffffc0203034:	8c860613          	addi	a2,a2,-1848 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203038:	09800593          	li	a1,152
ffffffffc020303c:	00003517          	auipc	a0,0x3
ffffffffc0203040:	37c50513          	addi	a0,a0,892 # ffffffffc02063b8 <default_pmm_manager+0x728>
ffffffffc0203044:	c0cfd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(pgfault_num==2);
ffffffffc0203048:	00003697          	auipc	a3,0x3
ffffffffc020304c:	51868693          	addi	a3,a3,1304 # ffffffffc0206560 <default_pmm_manager+0x8d0>
ffffffffc0203050:	00003617          	auipc	a2,0x3
ffffffffc0203054:	8a860613          	addi	a2,a2,-1880 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203058:	09a00593          	li	a1,154
ffffffffc020305c:	00003517          	auipc	a0,0x3
ffffffffc0203060:	35c50513          	addi	a0,a0,860 # ffffffffc02063b8 <default_pmm_manager+0x728>
ffffffffc0203064:	becfd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(pgfault_num==3);
ffffffffc0203068:	00003697          	auipc	a3,0x3
ffffffffc020306c:	50868693          	addi	a3,a3,1288 # ffffffffc0206570 <default_pmm_manager+0x8e0>
ffffffffc0203070:	00003617          	auipc	a2,0x3
ffffffffc0203074:	88860613          	addi	a2,a2,-1912 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203078:	09c00593          	li	a1,156
ffffffffc020307c:	00003517          	auipc	a0,0x3
ffffffffc0203080:	33c50513          	addi	a0,a0,828 # ffffffffc02063b8 <default_pmm_manager+0x728>
ffffffffc0203084:	bccfd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(pgfault_num==3);
ffffffffc0203088:	00003697          	auipc	a3,0x3
ffffffffc020308c:	4e868693          	addi	a3,a3,1256 # ffffffffc0206570 <default_pmm_manager+0x8e0>
ffffffffc0203090:	00003617          	auipc	a2,0x3
ffffffffc0203094:	86860613          	addi	a2,a2,-1944 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203098:	09e00593          	li	a1,158
ffffffffc020309c:	00003517          	auipc	a0,0x3
ffffffffc02030a0:	31c50513          	addi	a0,a0,796 # ffffffffc02063b8 <default_pmm_manager+0x728>
ffffffffc02030a4:	bacfd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(pgfault_num==1);
ffffffffc02030a8:	00003697          	auipc	a3,0x3
ffffffffc02030ac:	4a868693          	addi	a3,a3,1192 # ffffffffc0206550 <default_pmm_manager+0x8c0>
ffffffffc02030b0:	00003617          	auipc	a2,0x3
ffffffffc02030b4:	84860613          	addi	a2,a2,-1976 # ffffffffc02058f8 <commands+0x870>
ffffffffc02030b8:	09400593          	li	a1,148
ffffffffc02030bc:	00003517          	auipc	a0,0x3
ffffffffc02030c0:	2fc50513          	addi	a0,a0,764 # ffffffffc02063b8 <default_pmm_manager+0x728>
ffffffffc02030c4:	b8cfd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(pgfault_num==1);
ffffffffc02030c8:	00003697          	auipc	a3,0x3
ffffffffc02030cc:	48868693          	addi	a3,a3,1160 # ffffffffc0206550 <default_pmm_manager+0x8c0>
ffffffffc02030d0:	00003617          	auipc	a2,0x3
ffffffffc02030d4:	82860613          	addi	a2,a2,-2008 # ffffffffc02058f8 <commands+0x870>
ffffffffc02030d8:	09600593          	li	a1,150
ffffffffc02030dc:	00003517          	auipc	a0,0x3
ffffffffc02030e0:	2dc50513          	addi	a0,a0,732 # ffffffffc02063b8 <default_pmm_manager+0x728>
ffffffffc02030e4:	b6cfd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(pgfault_num==4);
ffffffffc02030e8:	00003697          	auipc	a3,0x3
ffffffffc02030ec:	49868693          	addi	a3,a3,1176 # ffffffffc0206580 <default_pmm_manager+0x8f0>
ffffffffc02030f0:	00003617          	auipc	a2,0x3
ffffffffc02030f4:	80860613          	addi	a2,a2,-2040 # ffffffffc02058f8 <commands+0x870>
ffffffffc02030f8:	0a000593          	li	a1,160
ffffffffc02030fc:	00003517          	auipc	a0,0x3
ffffffffc0203100:	2bc50513          	addi	a0,a0,700 # ffffffffc02063b8 <default_pmm_manager+0x728>
ffffffffc0203104:	b4cfd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(pgfault_num==4);
ffffffffc0203108:	00003697          	auipc	a3,0x3
ffffffffc020310c:	47868693          	addi	a3,a3,1144 # ffffffffc0206580 <default_pmm_manager+0x8f0>
ffffffffc0203110:	00002617          	auipc	a2,0x2
ffffffffc0203114:	7e860613          	addi	a2,a2,2024 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203118:	0a200593          	li	a1,162
ffffffffc020311c:	00003517          	auipc	a0,0x3
ffffffffc0203120:	29c50513          	addi	a0,a0,668 # ffffffffc02063b8 <default_pmm_manager+0x728>
ffffffffc0203124:	b2cfd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(pgdir[0] == 0);
ffffffffc0203128:	00003697          	auipc	a3,0x3
ffffffffc020312c:	30868693          	addi	a3,a3,776 # ffffffffc0206430 <default_pmm_manager+0x7a0>
ffffffffc0203130:	00002617          	auipc	a2,0x2
ffffffffc0203134:	7c860613          	addi	a2,a2,1992 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203138:	0cd00593          	li	a1,205
ffffffffc020313c:	00003517          	auipc	a0,0x3
ffffffffc0203140:	27c50513          	addi	a0,a0,636 # ffffffffc02063b8 <default_pmm_manager+0x728>
ffffffffc0203144:	b0cfd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(vma != NULL);
ffffffffc0203148:	00003697          	auipc	a3,0x3
ffffffffc020314c:	2f868693          	addi	a3,a3,760 # ffffffffc0206440 <default_pmm_manager+0x7b0>
ffffffffc0203150:	00002617          	auipc	a2,0x2
ffffffffc0203154:	7a860613          	addi	a2,a2,1960 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203158:	0d000593          	li	a1,208
ffffffffc020315c:	00003517          	auipc	a0,0x3
ffffffffc0203160:	25c50513          	addi	a0,a0,604 # ffffffffc02063b8 <default_pmm_manager+0x728>
ffffffffc0203164:	aecfd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(temp_ptep!= NULL);
ffffffffc0203168:	00003697          	auipc	a3,0x3
ffffffffc020316c:	32068693          	addi	a3,a3,800 # ffffffffc0206488 <default_pmm_manager+0x7f8>
ffffffffc0203170:	00002617          	auipc	a2,0x2
ffffffffc0203174:	78860613          	addi	a2,a2,1928 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203178:	0d800593          	li	a1,216
ffffffffc020317c:	00003517          	auipc	a0,0x3
ffffffffc0203180:	23c50513          	addi	a0,a0,572 # ffffffffc02063b8 <default_pmm_manager+0x728>
ffffffffc0203184:	accfd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert( nr_free == 0);         
ffffffffc0203188:	00003697          	auipc	a3,0x3
ffffffffc020318c:	94868693          	addi	a3,a3,-1720 # ffffffffc0205ad0 <commands+0xa48>
ffffffffc0203190:	00002617          	auipc	a2,0x2
ffffffffc0203194:	76860613          	addi	a2,a2,1896 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203198:	0f400593          	li	a1,244
ffffffffc020319c:	00003517          	auipc	a0,0x3
ffffffffc02031a0:	21c50513          	addi	a0,a0,540 # ffffffffc02063b8 <default_pmm_manager+0x728>
ffffffffc02031a4:	aacfd0ef          	jal	ra,ffffffffc0200450 <__panic>
    return KADDR(page2pa(page));
ffffffffc02031a8:	00003617          	auipc	a2,0x3
ffffffffc02031ac:	b3860613          	addi	a2,a2,-1224 # ffffffffc0205ce0 <default_pmm_manager+0x50>
ffffffffc02031b0:	06900593          	li	a1,105
ffffffffc02031b4:	00003517          	auipc	a0,0x3
ffffffffc02031b8:	b5450513          	addi	a0,a0,-1196 # ffffffffc0205d08 <default_pmm_manager+0x78>
ffffffffc02031bc:	a94fd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(count==0);
ffffffffc02031c0:	00003697          	auipc	a3,0x3
ffffffffc02031c4:	44068693          	addi	a3,a3,1088 # ffffffffc0206600 <default_pmm_manager+0x970>
ffffffffc02031c8:	00002617          	auipc	a2,0x2
ffffffffc02031cc:	73060613          	addi	a2,a2,1840 # ffffffffc02058f8 <commands+0x870>
ffffffffc02031d0:	11c00593          	li	a1,284
ffffffffc02031d4:	00003517          	auipc	a0,0x3
ffffffffc02031d8:	1e450513          	addi	a0,a0,484 # ffffffffc02063b8 <default_pmm_manager+0x728>
ffffffffc02031dc:	a74fd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(total==0);
ffffffffc02031e0:	00003697          	auipc	a3,0x3
ffffffffc02031e4:	43068693          	addi	a3,a3,1072 # ffffffffc0206610 <default_pmm_manager+0x980>
ffffffffc02031e8:	00002617          	auipc	a2,0x2
ffffffffc02031ec:	71060613          	addi	a2,a2,1808 # ffffffffc02058f8 <commands+0x870>
ffffffffc02031f0:	11d00593          	li	a1,285
ffffffffc02031f4:	00003517          	auipc	a0,0x3
ffffffffc02031f8:	1c450513          	addi	a0,a0,452 # ffffffffc02063b8 <default_pmm_manager+0x728>
ffffffffc02031fc:	a54fd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc0203200:	00003697          	auipc	a3,0x3
ffffffffc0203204:	30068693          	addi	a3,a3,768 # ffffffffc0206500 <default_pmm_manager+0x870>
ffffffffc0203208:	00002617          	auipc	a2,0x2
ffffffffc020320c:	6f060613          	addi	a2,a2,1776 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203210:	0eb00593          	li	a1,235
ffffffffc0203214:	00003517          	auipc	a0,0x3
ffffffffc0203218:	1a450513          	addi	a0,a0,420 # ffffffffc02063b8 <default_pmm_manager+0x728>
ffffffffc020321c:	a34fd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(mm != NULL);
ffffffffc0203220:	00003697          	auipc	a3,0x3
ffffffffc0203224:	1e868693          	addi	a3,a3,488 # ffffffffc0206408 <default_pmm_manager+0x778>
ffffffffc0203228:	00002617          	auipc	a2,0x2
ffffffffc020322c:	6d060613          	addi	a2,a2,1744 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203230:	0c500593          	li	a1,197
ffffffffc0203234:	00003517          	auipc	a0,0x3
ffffffffc0203238:	18450513          	addi	a0,a0,388 # ffffffffc02063b8 <default_pmm_manager+0x728>
ffffffffc020323c:	a14fd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(check_mm_struct == NULL);
ffffffffc0203240:	00003697          	auipc	a3,0x3
ffffffffc0203244:	1d868693          	addi	a3,a3,472 # ffffffffc0206418 <default_pmm_manager+0x788>
ffffffffc0203248:	00002617          	auipc	a2,0x2
ffffffffc020324c:	6b060613          	addi	a2,a2,1712 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203250:	0c800593          	li	a1,200
ffffffffc0203254:	00003517          	auipc	a0,0x3
ffffffffc0203258:	16450513          	addi	a0,a0,356 # ffffffffc02063b8 <default_pmm_manager+0x728>
ffffffffc020325c:	9f4fd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(ret==0);
ffffffffc0203260:	00003697          	auipc	a3,0x3
ffffffffc0203264:	39868693          	addi	a3,a3,920 # ffffffffc02065f8 <default_pmm_manager+0x968>
ffffffffc0203268:	00002617          	auipc	a2,0x2
ffffffffc020326c:	69060613          	addi	a2,a2,1680 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203270:	10300593          	li	a1,259
ffffffffc0203274:	00003517          	auipc	a0,0x3
ffffffffc0203278:	14450513          	addi	a0,a0,324 # ffffffffc02063b8 <default_pmm_manager+0x728>
ffffffffc020327c:	9d4fd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(total == nr_free_pages());
ffffffffc0203280:	00002697          	auipc	a3,0x2
ffffffffc0203284:	6a868693          	addi	a3,a3,1704 # ffffffffc0205928 <commands+0x8a0>
ffffffffc0203288:	00002617          	auipc	a2,0x2
ffffffffc020328c:	67060613          	addi	a2,a2,1648 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203290:	0c000593          	li	a1,192
ffffffffc0203294:	00003517          	auipc	a0,0x3
ffffffffc0203298:	12450513          	addi	a0,a0,292 # ffffffffc02063b8 <default_pmm_manager+0x728>
...
ffffffffc02032ec:	3b8b0b13          	addi	s6,s6,952 # ffffffffc02066a0 <default_pmm_manager+0xa10>
                    cprintf("SWAP: failed to save\n");
ffffffffc02032f0:	00003b97          	auipc	s7,0x3
ffffffffc02032f4:	398b8b93          	addi	s7,s7,920 # ffffffffc0206688 <default_pmm_manager+0x9f8>
...
ffffffffc0203364:	625000ef          	jal	ra,ffffffffc0204188 <swapfs_write>
...
ffffffffc02033a6:	29e50513          	addi	a0,a0,670 # ffffffffc0206640 <default_pmm_manager+0x9b0>
...
ffffffffc02033b8:	2bc68693          	addi	a3,a3,700 # ffffffffc0206670 <default_pmm_manager+0x9e0>
ffffffffc02033bc:	00002617          	auipc	a2,0x2
ffffffffc02033c0:	53c60613          	addi	a2,a2,1340 # ffffffffc02058f8 <commands+0x870>
ffffffffc02033c4:	06900593          	li	a1,105
ffffffffc02033c8:	00003517          	auipc	a0,0x3
ffffffffc02033cc:	ff050513          	addi	a0,a0,-16 # ffffffffc02063b8 <default_pmm_manager+0x728>
...
ffffffffc0203402:	4ef000ef          	jal	ra,ffffffffc02040f0 <swapfs_read>
     cprintf("swap_in: load disk swap entry %d with swap_page in vadr 0x%x\n", (*ptep)>>8, addr);
ffffffffc0203406:	00093583          	ld	a1,0(s2)
ffffffffc020340a:	8626                	mv	a2,s1
ffffffffc020340c:	00003517          	auipc	a0,0x3
ffffffffc0203410:	f4c50513          	addi	a0,a0,-180 # ffffffffc0206358 <default_pmm_manager+0x6c8>
...
ffffffffc0203432:	f1a68693          	addi	a3,a3,-230 # ffffffffc0206348 <default_pmm_manager+0x6b8>
ffffffffc0203436:	00002617          	auipc	a2,0x2
ffffffffc020343a:	4c260613          	addi	a2,a2,1218 # ffffffffc02058f8 <commands+0x870>
ffffffffc020343e:	07f00593          	li	a1,127
ffffffffc0203442:	00003517          	auipc	a0,0x3
ffffffffc0203446:	f7650513          	addi	a0,a0,-138 # ffffffffc02063b8 <default_pmm_manager+0x728>
...
ffffffffc0203476:	26e50513          	addi	a0,a0,622 # ffffffffc02066e0 <default_pmm_manager+0xa50>
    *(unsigned char *)0x3000 = 0x0c;
...
ffffffffc02034ae:	27650513          	addi	a0,a0,630 # ffffffffc0206720 <default_pmm_manager+0xa90>
    *(unsigned char *)0x1000 = 0x0a;
...
ffffffffc02034cc:	28050513          	addi	a0,a0,640 # ffffffffc0206748 <default_pmm_manager+0xab8>
    *(unsigned char *)0x4000 = 0x0d;
...
ffffffffc02034e8:	28c50513          	addi	a0,a0,652 # ffffffffc0206770 <default_pmm_manager+0xae0>
    *(unsigned char *)0x2000 = 0x0b;
...
ffffffffc0203504:	29850513          	addi	a0,a0,664 # ffffffffc0206798 <default_pmm_manager+0xb08>
...
ffffffffc0203522:	25250513          	addi	a0,a0,594 # ffffffffc0206770 <default_pmm_manager+0xae0>
...
ffffffffc020353a:	1ea50513          	addi	a0,a0,490 # ffffffffc0206720 <default_pmm_manager+0xa90>
...
ffffffffc0203554:	22050513          	addi	a0,a0,544 # ffffffffc0206770 <default_pmm_manager+0xae0>
...
ffffffffc020356e:	17650513          	addi	a0,a0,374 # ffffffffc02066e0 <default_pmm_manager+0xa50>
...
ffffffffc0203588:	1c450513          	addi	a0,a0,452 # ffffffffc0206748 <default_pmm_manager+0xab8>
...
ffffffffc02035a2:	1fa50513          	addi	a0,a0,506 # ffffffffc0206798 <default_pmm_manager+0xb08>
...
ffffffffc02035c0:	16450513          	addi	a0,a0,356 # ffffffffc0206720 <default_pmm_manager+0xa90>
...
ffffffffc02035fc:	f8868693          	addi	a3,a3,-120 # ffffffffc0206580 <default_pmm_manager+0x8f0>
ffffffffc0203600:	00002617          	auipc	a2,0x2
ffffffffc0203604:	2f860613          	addi	a2,a2,760 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203608:	05800593          	li	a1,88
ffffffffc020360c:	00003517          	auipc	a0,0x3
ffffffffc0203610:	0fc50513          	addi	a0,a0,252 # ffffffffc0206708 <default_pmm_manager+0xa78>
ffffffffc0203614:	e3dfc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pgfault_num==11);
ffffffffc0203618:	00003697          	auipc	a3,0x3
ffffffffc020361c:	23068693          	addi	a3,a3,560 # ffffffffc0206848 <default_pmm_manager+0xbb8>
ffffffffc0203620:	00002617          	auipc	a2,0x2
ffffffffc0203624:	2d860613          	addi	a2,a2,728 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203628:	07a00593          	li	a1,122
ffffffffc020362c:	00003517          	auipc	a0,0x3
ffffffffc0203630:	0dc50513          	addi	a0,a0,220 # ffffffffc0206708 <default_pmm_manager+0xa78>
ffffffffc0203634:	e1dfc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc0203638:	00003697          	auipc	a3,0x3
ffffffffc020363c:	1e868693          	addi	a3,a3,488 # ffffffffc0206820 <default_pmm_manager+0xb90>
ffffffffc0203640:	00002617          	auipc	a2,0x2
ffffffffc0203644:	2b860613          	addi	a2,a2,696 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203648:	07800593          	li	a1,120
ffffffffc020364c:	00003517          	auipc	a0,0x3
ffffffffc0203650:	0bc50513          	addi	a0,a0,188 # ffffffffc0206708 <default_pmm_manager+0xa78>
ffffffffc0203654:	dfdfc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pgfault_num==10);
ffffffffc0203658:	00003697          	auipc	a3,0x3
ffffffffc020365c:	1b868693          	addi	a3,a3,440 # ffffffffc0206810 <default_pmm_manager+0xb80>
ffffffffc0203660:	00002617          	auipc	a2,0x2
ffffffffc0203664:	29860613          	addi	a2,a2,664 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203668:	07600593          	li	a1,118
ffffffffc020366c:	00003517          	auipc	a0,0x3
ffffffffc0203670:	09c50513          	addi	a0,a0,156 # ffffffffc0206708 <default_pmm_manager+0xa78>
ffffffffc0203674:	dddfc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pgfault_num==9);
ffffffffc0203678:	00003697          	auipc	a3,0x3
ffffffffc020367c:	18868693          	addi	a3,a3,392 # ffffffffc0206800 <default_pmm_manager+0xb70>
ffffffffc0203680:	00002617          	auipc	a2,0x2
ffffffffc0203684:	27860613          	addi	a2,a2,632 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203688:	07300593          	li	a1,115
ffffffffc020368c:	00003517          	auipc	a0,0x3
ffffffffc0203690:	07c50513          	addi	a0,a0,124 # ffffffffc0206708 <default_pmm_manager+0xa78>
ffffffffc0203694:	dbdfc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pgfault_num==8);
ffffffffc0203698:	00003697          	auipc	a3,0x3
ffffffffc020369c:	15868693          	addi	a3,a3,344 # ffffffffc02067f0 <default_pmm_manager+0xb60>
ffffffffc02036a0:	00002617          	auipc	a2,0x2
ffffffffc02036a4:	25860613          	addi	a2,a2,600 # ffffffffc02058f8 <commands+0x870>
ffffffffc02036a8:	07000593          	li	a1,112
ffffffffc02036ac:	00003517          	auipc	a0,0x3
ffffffffc02036b0:	05c50513          	addi	a0,a0,92 # ffffffffc0206708 <default_pmm_manager+0xa78>
ffffffffc02036b4:	d9dfc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pgfault_num==7);
ffffffffc02036b8:	00003697          	auipc	a3,0x3
ffffffffc02036bc:	12868693          	addi	a3,a3,296 # ffffffffc02067e0 <default_pmm_manager+0xb50>
ffffffffc02036c0:	00002617          	auipc	a2,0x2
ffffffffc02036c4:	23860613          	addi	a2,a2,568 # ffffffffc02058f8 <commands+0x870>
ffffffffc02036c8:	06d00593          	li	a1,109
ffffffffc02036cc:	00003517          	auipc	a0,0x3
ffffffffc02036d0:	03c50513          	addi	a0,a0,60 # ffffffffc0206708 <default_pmm_manager+0xa78>
ffffffffc02036d4:	d7dfc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pgfault_num==6);
ffffffffc02036d8:	00003697          	auipc	a3,0x3
ffffffffc02036dc:	0f868693          	addi	a3,a3,248 # ffffffffc02067d0 <default_pmm_manager+0xb40>
ffffffffc02036e0:	00002617          	auipc	a2,0x2
ffffffffc02036e4:	21860613          	addi	a2,a2,536 # ffffffffc02058f8 <commands+0x870>
ffffffffc02036e8:	06a00593          	li	a1,106
ffffffffc02036ec:	00003517          	auipc	a0,0x3
ffffffffc02036f0:	01c50513          	addi	a0,a0,28 # ffffffffc0206708 <default_pmm_manager+0xa78>
ffffffffc02036f4:	d5dfc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pgfault_num==5);
ffffffffc02036f8:	00003697          	auipc	a3,0x3
ffffffffc02036fc:	0c868693          	addi	a3,a3,200 # ffffffffc02067c0 <default_pmm_manager+0xb30>
ffffffffc0203700:	00002617          	auipc	a2,0x2
ffffffffc0203704:	1f860613          	addi	a2,a2,504 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203708:	06700593          	li	a1,103
ffffffffc020370c:	00003517          	auipc	a0,0x3
ffffffffc0203710:	ffc50513          	addi	a0,a0,-4 # ffffffffc0206708 <default_pmm_manager+0xa78>
ffffffffc0203714:	d3dfc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pgfault_num==5);
ffffffffc0203718:	00003697          	auipc	a3,0x3
ffffffffc020371c:	0a868693          	addi	a3,a3,168 # ffffffffc02067c0 <default_pmm_manager+0xb30>
ffffffffc0203720:	00002617          	auipc	a2,0x2
ffffffffc0203724:	1d860613          	addi	a2,a2,472 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203728:	06400593          	li	a1,100
ffffffffc020372c:	00003517          	auipc	a0,0x3
ffffffffc0203730:	fdc50513          	addi	a0,a0,-36 # ffffffffc0206708 <default_pmm_manager+0xa78>
ffffffffc0203734:	d1dfc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pgfault_num==4);
ffffffffc0203738:	00003697          	auipc	a3,0x3
ffffffffc020373c:	e4868693          	addi	a3,a3,-440 # ffffffffc0206580 <default_pmm_manager+0x8f0>
ffffffffc0203740:	00002617          	auipc	a2,0x2
ffffffffc0203744:	1b860613          	addi	a2,a2,440 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203748:	06100593          	li	a1,97
ffffffffc020374c:	00003517          	auipc	a0,0x3
ffffffffc0203750:	fbc50513          	addi	a0,a0,-68 # ffffffffc0206708 <default_pmm_manager+0xa78>
ffffffffc0203754:	cfdfc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pgfault_num==4);
ffffffffc0203758:	00003697          	auipc	a3,0x3
ffffffffc020375c:	e2868693          	addi	a3,a3,-472 # ffffffffc0206580 <default_pmm_manager+0x8f0>
ffffffffc0203760:	00002617          	auipc	a2,0x2
ffffffffc0203764:	19860613          	addi	a2,a2,408 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203768:	05e00593          	li	a1,94
ffffffffc020376c:	00003517          	auipc	a0,0x3
ffffffffc0203770:	f9c50513          	addi	a0,a0,-100 # ffffffffc0206708 <default_pmm_manager+0xa78>
ffffffffc0203774:	cddfc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pgfault_num==4);
ffffffffc0203778:	00003697          	auipc	a3,0x3
ffffffffc020377c:	e0868693          	addi	a3,a3,-504 # ffffffffc0206580 <default_pmm_manager+0x8f0>
ffffffffc0203780:	00002617          	auipc	a2,0x2
ffffffffc0203784:	17860613          	addi	a2,a2,376 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203788:	05b00593          	li	a1,91
ffffffffc020378c:	00003517          	auipc	a0,0x3
ffffffffc0203790:	f7c50513          	addi	a0,a0,-132 # ffffffffc0206708 <default_pmm_manager+0xa78>
...
ffffffffc02037ce:	0be68693          	addi	a3,a3,190 # ffffffffc0206888 <default_pmm_manager+0xbf8>
ffffffffc02037d2:	00002617          	auipc	a2,0x2
ffffffffc02037d6:	12660613          	addi	a2,a2,294 # ffffffffc02058f8 <commands+0x870>
ffffffffc02037da:	04200593          	li	a1,66
ffffffffc02037de:	00003517          	auipc	a0,0x3
ffffffffc02037e2:	f2a50513          	addi	a0,a0,-214 # ffffffffc0206708 <default_pmm_manager+0xa78>
ffffffffc02037e6:	c6bfc0ef          	jal	ra,ffffffffc0200450 <__panic>
         assert(head != NULL);
ffffffffc02037ea:	00003697          	auipc	a3,0x3
ffffffffc02037ee:	08e68693          	addi	a3,a3,142 # ffffffffc0206878 <default_pmm_manager+0xbe8>
ffffffffc02037f2:	00002617          	auipc	a2,0x2
ffffffffc02037f6:	10660613          	addi	a2,a2,262 # ffffffffc02058f8 <commands+0x870>
ffffffffc02037fa:	04100593          	li	a1,65
ffffffffc02037fe:	00003517          	auipc	a0,0x3
ffffffffc0203802:	f0a50513          	addi	a0,a0,-246 # ffffffffc0206708 <default_pmm_manager+0xa78>
...
ffffffffc0203828:	03468693          	addi	a3,a3,52 # ffffffffc0206858 <default_pmm_manager+0xbc8>
ffffffffc020382c:	00002617          	auipc	a2,0x2
ffffffffc0203830:	0cc60613          	addi	a2,a2,204 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203834:	03200593          	li	a1,50
ffffffffc0203838:	00003517          	auipc	a0,0x3
ffffffffc020383c:	ed050513          	addi	a0,a0,-304 # ffffffffc0206708 <default_pmm_manager+0xa78>
{
...
ffffffffc020384c:	06868693          	addi	a3,a3,104 # ffffffffc02068b0 <default_pmm_manager+0xc20>
ffffffffc0203850:	00002617          	auipc	a2,0x2
ffffffffc0203854:	0a860613          	addi	a2,a2,168 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203858:	07e00593          	li	a1,126
ffffffffc020385c:	00003517          	auipc	a0,0x3
ffffffffc0203860:	07450513          	addi	a0,a0,116 # ffffffffc02068d0 <default_pmm_manager+0xc40>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
...
ffffffffc0203994:	04868693          	addi	a3,a3,72 # ffffffffc02069d8 <default_pmm_manager+0xd48>
ffffffffc0203998:	00002617          	auipc	a2,0x2
ffffffffc020399c:	f6060613          	addi	a2,a2,-160 # ffffffffc02058f8 <commands+0x870>
ffffffffc02039a0:	08500593          	li	a1,133
ffffffffc02039a4:	00003517          	auipc	a0,0x3
ffffffffc02039a8:	f2c50513          	addi	a0,a0,-212 # ffffffffc02068d0 <default_pmm_manager+0xc40>
ffffffffc02039ac:	aa5fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc02039b0:	00003697          	auipc	a3,0x3
ffffffffc02039b4:	06868693          	addi	a3,a3,104 # ffffffffc0206a18 <default_pmm_manager+0xd88>
ffffffffc02039b8:	00002617          	auipc	a2,0x2
ffffffffc02039bc:	f4060613          	addi	a2,a2,-192 # ffffffffc02058f8 <commands+0x870>
ffffffffc02039c0:	07d00593          	li	a1,125
ffffffffc02039c4:	00003517          	auipc	a0,0x3
ffffffffc02039c8:	f0c50513          	addi	a0,a0,-244 # ffffffffc02068d0 <default_pmm_manager+0xc40>
ffffffffc02039cc:	a85fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc02039d0:	00003697          	auipc	a3,0x3
ffffffffc02039d4:	02868693          	addi	a3,a3,40 # ffffffffc02069f8 <default_pmm_manager+0xd68>
ffffffffc02039d8:	00002617          	auipc	a2,0x2
ffffffffc02039dc:	f2060613          	addi	a2,a2,-224 # ffffffffc02058f8 <commands+0x870>
ffffffffc02039e0:	07c00593          	li	a1,124
ffffffffc02039e4:	00003517          	auipc	a0,0x3
ffffffffc02039e8:	eec50513          	addi	a0,a0,-276 # ffffffffc02068d0 <default_pmm_manager+0xc40>
...
ffffffffc0203a62:	9e268693          	addi	a3,a3,-1566 # ffffffffc0206440 <default_pmm_manager+0x7b0>
ffffffffc0203a66:	00002617          	auipc	a2,0x2
ffffffffc0203a6a:	e9260613          	addi	a2,a2,-366 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203a6e:	0c900593          	li	a1,201
ffffffffc0203a72:	00003517          	auipc	a0,0x3
ffffffffc0203a76:	e5e50513          	addi	a0,a0,-418 # ffffffffc02068d0 <default_pmm_manager+0xc40>
...
ffffffffc0203ab0:	99468693          	addi	a3,a3,-1644 # ffffffffc0206440 <default_pmm_manager+0x7b0>
ffffffffc0203ab4:	00002617          	auipc	a2,0x2
ffffffffc0203ab8:	e4460613          	addi	a2,a2,-444 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203abc:	0cf00593          	li	a1,207
ffffffffc0203ac0:	00003517          	auipc	a0,0x3
ffffffffc0203ac4:	e1050513          	addi	a0,a0,-496 # ffffffffc02068d0 <default_pmm_manager+0xc40>
...
ffffffffc0203b84:	fb850513          	addi	a0,a0,-72 # ffffffffc0206b38 <default_pmm_manager+0xea8>
ffffffffc0203b88:	e06fc0ef          	jal	ra,ffffffffc020018e <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0203b8c:	00003697          	auipc	a3,0x3
ffffffffc0203b90:	fd468693          	addi	a3,a3,-44 # ffffffffc0206b60 <default_pmm_manager+0xed0>
ffffffffc0203b94:	00002617          	auipc	a2,0x2
ffffffffc0203b98:	d6460613          	addi	a2,a2,-668 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203b9c:	0f100593          	li	a1,241
ffffffffc0203ba0:	00003517          	auipc	a0,0x3
ffffffffc0203ba4:	d3050513          	addi	a0,a0,-720 # ffffffffc02068d0 <default_pmm_manager+0xc40>
...
ffffffffc0203bbc:	fc050513          	addi	a0,a0,-64 # ffffffffc0206b78 <default_pmm_manager+0xee8>
...
ffffffffc0203c72:	42268693          	addi	a3,a3,1058 # ffffffffc0207090 <nbase>
...
ffffffffc0203d10:	efc50513          	addi	a0,a0,-260 # ffffffffc0206c08 <default_pmm_manager+0xf78>
...
ffffffffc0203d2a:	f0250513          	addi	a0,a0,-254 # ffffffffc0206c28 <default_pmm_manager+0xf98>
}
...
ffffffffc0203d38:	d1c68693          	addi	a3,a3,-740 # ffffffffc0206a50 <default_pmm_manager+0xdc0>
ffffffffc0203d3c:	00002617          	auipc	a2,0x2
ffffffffc0203d40:	bbc60613          	addi	a2,a2,-1092 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203d44:	0d800593          	li	a1,216
ffffffffc0203d48:	00003517          	auipc	a0,0x3
ffffffffc0203d4c:	b8850513          	addi	a0,a0,-1144 # ffffffffc02068d0 <default_pmm_manager+0xc40>
ffffffffc0203d50:	f00fc0ef          	jal	ra,ffffffffc0200450 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203d54:	00003697          	auipc	a3,0x3
ffffffffc0203d58:	d8468693          	addi	a3,a3,-636 # ffffffffc0206ad8 <default_pmm_manager+0xe48>
ffffffffc0203d5c:	00002617          	auipc	a2,0x2
ffffffffc0203d60:	b9c60613          	addi	a2,a2,-1124 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203d64:	0e800593          	li	a1,232
ffffffffc0203d68:	00003517          	auipc	a0,0x3
ffffffffc0203d6c:	b6850513          	addi	a0,a0,-1176 # ffffffffc02068d0 <default_pmm_manager+0xc40>
ffffffffc0203d70:	ee0fc0ef          	jal	ra,ffffffffc0200450 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203d74:	00003697          	auipc	a3,0x3
ffffffffc0203d78:	d9468693          	addi	a3,a3,-620 # ffffffffc0206b08 <default_pmm_manager+0xe78>
ffffffffc0203d7c:	00002617          	auipc	a2,0x2
ffffffffc0203d80:	b7c60613          	addi	a2,a2,-1156 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203d84:	0e900593          	li	a1,233
ffffffffc0203d88:	00003517          	auipc	a0,0x3
ffffffffc0203d8c:	b4850513          	addi	a0,a0,-1208 # ffffffffc02068d0 <default_pmm_manager+0xc40>
ffffffffc0203d90:	ec0fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(vma != NULL);
ffffffffc0203d94:	00002697          	auipc	a3,0x2
ffffffffc0203d98:	6ac68693          	addi	a3,a3,1708 # ffffffffc0206440 <default_pmm_manager+0x7b0>
ffffffffc0203d9c:	00002617          	auipc	a2,0x2
ffffffffc0203da0:	b5c60613          	addi	a2,a2,-1188 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203da4:	10800593          	li	a1,264
ffffffffc0203da8:	00003517          	auipc	a0,0x3
ffffffffc0203dac:	b2850513          	addi	a0,a0,-1240 # ffffffffc02068d0 <default_pmm_manager+0xc40>
ffffffffc0203db0:	ea0fc0ef          	jal	ra,ffffffffc0200450 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203db4:	00003697          	auipc	a3,0x3
ffffffffc0203db8:	c8468693          	addi	a3,a3,-892 # ffffffffc0206a38 <default_pmm_manager+0xda8>
ffffffffc0203dbc:	00002617          	auipc	a2,0x2
ffffffffc0203dc0:	b3c60613          	addi	a2,a2,-1220 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203dc4:	0d600593          	li	a1,214
ffffffffc0203dc8:	00003517          	auipc	a0,0x3
ffffffffc0203dcc:	b0850513          	addi	a0,a0,-1272 # ffffffffc02068d0 <default_pmm_manager+0xc40>
ffffffffc0203dd0:	e80fc0ef          	jal	ra,ffffffffc0200450 <__panic>
        assert(vma3 == NULL);
ffffffffc0203dd4:	00003697          	auipc	a3,0x3
ffffffffc0203dd8:	cd468693          	addi	a3,a3,-812 # ffffffffc0206aa8 <default_pmm_manager+0xe18>
ffffffffc0203ddc:	00002617          	auipc	a2,0x2
ffffffffc0203de0:	b1c60613          	addi	a2,a2,-1252 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203de4:	0e200593          	li	a1,226
ffffffffc0203de8:	00003517          	auipc	a0,0x3
ffffffffc0203dec:	ae850513          	addi	a0,a0,-1304 # ffffffffc02068d0 <default_pmm_manager+0xc40>
ffffffffc0203df0:	e60fc0ef          	jal	ra,ffffffffc0200450 <__panic>
        assert(vma2 != NULL);
ffffffffc0203df4:	00003697          	auipc	a3,0x3
ffffffffc0203df8:	ca468693          	addi	a3,a3,-860 # ffffffffc0206a98 <default_pmm_manager+0xe08>
ffffffffc0203dfc:	00002617          	auipc	a2,0x2
ffffffffc0203e00:	afc60613          	addi	a2,a2,-1284 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203e04:	0e000593          	li	a1,224
ffffffffc0203e08:	00003517          	auipc	a0,0x3
ffffffffc0203e0c:	ac850513          	addi	a0,a0,-1336 # ffffffffc02068d0 <default_pmm_manager+0xc40>
ffffffffc0203e10:	e40fc0ef          	jal	ra,ffffffffc0200450 <__panic>
        assert(vma1 != NULL);
ffffffffc0203e14:	00003697          	auipc	a3,0x3
ffffffffc0203e18:	c7468693          	addi	a3,a3,-908 # ffffffffc0206a88 <default_pmm_manager+0xdf8>
ffffffffc0203e1c:	00002617          	auipc	a2,0x2
ffffffffc0203e20:	adc60613          	addi	a2,a2,-1316 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203e24:	0de00593          	li	a1,222
ffffffffc0203e28:	00003517          	auipc	a0,0x3
ffffffffc0203e2c:	aa850513          	addi	a0,a0,-1368 # ffffffffc02068d0 <default_pmm_manager+0xc40>
ffffffffc0203e30:	e20fc0ef          	jal	ra,ffffffffc0200450 <__panic>
        assert(vma5 == NULL);
ffffffffc0203e34:	00003697          	auipc	a3,0x3
ffffffffc0203e38:	c9468693          	addi	a3,a3,-876 # ffffffffc0206ac8 <default_pmm_manager+0xe38>
ffffffffc0203e3c:	00002617          	auipc	a2,0x2
ffffffffc0203e40:	abc60613          	addi	a2,a2,-1348 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203e44:	0e600593          	li	a1,230
ffffffffc0203e48:	00003517          	auipc	a0,0x3
ffffffffc0203e4c:	a8850513          	addi	a0,a0,-1400 # ffffffffc02068d0 <default_pmm_manager+0xc40>
ffffffffc0203e50:	e00fc0ef          	jal	ra,ffffffffc0200450 <__panic>
        assert(vma4 == NULL);
ffffffffc0203e54:	00003697          	auipc	a3,0x3
ffffffffc0203e58:	c6468693          	addi	a3,a3,-924 # ffffffffc0206ab8 <default_pmm_manager+0xe28>
ffffffffc0203e5c:	00002617          	auipc	a2,0x2
ffffffffc0203e60:	a9c60613          	addi	a2,a2,-1380 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203e64:	0e400593          	li	a1,228
ffffffffc0203e68:	00003517          	auipc	a0,0x3
ffffffffc0203e6c:	a6850513          	addi	a0,a0,-1432 # ffffffffc02068d0 <default_pmm_manager+0xc40>
ffffffffc0203e70:	de0fc0ef          	jal	ra,ffffffffc0200450 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203e74:	00002617          	auipc	a2,0x2
ffffffffc0203e78:	ecc60613          	addi	a2,a2,-308 # ffffffffc0205d40 <default_pmm_manager+0xb0>
ffffffffc0203e7c:	06200593          	li	a1,98
ffffffffc0203e80:	00002517          	auipc	a0,0x2
ffffffffc0203e84:	e8850513          	addi	a0,a0,-376 # ffffffffc0205d08 <default_pmm_manager+0x78>
ffffffffc0203e88:	dc8fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(mm != NULL);
ffffffffc0203e8c:	00002697          	auipc	a3,0x2
ffffffffc0203e90:	57c68693          	addi	a3,a3,1404 # ffffffffc0206408 <default_pmm_manager+0x778>
ffffffffc0203e94:	00002617          	auipc	a2,0x2
ffffffffc0203e98:	a6460613          	addi	a2,a2,-1436 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203e9c:	0c200593          	li	a1,194
ffffffffc0203ea0:	00003517          	auipc	a0,0x3
ffffffffc0203ea4:	a3050513          	addi	a0,a0,-1488 # ffffffffc02068d0 <default_pmm_manager+0xc40>
ffffffffc0203ea8:	da8fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203eac:	00003697          	auipc	a3,0x3
ffffffffc0203eb0:	d3468693          	addi	a3,a3,-716 # ffffffffc0206be0 <default_pmm_manager+0xf50>
ffffffffc0203eb4:	00002617          	auipc	a2,0x2
ffffffffc0203eb8:	a4460613          	addi	a2,a2,-1468 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203ebc:	12400593          	li	a1,292
ffffffffc0203ec0:	00003517          	auipc	a0,0x3
ffffffffc0203ec4:	a1050513          	addi	a0,a0,-1520 # ffffffffc02068d0 <default_pmm_manager+0xc40>
ffffffffc0203ec8:	d88fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203ecc:	00002697          	auipc	a3,0x2
ffffffffc0203ed0:	56468693          	addi	a3,a3,1380 # ffffffffc0206430 <default_pmm_manager+0x7a0>
ffffffffc0203ed4:	00002617          	auipc	a2,0x2
ffffffffc0203ed8:	a2460613          	addi	a2,a2,-1500 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203edc:	10500593          	li	a1,261
ffffffffc0203ee0:	00003517          	auipc	a0,0x3
ffffffffc0203ee4:	9f050513          	addi	a0,a0,-1552 # ffffffffc02068d0 <default_pmm_manager+0xc40>
ffffffffc0203ee8:	d68fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203eec:	00003697          	auipc	a3,0x3
ffffffffc0203ef0:	cc468693          	addi	a3,a3,-828 # ffffffffc0206bb0 <default_pmm_manager+0xf20>
ffffffffc0203ef4:	00002617          	auipc	a2,0x2
ffffffffc0203ef8:	a0460613          	addi	a2,a2,-1532 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203efc:	10d00593          	li	a1,269
ffffffffc0203f00:	00003517          	auipc	a0,0x3
ffffffffc0203f04:	9d050513          	addi	a0,a0,-1584 # ffffffffc02068d0 <default_pmm_manager+0xc40>
ffffffffc0203f08:	d48fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    return KADDR(page2pa(page));
ffffffffc0203f0c:	00002617          	auipc	a2,0x2
ffffffffc0203f10:	dd460613          	addi	a2,a2,-556 # ffffffffc0205ce0 <default_pmm_manager+0x50>
ffffffffc0203f14:	06900593          	li	a1,105
ffffffffc0203f18:	00002517          	auipc	a0,0x2
ffffffffc0203f1c:	df050513          	addi	a0,a0,-528 # ffffffffc0205d08 <default_pmm_manager+0x78>
ffffffffc0203f20:	d30fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(sum == 0);
ffffffffc0203f24:	00003697          	auipc	a3,0x3
ffffffffc0203f28:	cac68693          	addi	a3,a3,-852 # ffffffffc0206bd0 <default_pmm_manager+0xf40>
ffffffffc0203f2c:	00002617          	auipc	a2,0x2
ffffffffc0203f30:	9cc60613          	addi	a2,a2,-1588 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203f34:	11700593          	li	a1,279
ffffffffc0203f38:	00003517          	auipc	a0,0x3
ffffffffc0203f3c:	99850513          	addi	a0,a0,-1640 # ffffffffc02068d0 <default_pmm_manager+0xc40>
ffffffffc0203f40:	d10fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203f44:	00003697          	auipc	a3,0x3
ffffffffc0203f48:	c5468693          	addi	a3,a3,-940 # ffffffffc0206b98 <default_pmm_manager+0xf08>
ffffffffc0203f4c:	00002617          	auipc	a2,0x2
ffffffffc0203f50:	9ac60613          	addi	a2,a2,-1620 # ffffffffc02058f8 <commands+0x870>
ffffffffc0203f54:	10100593          	li	a1,257
ffffffffc0203f58:	00003517          	auipc	a0,0x3
ffffffffc0203f5c:	97850513          	addi	a0,a0,-1672 # ffffffffc02068d0 <default_pmm_manager+0xc40>
...
ffffffffc0203f8e:	0e050c63          	beqz	a0,ffffffffc0204086 <do_pgfault+0x122>
ffffffffc0203f92:	651c                	ld	a5,8(a0)
ffffffffc0203f94:	0ef46963          	bltu	s0,a5,ffffffffc0204086 <do_pgfault+0x122>
...
ffffffffc0203f98:	4d1c                	lw	a5,24(a0)
    uint32_t perm = PTE_U;
ffffffffc0203f9a:	49c1                	li	s3,16
    if (vma->vm_flags & VM_WRITE) {
ffffffffc0203f9c:	8b89                	andi	a5,a5,2
ffffffffc0203f9e:	e3c1                	bnez	a5,ffffffffc020401e <do_pgfault+0xba>
        perm |= READ_WRITE;
    }
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203fa0:	767d                	lui	a2,0xfffff
...
ffffffffc0203fa2:	6c88                	ld	a0,24(s1)
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203fa4:	8c71                	and	s0,s0,a2
    if ((ptep = get_pte(mm->pgdir, addr, 1)) == NULL) {
ffffffffc0203fa6:	85a2                	mv	a1,s0
ffffffffc0203fa8:	4605                	li	a2,1
ffffffffc0203faa:	cfbfd0ef          	jal	ra,ffffffffc0201ca4 <get_pte>
ffffffffc0203fae:	0e050d63          	beqz	a0,ffffffffc02040a8 <do_pgfault+0x144>
        cprintf("get_pte in do_pgfault failed\n");
        goto failed;
    }
    if (*ptep == 0) { // if the phy addr isn't exist, then alloc a page & map the phy addr with logical addr
ffffffffc0203fb2:	610c                	ld	a1,0(a0)
ffffffffc0203fb4:	c5c9                	beqz	a1,ffffffffc020403e <do_pgfault+0xda>
        ...
        */
        if (swap_init_ok) {
ffffffffc0203fb6:	00012797          	auipc	a5,0x12
ffffffffc0203fba:	4ea78793          	addi	a5,a5,1258 # ffffffffc02164a0 <swap_init_ok>
ffffffffc0203fbe:	439c                	lw	a5,0(a5)
ffffffffc0203fc0:	2781                	sext.w	a5,a5
ffffffffc0203fc2:	0c078b63          	beqz	a5,ffffffffc0204098 <do_pgfault+0x134>
...
ffffffffc0203fc6:	0030                	addi	a2,sp,8
ffffffffc0203fc8:	85a2                	mv	a1,s0
ffffffffc0203fca:	8526                	mv	a0,s1
            struct Page *page = NULL;
ffffffffc0203fcc:	e402                	sd	zero,8(sp)
            if ((ret = swap_in(mm, addr, &page)) != 0) { // 加载失败
ffffffffc0203fce:	c06ff0ef          	jal	ra,ffffffffc02033d4 <swap_in>
ffffffffc0203fd2:	892a                	mv	s2,a0
ffffffffc0203fd4:	e539                	bnez	a0,ffffffffc0204022 <do_pgfault+0xbe>
...
ffffffffc0203fd6:	65a2                	ld	a1,8(sp)
ffffffffc0203fd8:	86ce                	mv	a3,s3
ffffffffc0203fda:	8622                	mv	a2,s0
ffffffffc0203fdc:	8526                	mv	a0,s1
ffffffffc0203fde:	f6ffd0ef          	jal	ra,ffffffffc0201f4c <page_insert>
ffffffffc0203fe2:	e541                	bnez	a0,ffffffffc020406a <do_pgfault+0x106>
...
ffffffffc0203fe4:	6622                	ld	a2,8(sp)
ffffffffc0203fe6:	4685                	li	a3,1
ffffffffc0203fe8:	85a2                	mv	a1,s0
ffffffffc0203fea:	8526                	mv	a0,s1
ffffffffc0203fec:	ac4ff0ef          	jal	ra,ffffffffc02032b0 <swap_map_swappable>
ffffffffc0203ff0:	e535                	bnez	a0,ffffffffc020405c <do_pgfault+0xf8>
                cprintf("swap_map_swappable failed\n");
                 goto failed;
            }
            // 交换成功，则建立物理地址->虚拟地址映射，并将页设置为可交换的
            page_insert(mm->pgdir,page,addr,perm);
ffffffffc0203ff2:	65a2                	ld	a1,8(sp)
ffffffffc0203ff4:	6c88                	ld	a0,24(s1)
ffffffffc0203ff6:	86ce                	mv	a3,s3
ffffffffc0203ff8:	8622                	mv	a2,s0
ffffffffc0203ffa:	f53fd0ef          	jal	ra,ffffffffc0201f4c <page_insert>
            swap_map_swappable(mm,addr,page,1);           
ffffffffc0203ffe:	6622                	ld	a2,8(sp)
ffffffffc0204000:	85a2                	mv	a1,s0
ffffffffc0204002:	8526                	mv	a0,s1
ffffffffc0204004:	4685                	li	a3,1
ffffffffc0204006:	aaaff0ef          	jal	ra,ffffffffc02032b0 <swap_map_swappable>
            page->pra_vaddr = addr;
ffffffffc020400a:	67a2                	ld	a5,8(sp)
   }
...
ffffffffc020400e:	854a                	mv	a0,s2
            page->pra_vaddr = addr;
ffffffffc0204010:	ff80                	sd	s0,56(a5)
}
ffffffffc0204012:	7442                	ld	s0,48(sp)
ffffffffc0204014:	74a2                	ld	s1,40(sp)
ffffffffc0204016:	7902                	ld	s2,32(sp)
ffffffffc0204018:	69e2                	ld	s3,24(sp)
ffffffffc020401a:	6121                	addi	sp,sp,64
ffffffffc020401c:	8082                	ret
        perm |= READ_WRITE;
ffffffffc020401e:	49dd                	li	s3,23
ffffffffc0204020:	b741                	j	ffffffffc0203fa0 <do_pgfault+0x3c>
                cprintf("swap page in do_pgfault failed\n");
ffffffffc0204022:	00003517          	auipc	a0,0x3
ffffffffc0204026:	93650513          	addi	a0,a0,-1738 # ffffffffc0206958 <default_pmm_manager+0xcc8>
ffffffffc020402a:	964fc0ef          	jal	ra,ffffffffc020018e <cprintf>
}
ffffffffc020402e:	70e2                	ld	ra,56(sp)
ffffffffc0204030:	7442                	ld	s0,48(sp)
ffffffffc0204032:	854a                	mv	a0,s2
ffffffffc0204034:	74a2                	ld	s1,40(sp)
ffffffffc0204036:	7902                	ld	s2,32(sp)
ffffffffc0204038:	69e2                	ld	s3,24(sp)
ffffffffc020403a:	6121                	addi	sp,sp,64
ffffffffc020403c:	8082                	ret
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc020403e:	6c88                	ld	a0,24(s1)
ffffffffc0204040:	864e                	mv	a2,s3
ffffffffc0204042:	85a2                	mv	a1,s0
ffffffffc0204044:	a57fe0ef          	jal	ra,ffffffffc0202a9a <pgdir_alloc_page>
   ret = 0;
ffffffffc0204048:	4901                	li	s2,0
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc020404a:	f175                	bnez	a0,ffffffffc020402e <do_pgfault+0xca>
            cprintf("pgdir_alloc_page in do_pgfault failed\n");
ffffffffc020404c:	00003517          	auipc	a0,0x3
ffffffffc0204050:	8e450513          	addi	a0,a0,-1820 # ffffffffc0206930 <default_pmm_manager+0xca0>
ffffffffc0204054:	93afc0ef          	jal	ra,ffffffffc020018e <cprintf>
    ret = -E_NO_MEM;
ffffffffc0204058:	5971                	li	s2,-4
            goto failed;
ffffffffc020405a:	bfd1                	j	ffffffffc020402e <do_pgfault+0xca>
                cprintf("swap_map_swappable failed\n");
ffffffffc020405c:	00003517          	auipc	a0,0x3
ffffffffc0204060:	93450513          	addi	a0,a0,-1740 # ffffffffc0206990 <default_pmm_manager+0xd00>
ffffffffc0204064:	92afc0ef          	jal	ra,ffffffffc020018e <cprintf>
                 goto failed;
ffffffffc0204068:	b7d9                	j	ffffffffc020402e <do_pgfault+0xca>
                cprintf("page_insert failed\n");
ffffffffc020406a:	00003517          	auipc	a0,0x3
ffffffffc020406e:	90e50513          	addi	a0,a0,-1778 # ffffffffc0206978 <default_pmm_manager+0xce8>
ffffffffc0204072:	91cfc0ef          	jal	ra,ffffffffc020018e <cprintf>
}
ffffffffc0204076:	70e2                	ld	ra,56(sp)
ffffffffc0204078:	7442                	ld	s0,48(sp)
ffffffffc020407a:	854a                	mv	a0,s2
ffffffffc020407c:	74a2                	ld	s1,40(sp)
ffffffffc020407e:	7902                	ld	s2,32(sp)
ffffffffc0204080:	69e2                	ld	s3,24(sp)
...
ffffffffc020408c:	85850513          	addi	a0,a0,-1960 # ffffffffc02068e0 <default_pmm_manager+0xc50>
ffffffffc0204090:	8fefc0ef          	jal	ra,ffffffffc020018e <cprintf>
    int ret = -E_INVAL;
ffffffffc0204094:	5975                	li	s2,-3
        goto failed;
ffffffffc0204096:	bf61                	j	ffffffffc020402e <do_pgfault+0xca>
            cprintf("no swap_init_ok but ptep is %x, failed\n", *ptep);
ffffffffc0204098:	00003517          	auipc	a0,0x3
ffffffffc020409c:	91850513          	addi	a0,a0,-1768 # ffffffffc02069b0 <default_pmm_manager+0xd20>
ffffffffc02040a0:	8eefc0ef          	jal	ra,ffffffffc020018e <cprintf>
    ret = -E_NO_MEM;
ffffffffc02040a4:	5971                	li	s2,-4
            goto failed;
ffffffffc02040a6:	b761                	j	ffffffffc020402e <do_pgfault+0xca>
        cprintf("get_pte in do_pgfault failed\n");
ffffffffc02040a8:	00003517          	auipc	a0,0x3
ffffffffc02040ac:	86850513          	addi	a0,a0,-1944 # ffffffffc0206910 <default_pmm_manager+0xc80>
ffffffffc02040b0:	8defc0ef          	jal	ra,ffffffffc020018e <cprintf>
    ret = -E_NO_MEM;
ffffffffc02040b4:	5971                	li	s2,-4
        goto failed;
ffffffffc02040b6:	bfa5                	j	ffffffffc020402e <do_pgfault+0xca>

ffffffffc02040b8 <swapfs_init>:
#include <ide.h>
#include <pmm.h>
#include <assert.h>
...
ffffffffc02040ba:	4505                	li	a0,1
swapfs_init(void) {
ffffffffc02040bc:	e406                	sd	ra,8(sp)
    if (!ide_device_valid(SWAP_DEV_NO)) {
ffffffffc02040be:	cbefc0ef          	jal	ra,ffffffffc020057c <ide_device_valid>
ffffffffc02040c2:	cd01                	beqz	a0,ffffffffc02040da <swapfs_init+0x22>
        panic("swap fs isn't available.\n");
    }
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc02040c4:	4505                	li	a0,1
ffffffffc02040c6:	cbcfc0ef          	jal	ra,ffffffffc0200582 <ide_device_size>
}
ffffffffc02040ca:	60a2                	ld	ra,8(sp)
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc02040cc:	810d                	srli	a0,a0,0x3
ffffffffc02040ce:	00012797          	auipc	a5,0x12
ffffffffc02040d2:	4ca7b123          	sd	a0,1218(a5) # ffffffffc0216590 <max_swap_offset>
}
ffffffffc02040d6:	0141                	addi	sp,sp,16
ffffffffc02040d8:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc02040da:	00003617          	auipc	a2,0x3
ffffffffc02040de:	b6660613          	addi	a2,a2,-1178 # ffffffffc0206c40 <default_pmm_manager+0xfb0>
ffffffffc02040e2:	45b5                	li	a1,13
ffffffffc02040e4:	00003517          	auipc	a0,0x3
ffffffffc02040e8:	b7c50513          	addi	a0,a0,-1156 # ffffffffc0206c60 <default_pmm_manager+0xfd0>
ffffffffc02040ec:	b64fc0ef          	jal	ra,ffffffffc0200450 <__panic>

ffffffffc02040f0 <swapfs_read>:

int
swapfs_read(swap_entry_t entry, struct Page *page) {
ffffffffc02040f0:	1141                	addi	sp,sp,-16
ffffffffc02040f2:	e406                	sd	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc02040f4:	00855793          	srli	a5,a0,0x8
ffffffffc02040f8:	cfb9                	beqz	a5,ffffffffc0204156 <swapfs_read+0x66>
ffffffffc02040fa:	00012717          	auipc	a4,0x12
ffffffffc02040fe:	49670713          	addi	a4,a4,1174 # ffffffffc0216590 <max_swap_offset>
ffffffffc0204102:	6318                	ld	a4,0(a4)
ffffffffc0204104:	04e7f963          	bleu	a4,a5,ffffffffc0204156 <swapfs_read+0x66>
    return page - pages + nbase;
ffffffffc0204108:	00012717          	auipc	a4,0x12
ffffffffc020410c:	3f870713          	addi	a4,a4,1016 # ffffffffc0216500 <pages>
ffffffffc0204110:	6310                	ld	a2,0(a4)
ffffffffc0204112:	00003717          	auipc	a4,0x3
ffffffffc0204116:	f7e70713          	addi	a4,a4,-130 # ffffffffc0207090 <nbase>
    return KADDR(page2pa(page));
ffffffffc020411a:	00012697          	auipc	a3,0x12
ffffffffc020411e:	37668693          	addi	a3,a3,886 # ffffffffc0216490 <npage>
    return page - pages + nbase;
ffffffffc0204122:	40c58633          	sub	a2,a1,a2
ffffffffc0204126:	630c                	ld	a1,0(a4)
ffffffffc0204128:	8619                	srai	a2,a2,0x6
    return KADDR(page2pa(page));
ffffffffc020412a:	577d                	li	a4,-1
ffffffffc020412c:	6294                	ld	a3,0(a3)
    return page - pages + nbase;
ffffffffc020412e:	962e                	add	a2,a2,a1
    return KADDR(page2pa(page));
ffffffffc0204130:	8331                	srli	a4,a4,0xc
ffffffffc0204132:	8f71                	and	a4,a4,a2
ffffffffc0204134:	0037959b          	slliw	a1,a5,0x3
    return page2ppn(page) << PGSHIFT;
ffffffffc0204138:	0632                	slli	a2,a2,0xc
    return KADDR(page2pa(page));
ffffffffc020413a:	02d77a63          	bleu	a3,a4,ffffffffc020416e <swapfs_read+0x7e>
ffffffffc020413e:	00012797          	auipc	a5,0x12
ffffffffc0204142:	3b278793          	addi	a5,a5,946 # ffffffffc02164f0 <va_pa_offset>
ffffffffc0204146:	639c                	ld	a5,0(a5)
}
...
ffffffffc0204150:	0141                	addi	sp,sp,16
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0204152:	c36fc06f          	j	ffffffffc0200588 <ide_read_secs>
ffffffffc0204156:	86aa                	mv	a3,a0
ffffffffc0204158:	00003617          	auipc	a2,0x3
ffffffffc020415c:	b2060613          	addi	a2,a2,-1248 # ffffffffc0206c78 <default_pmm_manager+0xfe8>
ffffffffc0204160:	45d1                	li	a1,20
ffffffffc0204162:	00003517          	auipc	a0,0x3
ffffffffc0204166:	afe50513          	addi	a0,a0,-1282 # ffffffffc0206c60 <default_pmm_manager+0xfd0>
ffffffffc020416a:	ae6fc0ef          	jal	ra,ffffffffc0200450 <__panic>
ffffffffc020416e:	86b2                	mv	a3,a2
ffffffffc0204170:	06900593          	li	a1,105
ffffffffc0204174:	00002617          	auipc	a2,0x2
ffffffffc0204178:	b6c60613          	addi	a2,a2,-1172 # ffffffffc0205ce0 <default_pmm_manager+0x50>
ffffffffc020417c:	00002517          	auipc	a0,0x2
ffffffffc0204180:	b8c50513          	addi	a0,a0,-1140 # ffffffffc0205d08 <default_pmm_manager+0x78>
...
ffffffffc0204190:	cfb9                	beqz	a5,ffffffffc02041ee <swapfs_write+0x66>
ffffffffc0204192:	00012717          	auipc	a4,0x12
ffffffffc0204196:	3fe70713          	addi	a4,a4,1022 # ffffffffc0216590 <max_swap_offset>
ffffffffc020419a:	6318                	ld	a4,0(a4)
ffffffffc020419c:	04e7f963          	bleu	a4,a5,ffffffffc02041ee <swapfs_write+0x66>
    return page - pages + nbase;
ffffffffc02041a0:	00012717          	auipc	a4,0x12
ffffffffc02041a4:	36070713          	addi	a4,a4,864 # ffffffffc0216500 <pages>
ffffffffc02041a8:	6310                	ld	a2,0(a4)
ffffffffc02041aa:	00003717          	auipc	a4,0x3
ffffffffc02041ae:	ee670713          	addi	a4,a4,-282 # ffffffffc0207090 <nbase>
    return KADDR(page2pa(page));
ffffffffc02041b2:	00012697          	auipc	a3,0x12
ffffffffc02041b6:	2de68693          	addi	a3,a3,734 # ffffffffc0216490 <npage>
    return page - pages + nbase;
ffffffffc02041ba:	40c58633          	sub	a2,a1,a2
ffffffffc02041be:	630c                	ld	a1,0(a4)
ffffffffc02041c0:	8619                	srai	a2,a2,0x6
    return KADDR(page2pa(page));
ffffffffc02041c2:	577d                	li	a4,-1
ffffffffc02041c4:	6294                	ld	a3,0(a3)
    return page - pages + nbase;
ffffffffc02041c6:	962e                	add	a2,a2,a1
    return KADDR(page2pa(page));
ffffffffc02041c8:	8331                	srli	a4,a4,0xc
ffffffffc02041ca:	8f71                	and	a4,a4,a2
ffffffffc02041cc:	0037959b          	slliw	a1,a5,0x3
    return page2ppn(page) << PGSHIFT;
ffffffffc02041d0:	0632                	slli	a2,a2,0xc
    return KADDR(page2pa(page));
ffffffffc02041d2:	02d77a63          	bleu	a3,a4,ffffffffc0204206 <swapfs_write+0x7e>
ffffffffc02041d6:	00012797          	auipc	a5,0x12
ffffffffc02041da:	31a78793          	addi	a5,a5,794 # ffffffffc02164f0 <va_pa_offset>
ffffffffc02041de:	639c                	ld	a5,0(a5)
}
ffffffffc02041e0:	60a2                	ld	ra,8(sp)
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc02041e2:	46a1                	li	a3,8
ffffffffc02041e4:	963e                	add	a2,a2,a5
ffffffffc02041e6:	4505                	li	a0,1
}
ffffffffc02041e8:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc02041ea:	bc2fc06f          	j	ffffffffc02005ac <ide_write_secs>
ffffffffc02041ee:	86aa                	mv	a3,a0
ffffffffc02041f0:	00003617          	auipc	a2,0x3
ffffffffc02041f4:	a8860613          	addi	a2,a2,-1400 # ffffffffc0206c78 <default_pmm_manager+0xfe8>
ffffffffc02041f8:	45e5                	li	a1,25
ffffffffc02041fa:	00003517          	auipc	a0,0x3
ffffffffc02041fe:	a6650513          	addi	a0,a0,-1434 # ffffffffc0206c60 <default_pmm_manager+0xfd0>
ffffffffc0204202:	a4efc0ef          	jal	ra,ffffffffc0200450 <__panic>
ffffffffc0204206:	86b2                	mv	a3,a2
ffffffffc0204208:	06900593          	li	a1,105
ffffffffc020420c:	00002617          	auipc	a2,0x2
ffffffffc0204210:	ad460613          	addi	a2,a2,-1324 # ffffffffc0205ce0 <default_pmm_manager+0x50>
ffffffffc0204214:	00002517          	auipc	a0,0x2
ffffffffc0204218:	af450513          	addi	a0,a0,-1292 # ffffffffc0205d08 <default_pmm_manager+0x78>
ffffffffc020421c:	a34fc0ef          	jal	ra,ffffffffc0200450 <__panic>

ffffffffc0204220 <kernel_thread_entry>:
.text
...
ffffffffc0204220:	8526                	mv	a0,s1
	jalr s0
ffffffffc0204222:	9402                	jalr	s0

	jal do_exit
ffffffffc0204224:	4c8000ef          	jal	ra,ffffffffc02046ec <do_exit>

ffffffffc0204228 <alloc_proc>:
...
alloc_proc(void) {
ffffffffc0204228:	1141                	addi	sp,sp,-16
    struct proc_struct *proc = kmalloc(sizeof(struct proc_struct));
ffffffffc020422a:	0e800513          	li	a0,232
alloc_proc(void) {
ffffffffc020422e:	e022                	sd	s0,0(sp)
ffffffffc0204230:	e406                	sd	ra,8(sp)
    struct proc_struct *proc = kmalloc(sizeof(struct proc_struct));
ffffffffc0204232:	f68fd0ef          	jal	ra,ffffffffc020199a <kmalloc>
ffffffffc0204236:	842a                	mv	s0,a0
    if (proc != NULL) {
ffffffffc0204238:	c529                	beqz	a0,ffffffffc0204282 <alloc_proc+0x5a>
...
ffffffffc020423a:	57fd                	li	a5,-1
ffffffffc020423c:	1782                	slli	a5,a5,0x20
ffffffffc020423e:	e11c                	sd	a5,0(a0)
        proc->runs = 0;            // 初始化运行次数
...
ffffffffc0204240:	07000613          	li	a2,112
ffffffffc0204244:	4581                	li	a1,0
        proc->runs = 0;            // 初始化运行次数
ffffffffc0204246:	00052423          	sw	zero,8(a0)
        proc->kstack = 0;          // 初始化内核栈地址
ffffffffc020424a:	00053823          	sd	zero,16(a0)
        proc->need_resched = 0;    // 初始化不需要重新调度
ffffffffc020424e:	00052c23          	sw	zero,24(a0)
        proc->parent = NULL;       // 父进程暂时为空
ffffffffc0204252:	02053023          	sd	zero,32(a0)
        proc->mm = NULL;           // 内存管理结构为空
ffffffffc0204256:	02053423          	sd	zero,40(a0)
        memset(&(proc->context), 0, sizeof(struct context));  // 初始化上下文
ffffffffc020425a:	03050513          	addi	a0,a0,48
ffffffffc020425e:	49f000ef          	jal	ra,ffffffffc0204efc <memset>
        proc->tf = NULL;           // 中断帧指针暂时为空
        proc->cr3 = boot_cr3;      // 默认页目录为内核页目录表的基地址
ffffffffc0204262:	00012797          	auipc	a5,0x12
ffffffffc0204266:	29678793          	addi	a5,a5,662 # ffffffffc02164f8 <boot_cr3>
ffffffffc020426a:	639c                	ld	a5,0(a5)
        proc->tf = NULL;           // 中断帧指针暂时为空
ffffffffc020426c:	0a043023          	sd	zero,160(s0)
        proc->flags = 0;           // 初始化进程标志
ffffffffc0204270:	0a042823          	sw	zero,176(s0)
        proc->cr3 = boot_cr3;      // 默认页目录为内核页目录表的基地址
ffffffffc0204274:	f45c                	sd	a5,168(s0)
...
ffffffffc020427e:	47f000ef          	jal	ra,ffffffffc0204efc <memset>
...
ffffffffc0204290:	21c78793          	addi	a5,a5,540 # ffffffffc02164a8 <current>
ffffffffc0204294:	639c                	ld	a5,0(a5)
ffffffffc0204296:	73c8                	ld	a0,160(a5)
ffffffffc0204298:	901fc06f          	j	ffffffffc0200b98 <forkrets>

ffffffffc020429c <set_proc_name>:
set_proc_name(struct proc_struct *proc, const char *name) {
ffffffffc020429c:	1101                	addi	sp,sp,-32
ffffffffc020429e:	e822                	sd	s0,16(sp)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02042a0:	0b450413          	addi	s0,a0,180
set_proc_name(struct proc_struct *proc, const char *name) {
ffffffffc02042a4:	e426                	sd	s1,8(sp)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02042a6:	4641                	li	a2,16
set_proc_name(struct proc_struct *proc, const char *name) {
ffffffffc02042a8:	84ae                	mv	s1,a1
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02042aa:	8522                	mv	a0,s0
ffffffffc02042ac:	4581                	li	a1,0
set_proc_name(struct proc_struct *proc, const char *name) {
ffffffffc02042ae:	ec06                	sd	ra,24(sp)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02042b0:	44d000ef          	jal	ra,ffffffffc0204efc <memset>
...
ffffffffc02042bc:	64a2                	ld	s1,8(sp)
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc02042be:	463d                	li	a2,15
}
ffffffffc02042c0:	6105                	addi	sp,sp,32
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc02042c2:	44d0006f          	j	ffffffffc0204f0e <memcpy>

ffffffffc02042c6 <get_proc_name>:
get_proc_name(struct proc_struct *proc) {
ffffffffc02042c6:	1101                	addi	sp,sp,-32
ffffffffc02042c8:	e822                	sd	s0,16(sp)
    memset(name, 0, sizeof(name));
ffffffffc02042ca:	00012417          	auipc	s0,0x12
ffffffffc02042ce:	19640413          	addi	s0,s0,406 # ffffffffc0216460 <name.1565>
get_proc_name(struct proc_struct *proc) {
ffffffffc02042d2:	e426                	sd	s1,8(sp)
    memset(name, 0, sizeof(name));
ffffffffc02042d4:	4641                	li	a2,16
get_proc_name(struct proc_struct *proc) {
ffffffffc02042d6:	84aa                	mv	s1,a0
    memset(name, 0, sizeof(name));
...
ffffffffc02042dc:	ec06                	sd	ra,24(sp)
    memset(name, 0, sizeof(name));
ffffffffc02042de:	41f000ef          	jal	ra,ffffffffc0204efc <memset>
...
ffffffffc02042e6:	60e2                	ld	ra,24(sp)
    return memcpy(name, proc->name, PROC_NAME_LEN);
ffffffffc02042e8:	0b448593          	addi	a1,s1,180
}
ffffffffc02042ec:	64a2                	ld	s1,8(sp)
    return memcpy(name, proc->name, PROC_NAME_LEN);
ffffffffc02042ee:	463d                	li	a2,15
}
ffffffffc02042f0:	6105                	addi	sp,sp,32
    return memcpy(name, proc->name, PROC_NAME_LEN);
ffffffffc02042f2:	41d0006f          	j	ffffffffc0204f0e <memcpy>

ffffffffc02042f6 <init_main>:
}
...
ffffffffc02042f6:	00012797          	auipc	a5,0x12
ffffffffc02042fa:	1b278793          	addi	a5,a5,434 # ffffffffc02164a8 <current>
ffffffffc02042fe:	639c                	ld	a5,0(a5)
init_main(void *arg) {
ffffffffc0204300:	1101                	addi	sp,sp,-32
ffffffffc0204302:	e426                	sd	s1,8(sp)
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc0204304:	43c4                	lw	s1,4(a5)
init_main(void *arg) {
ffffffffc0204306:	e822                	sd	s0,16(sp)
ffffffffc0204308:	842a                	mv	s0,a0
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc020430a:	853e                	mv	a0,a5
init_main(void *arg) {
ffffffffc020430c:	ec06                	sd	ra,24(sp)
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc020430e:	fb9ff0ef          	jal	ra,ffffffffc02042c6 <get_proc_name>
ffffffffc0204312:	862a                	mv	a2,a0
ffffffffc0204314:	85a6                	mv	a1,s1
ffffffffc0204316:	00003517          	auipc	a0,0x3
ffffffffc020431a:	9ca50513          	addi	a0,a0,-1590 # ffffffffc0206ce0 <default_pmm_manager+0x1050>
ffffffffc020431e:	e71fb0ef          	jal	ra,ffffffffc020018e <cprintf>
    cprintf("To U: \"%s\".\n", (const char *)arg);
ffffffffc0204322:	85a2                	mv	a1,s0
ffffffffc0204324:	00003517          	auipc	a0,0x3
ffffffffc0204328:	9e450513          	addi	a0,a0,-1564 # ffffffffc0206d08 <default_pmm_manager+0x1078>
ffffffffc020432c:	e63fb0ef          	jal	ra,ffffffffc020018e <cprintf>
    cprintf("To U: \"en.., Bye, Bye. :)\"\n");
ffffffffc0204330:	00003517          	auipc	a0,0x3
ffffffffc0204334:	9e850513          	addi	a0,a0,-1560 # ffffffffc0206d18 <default_pmm_manager+0x1088>
ffffffffc0204338:	e57fb0ef          	jal	ra,ffffffffc020018e <cprintf>
    return 0;
}
...
ffffffffc0204344:	6105                	addi	sp,sp,32
ffffffffc0204346:	8082                	ret

ffffffffc0204348 <proc_run>:
proc_run(struct proc_struct *proc) {
ffffffffc0204348:	1101                	addi	sp,sp,-32
    if (proc != current) {
ffffffffc020434a:	00012797          	auipc	a5,0x12
ffffffffc020434e:	15e78793          	addi	a5,a5,350 # ffffffffc02164a8 <current>
proc_run(struct proc_struct *proc) {
ffffffffc0204352:	e426                	sd	s1,8(sp)
    if (proc != current) {
ffffffffc0204354:	6384                	ld	s1,0(a5)
proc_run(struct proc_struct *proc) {
ffffffffc0204356:	ec06                	sd	ra,24(sp)
ffffffffc0204358:	e822                	sd	s0,16(sp)
ffffffffc020435a:	e04a                	sd	s2,0(sp)
    if (proc != current) {
ffffffffc020435c:	02a48c63          	beq	s1,a0,ffffffffc0204394 <proc_run+0x4c>
...
ffffffffc0204368:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020436a:	e3b1                	bnez	a5,ffffffffc02043ae <proc_run+0x66>
             lcr3(next->cr3);//更新CR3为新进程页目录表物理地址,完成进程间页表切换
ffffffffc020436c:	745c                	ld	a5,168(s0)
             current = proc;//设置当前进程为proc
ffffffffc020436e:	00012717          	auipc	a4,0x12
ffffffffc0204372:	12873d23          	sd	s0,314(a4) # ffffffffc02164a8 <current>
...
ffffffffc0204376:	80000737          	lui	a4,0x80000
ffffffffc020437a:	00c7d79b          	srliw	a5,a5,0xc
ffffffffc020437e:	8fd9                	or	a5,a5,a4
ffffffffc0204380:	18079073          	csrw	satp,a5
             switch_to(&(prev->context), &(next->context));//切换当前进程和新进程的上下文
ffffffffc0204384:	03040593          	addi	a1,s0,48
ffffffffc0204388:	03048513          	addi	a0,s1,48
ffffffffc020438c:	58c000ef          	jal	ra,ffffffffc0204918 <switch_to>
    if (flag) {
ffffffffc0204390:	00091863          	bnez	s2,ffffffffc02043a0 <proc_run+0x58>
}
...
ffffffffc02043a8:	6105                	addi	sp,sp,32
        intr_enable();
ffffffffc02043aa:	a28fc06f          	j	ffffffffc02005d2 <intr_enable>
        intr_disable();
ffffffffc02043ae:	a2afc0ef          	jal	ra,ffffffffc02005d8 <intr_disable>
        return 1;
ffffffffc02043b2:	4905                	li	s2,1
ffffffffc02043b4:	bf65                	j	ffffffffc020436c <proc_run+0x24>

ffffffffc02043b6 <find_proc>:
    if (0 < pid && pid < MAX_PID) {
ffffffffc02043b6:	0005071b          	sext.w	a4,a0
ffffffffc02043ba:	6789                	lui	a5,0x2
ffffffffc02043bc:	fff7069b          	addiw	a3,a4,-1
ffffffffc02043c0:	17f9                	addi	a5,a5,-2
ffffffffc02043c2:	04d7e063          	bltu	a5,a3,ffffffffc0204402 <find_proc+0x4c>
find_proc(int pid) {
ffffffffc02043c6:	1141                	addi	sp,sp,-16
ffffffffc02043c8:	e022                	sd	s0,0(sp)
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc02043ca:	45a9                	li	a1,10
ffffffffc02043cc:	842a                	mv	s0,a0
ffffffffc02043ce:	853a                	mv	a0,a4
find_proc(int pid) {
ffffffffc02043d0:	e406                	sd	ra,8(sp)
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc02043d2:	67c000ef          	jal	ra,ffffffffc0204a4e <hash32>
ffffffffc02043d6:	02051693          	slli	a3,a0,0x20
ffffffffc02043da:	82f1                	srli	a3,a3,0x1c
ffffffffc02043dc:	0000e517          	auipc	a0,0xe
ffffffffc02043e0:	08450513          	addi	a0,a0,132 # ffffffffc0212460 <hash_list>
ffffffffc02043e4:	96aa                	add	a3,a3,a0
ffffffffc02043e6:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list) {
ffffffffc02043e8:	a029                	j	ffffffffc02043f2 <find_proc+0x3c>
            if (proc->pid == pid) {
ffffffffc02043ea:	f2c7a703          	lw	a4,-212(a5) # 1f2c <BASE_ADDRESS-0xffffffffc01fe0d4>
ffffffffc02043ee:	00870c63          	beq	a4,s0,ffffffffc0204406 <find_proc+0x50>
ffffffffc02043f2:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc02043f4:	fef69be3          	bne	a3,a5,ffffffffc02043ea <find_proc+0x34>
}
ffffffffc02043f8:	60a2                	ld	ra,8(sp)
ffffffffc02043fa:	6402                	ld	s0,0(sp)
    return NULL;
ffffffffc02043fc:	4501                	li	a0,0
}
ffffffffc02043fe:	0141                	addi	sp,sp,16
...
ffffffffc020440a:	f2878513          	addi	a0,a5,-216
}
ffffffffc020440e:	0141                	addi	sp,sp,16
ffffffffc0204410:	8082                	ret

ffffffffc0204412 <do_fork>:
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc0204412:	7179                	addi	sp,sp,-48
ffffffffc0204414:	e84a                	sd	s2,16(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc0204416:	00012917          	auipc	s2,0x12
ffffffffc020441a:	0aa90913          	addi	s2,s2,170 # ffffffffc02164c0 <nr_process>
ffffffffc020441e:	00092703          	lw	a4,0(s2)
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc0204422:	f406                	sd	ra,40(sp)
ffffffffc0204424:	f022                	sd	s0,32(sp)
ffffffffc0204426:	ec26                	sd	s1,24(sp)
ffffffffc0204428:	e44e                	sd	s3,8(sp)
ffffffffc020442a:	e052                	sd	s4,0(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc020442c:	6785                	lui	a5,0x1
ffffffffc020442e:	22f75763          	ble	a5,a4,ffffffffc020465c <do_fork+0x24a>
ffffffffc0204432:	89ae                	mv	s3,a1
ffffffffc0204434:	84b2                	mv	s1,a2
    if((proc = alloc_proc()) == NULL){//    分配并初始化一个新的进程控制块pcb
ffffffffc0204436:	df3ff0ef          	jal	ra,ffffffffc0204228 <alloc_proc>
ffffffffc020443a:	842a                	mv	s0,a0
ffffffffc020443c:	22050263          	beqz	a0,ffffffffc0204660 <do_fork+0x24e>
     proc->parent = current; // 设置父进程为current，表示当前进程是新进程的父进程
ffffffffc0204440:	00012a17          	auipc	s4,0x12
ffffffffc0204444:	068a0a13          	addi	s4,s4,104 # ffffffffc02164a8 <current>
ffffffffc0204448:	000a3783          	ld	a5,0(s4)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc020444c:	4509                	li	a0,2
     proc->parent = current; // 设置父进程为current，表示当前进程是新进程的父进程
ffffffffc020444e:	f01c                	sd	a5,32(s0)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc0204450:	f46fd0ef          	jal	ra,ffffffffc0201b96 <alloc_pages>
    if (page != NULL) {
ffffffffc0204454:	1e050f63          	beqz	a0,ffffffffc0204652 <do_fork+0x240>
    return page - pages + nbase;
ffffffffc0204458:	00012797          	auipc	a5,0x12
ffffffffc020445c:	0a878793          	addi	a5,a5,168 # ffffffffc0216500 <pages>
ffffffffc0204460:	6394                	ld	a3,0(a5)
ffffffffc0204462:	00003797          	auipc	a5,0x3
ffffffffc0204466:	c2e78793          	addi	a5,a5,-978 # ffffffffc0207090 <nbase>
    return KADDR(page2pa(page));
ffffffffc020446a:	00012717          	auipc	a4,0x12
ffffffffc020446e:	02670713          	addi	a4,a4,38 # ffffffffc0216490 <npage>
    return page - pages + nbase;
ffffffffc0204472:	40d506b3          	sub	a3,a0,a3
ffffffffc0204476:	6388                	ld	a0,0(a5)
ffffffffc0204478:	8699                	srai	a3,a3,0x6
    return KADDR(page2pa(page));
ffffffffc020447a:	57fd                	li	a5,-1
ffffffffc020447c:	6318                	ld	a4,0(a4)
    return page - pages + nbase;
ffffffffc020447e:	96aa                	add	a3,a3,a0
    return KADDR(page2pa(page));
ffffffffc0204480:	83b1                	srli	a5,a5,0xc
ffffffffc0204482:	8ff5                	and	a5,a5,a3
    return page2ppn(page) << PGSHIFT;
ffffffffc0204484:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0204486:	1ee7ff63          	bleu	a4,a5,ffffffffc0204684 <do_fork+0x272>
    assert(current->mm == NULL);
ffffffffc020448a:	000a3783          	ld	a5,0(s4)
ffffffffc020448e:	00012717          	auipc	a4,0x12
ffffffffc0204492:	06270713          	addi	a4,a4,98 # ffffffffc02164f0 <va_pa_offset>
ffffffffc0204496:	6318                	ld	a4,0(a4)
ffffffffc0204498:	779c                	ld	a5,40(a5)
ffffffffc020449a:	96ba                	add	a3,a3,a4
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc020449c:	e814                	sd	a3,16(s0)
    assert(current->mm == NULL);
ffffffffc020449e:	1c079363          	bnez	a5,ffffffffc0204664 <do_fork+0x252>
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc02044a2:	6789                	lui	a5,0x2
ffffffffc02044a4:	ee078793          	addi	a5,a5,-288 # 1ee0 <BASE_ADDRESS-0xffffffffc01fe120>
ffffffffc02044a8:	96be                	add	a3,a3,a5
    *(proc->tf) = *tf;
ffffffffc02044aa:	8626                	mv	a2,s1
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc02044ac:	f054                	sd	a3,160(s0)
    *(proc->tf) = *tf;
ffffffffc02044ae:	87b6                	mv	a5,a3
ffffffffc02044b0:	12048893          	addi	a7,s1,288
ffffffffc02044b4:	00063803          	ld	a6,0(a2)
ffffffffc02044b8:	6608                	ld	a0,8(a2)
ffffffffc02044ba:	6a0c                	ld	a1,16(a2)
ffffffffc02044bc:	6e18                	ld	a4,24(a2)
ffffffffc02044be:	0107b023          	sd	a6,0(a5)
ffffffffc02044c2:	e788                	sd	a0,8(a5)
ffffffffc02044c4:	eb8c                	sd	a1,16(a5)
ffffffffc02044c6:	ef98                	sd	a4,24(a5)
ffffffffc02044c8:	02060613          	addi	a2,a2,32
ffffffffc02044cc:	02078793          	addi	a5,a5,32
ffffffffc02044d0:	ff1612e3          	bne	a2,a7,ffffffffc02044b4 <do_fork+0xa2>
    proc->tf->gpr.a0 = 0;
ffffffffc02044d4:	0406b823          	sd	zero,80(a3)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc02044d8:	10098e63          	beqz	s3,ffffffffc02045f4 <do_fork+0x1e2>
ffffffffc02044dc:	0136b823          	sd	s3,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc02044e0:	00000797          	auipc	a5,0x0
ffffffffc02044e4:	dac78793          	addi	a5,a5,-596 # ffffffffc020428c <forkret>
ffffffffc02044e8:	f81c                	sd	a5,48(s0)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc02044ea:	fc14                	sd	a3,56(s0)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc02044ec:	100027f3          	csrr	a5,sstatus
ffffffffc02044f0:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc02044f2:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc02044f4:	10079f63          	bnez	a5,ffffffffc0204612 <do_fork+0x200>
    if (++ last_pid >= MAX_PID) {
ffffffffc02044f8:	00007797          	auipc	a5,0x7
ffffffffc02044fc:	b6078793          	addi	a5,a5,-1184 # ffffffffc020b058 <last_pid.1575>
ffffffffc0204500:	439c                	lw	a5,0(a5)
ffffffffc0204502:	6709                	lui	a4,0x2
ffffffffc0204504:	0017851b          	addiw	a0,a5,1
ffffffffc0204508:	00007697          	auipc	a3,0x7
ffffffffc020450c:	b4a6a823          	sw	a0,-1200(a3) # ffffffffc020b058 <last_pid.1575>
ffffffffc0204510:	12e55263          	ble	a4,a0,ffffffffc0204634 <do_fork+0x222>
    if (last_pid >= next_safe) {
ffffffffc0204514:	00007797          	auipc	a5,0x7
ffffffffc0204518:	b4878793          	addi	a5,a5,-1208 # ffffffffc020b05c <next_safe.1574>
ffffffffc020451c:	439c                	lw	a5,0(a5)
ffffffffc020451e:	00012497          	auipc	s1,0x12
ffffffffc0204522:	0ca48493          	addi	s1,s1,202 # ffffffffc02165e8 <proc_list>
ffffffffc0204526:	06f54063          	blt	a0,a5,ffffffffc0204586 <do_fork+0x174>
        next_safe = MAX_PID;
ffffffffc020452a:	6789                	lui	a5,0x2
ffffffffc020452c:	00007717          	auipc	a4,0x7
ffffffffc0204530:	b2f72823          	sw	a5,-1232(a4) # ffffffffc020b05c <next_safe.1574>
ffffffffc0204534:	4581                	li	a1,0
ffffffffc0204536:	87aa                	mv	a5,a0
ffffffffc0204538:	00012497          	auipc	s1,0x12
ffffffffc020453c:	0b048493          	addi	s1,s1,176 # ffffffffc02165e8 <proc_list>
    repeat:
ffffffffc0204540:	6889                	lui	a7,0x2
ffffffffc0204542:	882e                	mv	a6,a1
ffffffffc0204544:	6609                	lui	a2,0x2
        le = list;
ffffffffc0204546:	00012697          	auipc	a3,0x12
ffffffffc020454a:	0a268693          	addi	a3,a3,162 # ffffffffc02165e8 <proc_list>
ffffffffc020454e:	6694                	ld	a3,8(a3)
        while ((le = list_next(le)) != list) {
ffffffffc0204550:	00968f63          	beq	a3,s1,ffffffffc020456e <do_fork+0x15c>
            if (proc->pid == last_pid) {
ffffffffc0204554:	f3c6a703          	lw	a4,-196(a3)
ffffffffc0204558:	08e78963          	beq	a5,a4,ffffffffc02045ea <do_fork+0x1d8>
            else if (proc->pid > last_pid && next_safe > proc->pid) {
ffffffffc020455c:	fee7d9e3          	ble	a4,a5,ffffffffc020454e <do_fork+0x13c>
ffffffffc0204560:	fec757e3          	ble	a2,a4,ffffffffc020454e <do_fork+0x13c>
ffffffffc0204564:	6694                	ld	a3,8(a3)
ffffffffc0204566:	863a                	mv	a2,a4
ffffffffc0204568:	4805                	li	a6,1
        while ((le = list_next(le)) != list) {
ffffffffc020456a:	fe9695e3          	bne	a3,s1,ffffffffc0204554 <do_fork+0x142>
ffffffffc020456e:	c591                	beqz	a1,ffffffffc020457a <do_fork+0x168>
ffffffffc0204570:	00007717          	auipc	a4,0x7
ffffffffc0204574:	aef72423          	sw	a5,-1304(a4) # ffffffffc020b058 <last_pid.1575>
ffffffffc0204578:	853e                	mv	a0,a5
ffffffffc020457a:	00080663          	beqz	a6,ffffffffc0204586 <do_fork+0x174>
ffffffffc020457e:	00007797          	auipc	a5,0x7
ffffffffc0204582:	acc7af23          	sw	a2,-1314(a5) # ffffffffc020b05c <next_safe.1574>
         proc->pid = get_pid();//分配id
ffffffffc0204586:	c048                	sw	a0,4(s0)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc0204588:	45a9                	li	a1,10
ffffffffc020458a:	2501                	sext.w	a0,a0
ffffffffc020458c:	4c2000ef          	jal	ra,ffffffffc0204a4e <hash32>
ffffffffc0204590:	1502                	slli	a0,a0,0x20
ffffffffc0204592:	0000e797          	auipc	a5,0xe
ffffffffc0204596:	ece78793          	addi	a5,a5,-306 # ffffffffc0212460 <hash_list>
ffffffffc020459a:	8171                	srli	a0,a0,0x1c
ffffffffc020459c:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc020459e:	6510                	ld	a2,8(a0)
ffffffffc02045a0:	0d840793          	addi	a5,s0,216
ffffffffc02045a4:	6494                	ld	a3,8(s1)
         nr_process++;//进程数加1
ffffffffc02045a6:	00092703          	lw	a4,0(s2)
    prev->next = next->prev = elm;
ffffffffc02045aa:	e21c                	sd	a5,0(a2)
ffffffffc02045ac:	e51c                	sd	a5,8(a0)
    elm->next = next;
ffffffffc02045ae:	f070                	sd	a2,224(s0)
         list_add(&proc_list , &proc->list_link); //  将新进程添加到进程链表
ffffffffc02045b0:	0c840793          	addi	a5,s0,200
    elm->prev = prev;
ffffffffc02045b4:	ec68                	sd	a0,216(s0)
    prev->next = next->prev = elm;
ffffffffc02045b6:	e29c                	sd	a5,0(a3)
         nr_process++;//进程数加1
ffffffffc02045b8:	2705                	addiw	a4,a4,1
ffffffffc02045ba:	00012617          	auipc	a2,0x12
ffffffffc02045be:	02f63b23          	sd	a5,54(a2) # ffffffffc02165f0 <proc_list+0x8>
    elm->next = next;
ffffffffc02045c2:	e874                	sd	a3,208(s0)
    elm->prev = prev;
ffffffffc02045c4:	e464                	sd	s1,200(s0)
ffffffffc02045c6:	00012797          	auipc	a5,0x12
ffffffffc02045ca:	eee7ad23          	sw	a4,-262(a5) # ffffffffc02164c0 <nr_process>
    if (flag) {
ffffffffc02045ce:	06099a63          	bnez	s3,ffffffffc0204642 <do_fork+0x230>
     wakeup_proc(proc);//    唤醒新进程
ffffffffc02045d2:	8522                	mv	a0,s0
ffffffffc02045d4:	3ae000ef          	jal	ra,ffffffffc0204982 <wakeup_proc>
     ret =  proc->pid;//    返回新进程的PID，表示成功创建新进程
ffffffffc02045d8:	4048                	lw	a0,4(s0)
}
ffffffffc02045da:	70a2                	ld	ra,40(sp)
ffffffffc02045dc:	7402                	ld	s0,32(sp)
ffffffffc02045de:	64e2                	ld	s1,24(sp)
ffffffffc02045e0:	6942                	ld	s2,16(sp)
ffffffffc02045e2:	69a2                	ld	s3,8(sp)
ffffffffc02045e4:	6a02                	ld	s4,0(sp)
ffffffffc02045e6:	6145                	addi	sp,sp,48
ffffffffc02045e8:	8082                	ret
                if (++ last_pid >= next_safe) {
ffffffffc02045ea:	2785                	addiw	a5,a5,1
ffffffffc02045ec:	04c7de63          	ble	a2,a5,ffffffffc0204648 <do_fork+0x236>
ffffffffc02045f0:	4585                	li	a1,1
ffffffffc02045f2:	bfb1                	j	ffffffffc020454e <do_fork+0x13c>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc02045f4:	89b6                	mv	s3,a3
ffffffffc02045f6:	0136b823          	sd	s3,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc02045fa:	00000797          	auipc	a5,0x0
ffffffffc02045fe:	c9278793          	addi	a5,a5,-878 # ffffffffc020428c <forkret>
ffffffffc0204602:	f81c                	sd	a5,48(s0)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0204604:	fc14                	sd	a3,56(s0)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204606:	100027f3          	csrr	a5,sstatus
ffffffffc020460a:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc020460c:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020460e:	ee0785e3          	beqz	a5,ffffffffc02044f8 <do_fork+0xe6>
        intr_disable();
ffffffffc0204612:	fc7fb0ef          	jal	ra,ffffffffc02005d8 <intr_disable>
    if (++ last_pid >= MAX_PID) {
ffffffffc0204616:	00007797          	auipc	a5,0x7
ffffffffc020461a:	a4278793          	addi	a5,a5,-1470 # ffffffffc020b058 <last_pid.1575>
ffffffffc020461e:	439c                	lw	a5,0(a5)
ffffffffc0204620:	6709                	lui	a4,0x2
        return 1;
ffffffffc0204622:	4985                	li	s3,1
ffffffffc0204624:	0017851b          	addiw	a0,a5,1
ffffffffc0204628:	00007697          	auipc	a3,0x7
ffffffffc020462c:	a2a6a823          	sw	a0,-1488(a3) # ffffffffc020b058 <last_pid.1575>
ffffffffc0204630:	eee542e3          	blt	a0,a4,ffffffffc0204514 <do_fork+0x102>
        last_pid = 1;
ffffffffc0204634:	4785                	li	a5,1
ffffffffc0204636:	00007717          	auipc	a4,0x7
ffffffffc020463a:	a2f72123          	sw	a5,-1502(a4) # ffffffffc020b058 <last_pid.1575>
ffffffffc020463e:	4505                	li	a0,1
ffffffffc0204640:	b5ed                	j	ffffffffc020452a <do_fork+0x118>
        intr_enable();
ffffffffc0204642:	f91fb0ef          	jal	ra,ffffffffc02005d2 <intr_enable>
ffffffffc0204646:	b771                	j	ffffffffc02045d2 <do_fork+0x1c0>
                    if (last_pid >= MAX_PID) {
ffffffffc0204648:	0117c363          	blt	a5,a7,ffffffffc020464e <do_fork+0x23c>
                        last_pid = 1;
ffffffffc020464c:	4785                	li	a5,1
                    goto repeat;
ffffffffc020464e:	4585                	li	a1,1
ffffffffc0204650:	bdcd                	j	ffffffffc0204542 <do_fork+0x130>
    kfree(proc);
ffffffffc0204652:	8522                	mv	a0,s0
ffffffffc0204654:	c02fd0ef          	jal	ra,ffffffffc0201a56 <kfree>
    ret = -E_NO_MEM;
ffffffffc0204658:	5571                	li	a0,-4
    goto fork_out;
ffffffffc020465a:	b741                	j	ffffffffc02045da <do_fork+0x1c8>
    int ret = -E_NO_FREE_PROC;
ffffffffc020465c:	556d                	li	a0,-5
ffffffffc020465e:	bfb5                	j	ffffffffc02045da <do_fork+0x1c8>
    ret = -E_NO_MEM;
ffffffffc0204660:	5571                	li	a0,-4
ffffffffc0204662:	bfa5                	j	ffffffffc02045da <do_fork+0x1c8>
    assert(current->mm == NULL);
ffffffffc0204664:	00002697          	auipc	a3,0x2
ffffffffc0204668:	64c68693          	addi	a3,a3,1612 # ffffffffc0206cb0 <default_pmm_manager+0x1020>
ffffffffc020466c:	00001617          	auipc	a2,0x1
ffffffffc0204670:	28c60613          	addi	a2,a2,652 # ffffffffc02058f8 <commands+0x870>
ffffffffc0204674:	10900593          	li	a1,265
ffffffffc0204678:	00002517          	auipc	a0,0x2
ffffffffc020467c:	65050513          	addi	a0,a0,1616 # ffffffffc0206cc8 <default_pmm_manager+0x1038>
ffffffffc0204680:	dd1fb0ef          	jal	ra,ffffffffc0200450 <__panic>
ffffffffc0204684:	00001617          	auipc	a2,0x1
ffffffffc0204688:	65c60613          	addi	a2,a2,1628 # ffffffffc0205ce0 <default_pmm_manager+0x50>
ffffffffc020468c:	06900593          	li	a1,105
ffffffffc0204690:	00001517          	auipc	a0,0x1
ffffffffc0204694:	67850513          	addi	a0,a0,1656 # ffffffffc0205d08 <default_pmm_manager+0x78>
ffffffffc0204698:	db9fb0ef          	jal	ra,ffffffffc0200450 <__panic>
...
ffffffffc02046b2:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02046b4:	049000ef          	jal	ra,ffffffffc0204efc <memset>
...
ffffffffc02046d4:	b5078793          	addi	a5,a5,-1200 # ffffffffc0204220 <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02046d8:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc02046da:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02046dc:	d37ff0ef          	jal	ra,ffffffffc0204412 <do_fork>
}
...
ffffffffc02046ec:	1141                	addi	sp,sp,-16
    panic("process exit!!.\n");
ffffffffc02046ee:	00002617          	auipc	a2,0x2
ffffffffc02046f2:	5aa60613          	addi	a2,a2,1450 # ffffffffc0206c98 <default_pmm_manager+0x1008>
ffffffffc02046f6:	16d00593          	li	a1,365
ffffffffc02046fa:	00002517          	auipc	a0,0x2
ffffffffc02046fe:	5ce50513          	addi	a0,a0,1486 # ffffffffc0206cc8 <default_pmm_manager+0x1038>
do_exit(int error_code) {
ffffffffc0204702:	e406                	sd	ra,8(sp)
    panic("process exit!!.\n");
ffffffffc0204704:	d4dfb0ef          	jal	ra,ffffffffc0200450 <__panic>

ffffffffc0204708 <proc_init>:
    elm->prev = elm->next = elm;
ffffffffc0204708:	00012797          	auipc	a5,0x12
ffffffffc020470c:	ee078793          	addi	a5,a5,-288 # ffffffffc02165e8 <proc_list>
...
ffffffffc0204712:	00012717          	auipc	a4,0x12
ffffffffc0204716:	ecf73f23          	sd	a5,-290(a4) # ffffffffc02165f0 <proc_list+0x8>
ffffffffc020471a:	00012717          	auipc	a4,0x12
ffffffffc020471e:	ecf73723          	sd	a5,-306(a4) # ffffffffc02165e8 <proc_list>
ffffffffc0204722:	ec06                	sd	ra,24(sp)
ffffffffc0204724:	e822                	sd	s0,16(sp)
ffffffffc0204726:	e426                	sd	s1,8(sp)
ffffffffc0204728:	e04a                	sd	s2,0(sp)
ffffffffc020472a:	0000e797          	auipc	a5,0xe
ffffffffc020472e:	d3678793          	addi	a5,a5,-714 # ffffffffc0212460 <hash_list>
ffffffffc0204732:	00012717          	auipc	a4,0x12
ffffffffc0204736:	d2e70713          	addi	a4,a4,-722 # ffffffffc0216460 <name.1565>
ffffffffc020473a:	e79c                	sd	a5,8(a5)
ffffffffc020473c:	e39c                	sd	a5,0(a5)
ffffffffc020473e:	07c1                	addi	a5,a5,16
    int i;

    list_init(&proc_list);
    for (i = 0; i < HASH_LIST_SIZE; i ++) {
ffffffffc0204740:	fee79de3          	bne	a5,a4,ffffffffc020473a <proc_init+0x32>
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL) {
ffffffffc0204744:	ae5ff0ef          	jal	ra,ffffffffc0204228 <alloc_proc>
ffffffffc0204748:	00012797          	auipc	a5,0x12
ffffffffc020474c:	d6a7b423          	sd	a0,-664(a5) # ffffffffc02164b0 <idleproc>
ffffffffc0204750:	00012417          	auipc	s0,0x12
ffffffffc0204754:	d6040413          	addi	s0,s0,-672 # ffffffffc02164b0 <idleproc>
ffffffffc0204758:	12050a63          	beqz	a0,ffffffffc020488c <proc_init+0x184>
        panic("cannot alloc idleproc.\n");
    }

    // check the proc structure
    int *context_mem = (int*) kmalloc(sizeof(struct context));
ffffffffc020475c:	07000513          	li	a0,112
ffffffffc0204760:	a3afd0ef          	jal	ra,ffffffffc020199a <kmalloc>
    memset(context_mem, 0, sizeof(struct context));
ffffffffc0204764:	07000613          	li	a2,112
ffffffffc0204768:	4581                	li	a1,0
    int *context_mem = (int*) kmalloc(sizeof(struct context));
ffffffffc020476a:	84aa                	mv	s1,a0
    memset(context_mem, 0, sizeof(struct context));
ffffffffc020476c:	790000ef          	jal	ra,ffffffffc0204efc <memset>
    int context_init_flag = memcmp(&(idleproc->context), context_mem, sizeof(struct context));
ffffffffc0204770:	6008                	ld	a0,0(s0)
ffffffffc0204772:	85a6                	mv	a1,s1
ffffffffc0204774:	07000613          	li	a2,112
ffffffffc0204778:	03050513          	addi	a0,a0,48
ffffffffc020477c:	7aa000ef          	jal	ra,ffffffffc0204f26 <memcmp>
ffffffffc0204780:	892a                	mv	s2,a0

    int *proc_name_mem = (int*) kmalloc(PROC_NAME_LEN);
ffffffffc0204782:	453d                	li	a0,15
ffffffffc0204784:	a16fd0ef          	jal	ra,ffffffffc020199a <kmalloc>
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc0204788:	463d                	li	a2,15
ffffffffc020478a:	4581                	li	a1,0
    int *proc_name_mem = (int*) kmalloc(PROC_NAME_LEN);
ffffffffc020478c:	84aa                	mv	s1,a0
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc020478e:	76e000ef          	jal	ra,ffffffffc0204efc <memset>
    int proc_name_flag = memcmp(&(idleproc->name), proc_name_mem, PROC_NAME_LEN);
ffffffffc0204792:	6008                	ld	a0,0(s0)
ffffffffc0204794:	463d                	li	a2,15
ffffffffc0204796:	85a6                	mv	a1,s1
ffffffffc0204798:	0b450513          	addi	a0,a0,180
ffffffffc020479c:	78a000ef          	jal	ra,ffffffffc0204f26 <memcmp>

    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc02047a0:	601c                	ld	a5,0(s0)
ffffffffc02047a2:	00012717          	auipc	a4,0x12
ffffffffc02047a6:	d5670713          	addi	a4,a4,-682 # ffffffffc02164f8 <boot_cr3>
ffffffffc02047aa:	6318                	ld	a4,0(a4)
ffffffffc02047ac:	77d4                	ld	a3,168(a5)
ffffffffc02047ae:	08e68e63          	beq	a3,a4,ffffffffc020484a <proc_init+0x142>
...
ffffffffc02047b2:	4709                	li	a4,2
ffffffffc02047b4:	e398                	sd	a4,0(a5)
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc02047b6:	00004717          	auipc	a4,0x4
ffffffffc02047ba:	84a70713          	addi	a4,a4,-1974 # ffffffffc0208000 <bootstack>
ffffffffc02047be:	eb98                	sd	a4,16(a5)
    idleproc->need_resched = 1;
ffffffffc02047c0:	4705                	li	a4,1
ffffffffc02047c2:	cf98                	sw	a4,24(a5)
    set_proc_name(idleproc, "idle");
ffffffffc02047c4:	00002597          	auipc	a1,0x2
ffffffffc02047c8:	5a458593          	addi	a1,a1,1444 # ffffffffc0206d68 <default_pmm_manager+0x10d8>
ffffffffc02047cc:	853e                	mv	a0,a5
ffffffffc02047ce:	acfff0ef          	jal	ra,ffffffffc020429c <set_proc_name>
    nr_process ++;
ffffffffc02047d2:	00012797          	auipc	a5,0x12
ffffffffc02047d6:	cee78793          	addi	a5,a5,-786 # ffffffffc02164c0 <nr_process>
ffffffffc02047da:	439c                	lw	a5,0(a5)

    current = idleproc;
ffffffffc02047dc:	6018                	ld	a4,0(s0)

    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc02047de:	4601                	li	a2,0
    nr_process ++;
ffffffffc02047e0:	2785                	addiw	a5,a5,1
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc02047e2:	00002597          	auipc	a1,0x2
ffffffffc02047e6:	58e58593          	addi	a1,a1,1422 # ffffffffc0206d70 <default_pmm_manager+0x10e0>
ffffffffc02047ea:	00000517          	auipc	a0,0x0
ffffffffc02047ee:	b0c50513          	addi	a0,a0,-1268 # ffffffffc02042f6 <init_main>
    nr_process ++;
ffffffffc02047f2:	00012697          	auipc	a3,0x12
ffffffffc02047f6:	ccf6a723          	sw	a5,-818(a3) # ffffffffc02164c0 <nr_process>
    current = idleproc;
ffffffffc02047fa:	00012797          	auipc	a5,0x12
ffffffffc02047fe:	cae7b723          	sd	a4,-850(a5) # ffffffffc02164a8 <current>
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc0204802:	e9bff0ef          	jal	ra,ffffffffc020469c <kernel_thread>
    if (pid <= 0) {
ffffffffc0204806:	0ca05f63          	blez	a0,ffffffffc02048e4 <proc_init+0x1dc>
        panic("create init_main failed.\n");
    }

    initproc = find_proc(pid);
ffffffffc020480a:	badff0ef          	jal	ra,ffffffffc02043b6 <find_proc>
    set_proc_name(initproc, "init");
ffffffffc020480e:	00002597          	auipc	a1,0x2
ffffffffc0204812:	59258593          	addi	a1,a1,1426 # ffffffffc0206da0 <default_pmm_manager+0x1110>
    initproc = find_proc(pid);
ffffffffc0204816:	00012797          	auipc	a5,0x12
ffffffffc020481a:	caa7b123          	sd	a0,-862(a5) # ffffffffc02164b8 <initproc>
    set_proc_name(initproc, "init");
ffffffffc020481e:	a7fff0ef          	jal	ra,ffffffffc020429c <set_proc_name>

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0204822:	601c                	ld	a5,0(s0)
ffffffffc0204824:	c3c5                	beqz	a5,ffffffffc02048c4 <proc_init+0x1bc>
ffffffffc0204826:	43dc                	lw	a5,4(a5)
ffffffffc0204828:	efd1                	bnez	a5,ffffffffc02048c4 <proc_init+0x1bc>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc020482a:	00012797          	auipc	a5,0x12
ffffffffc020482e:	c8e78793          	addi	a5,a5,-882 # ffffffffc02164b8 <initproc>
ffffffffc0204832:	639c                	ld	a5,0(a5)
ffffffffc0204834:	cba5                	beqz	a5,ffffffffc02048a4 <proc_init+0x19c>
ffffffffc0204836:	43d8                	lw	a4,4(a5)
ffffffffc0204838:	4785                	li	a5,1
ffffffffc020483a:	06f71563          	bne	a4,a5,ffffffffc02048a4 <proc_init+0x19c>
}
ffffffffc020483e:	60e2                	ld	ra,24(sp)
ffffffffc0204840:	6442                	ld	s0,16(sp)
ffffffffc0204842:	64a2                	ld	s1,8(sp)
ffffffffc0204844:	6902                	ld	s2,0(sp)
ffffffffc0204846:	6105                	addi	sp,sp,32
ffffffffc0204848:	8082                	ret
    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc020484a:	73d8                	ld	a4,160(a5)
ffffffffc020484c:	f33d                	bnez	a4,ffffffffc02047b2 <proc_init+0xaa>
ffffffffc020484e:	f60912e3          	bnez	s2,ffffffffc02047b2 <proc_init+0xaa>
        && idleproc->state == PROC_UNINIT && idleproc->pid == -1 && idleproc->runs == 0
ffffffffc0204852:	6394                	ld	a3,0(a5)
ffffffffc0204854:	577d                	li	a4,-1
ffffffffc0204856:	1702                	slli	a4,a4,0x20
ffffffffc0204858:	f4e69de3          	bne	a3,a4,ffffffffc02047b2 <proc_init+0xaa>
ffffffffc020485c:	4798                	lw	a4,8(a5)
ffffffffc020485e:	fb31                	bnez	a4,ffffffffc02047b2 <proc_init+0xaa>
        && idleproc->kstack == 0 && idleproc->need_resched == 0 && idleproc->parent == NULL
ffffffffc0204860:	6b98                	ld	a4,16(a5)
ffffffffc0204862:	fb21                	bnez	a4,ffffffffc02047b2 <proc_init+0xaa>
ffffffffc0204864:	4f98                	lw	a4,24(a5)
ffffffffc0204866:	2701                	sext.w	a4,a4
ffffffffc0204868:	f729                	bnez	a4,ffffffffc02047b2 <proc_init+0xaa>
ffffffffc020486a:	7398                	ld	a4,32(a5)
ffffffffc020486c:	f339                	bnez	a4,ffffffffc02047b2 <proc_init+0xaa>
        && idleproc->mm == NULL && idleproc->flags == 0 && !proc_name_flag
ffffffffc020486e:	7798                	ld	a4,40(a5)
ffffffffc0204870:	f329                	bnez	a4,ffffffffc02047b2 <proc_init+0xaa>
ffffffffc0204872:	0b07a703          	lw	a4,176(a5)
ffffffffc0204876:	8f49                	or	a4,a4,a0
ffffffffc0204878:	2701                	sext.w	a4,a4
ffffffffc020487a:	ff05                	bnez	a4,ffffffffc02047b2 <proc_init+0xaa>
        cprintf("alloc_proc() correct!\n");
ffffffffc020487c:	00002517          	auipc	a0,0x2
ffffffffc0204880:	4d450513          	addi	a0,a0,1236 # ffffffffc0206d50 <default_pmm_manager+0x10c0>
ffffffffc0204884:	90bfb0ef          	jal	ra,ffffffffc020018e <cprintf>
ffffffffc0204888:	601c                	ld	a5,0(s0)
ffffffffc020488a:	b725                	j	ffffffffc02047b2 <proc_init+0xaa>
        panic("cannot alloc idleproc.\n");
ffffffffc020488c:	00002617          	auipc	a2,0x2
ffffffffc0204890:	4ac60613          	addi	a2,a2,1196 # ffffffffc0206d38 <default_pmm_manager+0x10a8>
ffffffffc0204894:	18500593          	li	a1,389
ffffffffc0204898:	00002517          	auipc	a0,0x2
ffffffffc020489c:	43050513          	addi	a0,a0,1072 # ffffffffc0206cc8 <default_pmm_manager+0x1038>
ffffffffc02048a0:	bb1fb0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc02048a4:	00002697          	auipc	a3,0x2
ffffffffc02048a8:	52c68693          	addi	a3,a3,1324 # ffffffffc0206dd0 <default_pmm_manager+0x1140>
ffffffffc02048ac:	00001617          	auipc	a2,0x1
ffffffffc02048b0:	04c60613          	addi	a2,a2,76 # ffffffffc02058f8 <commands+0x870>
ffffffffc02048b4:	1ac00593          	li	a1,428
ffffffffc02048b8:	00002517          	auipc	a0,0x2
ffffffffc02048bc:	41050513          	addi	a0,a0,1040 # ffffffffc0206cc8 <default_pmm_manager+0x1038>
ffffffffc02048c0:	b91fb0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc02048c4:	00002697          	auipc	a3,0x2
ffffffffc02048c8:	4e468693          	addi	a3,a3,1252 # ffffffffc0206da8 <default_pmm_manager+0x1118>
ffffffffc02048cc:	00001617          	auipc	a2,0x1
ffffffffc02048d0:	02c60613          	addi	a2,a2,44 # ffffffffc02058f8 <commands+0x870>
ffffffffc02048d4:	1ab00593          	li	a1,427
ffffffffc02048d8:	00002517          	auipc	a0,0x2
ffffffffc02048dc:	3f050513          	addi	a0,a0,1008 # ffffffffc0206cc8 <default_pmm_manager+0x1038>
ffffffffc02048e0:	b71fb0ef          	jal	ra,ffffffffc0200450 <__panic>
        panic("create init_main failed.\n");
ffffffffc02048e4:	00002617          	auipc	a2,0x2
ffffffffc02048e8:	49c60613          	addi	a2,a2,1180 # ffffffffc0206d80 <default_pmm_manager+0x10f0>
ffffffffc02048ec:	1a500593          	li	a1,421
ffffffffc02048f0:	00002517          	auipc	a0,0x2
ffffffffc02048f4:	3d850513          	addi	a0,a0,984 # ffffffffc0206cc8 <default_pmm_manager+0x1038>
ffffffffc02048f8:	b59fb0ef          	jal	ra,ffffffffc0200450 <__panic>

ffffffffc02048fc <cpu_idle>:

// cpu_idle - at the end of kern_init, the first kernel thread idleproc will do below works
void
cpu_idle(void) {
ffffffffc02048fc:	1141                	addi	sp,sp,-16
ffffffffc02048fe:	e022                	sd	s0,0(sp)
ffffffffc0204900:	e406                	sd	ra,8(sp)
ffffffffc0204902:	00012417          	auipc	s0,0x12
ffffffffc0204906:	ba640413          	addi	s0,s0,-1114 # ffffffffc02164a8 <current>
    while (1) {
        if (current->need_resched) {
ffffffffc020490a:	6018                	ld	a4,0(s0)
ffffffffc020490c:	4f1c                	lw	a5,24(a4)
ffffffffc020490e:	2781                	sext.w	a5,a5
ffffffffc0204910:	dff5                	beqz	a5,ffffffffc020490c <cpu_idle+0x10>
            schedule();
ffffffffc0204912:	0a2000ef          	jal	ra,ffffffffc02049b4 <schedule>
ffffffffc0204916:	bfd5                	j	ffffffffc020490a <cpu_idle+0xe>

ffffffffc0204918 <switch_to>:
.text
...
ffffffffc0204918:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc020491c:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc0204920:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc0204922:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc0204924:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc0204928:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc020492c:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc0204930:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc0204934:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc0204938:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc020493c:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc0204940:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc0204944:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc0204948:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc020494c:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc0204950:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc0204954:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc0204956:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc0204958:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc020495c:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc0204960:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc0204964:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc0204968:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc020496c:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc0204970:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc0204974:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc0204978:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc020497c:	0685bd83          	ld	s11,104(a1)

    ret
ffffffffc0204980:	8082                	ret

ffffffffc0204982 <wakeup_proc>:
#include <sched.h>
#include <assert.h>
...
ffffffffc0204982:	411c                	lw	a5,0(a0)
ffffffffc0204984:	4705                	li	a4,1
ffffffffc0204986:	37f9                	addiw	a5,a5,-2
ffffffffc0204988:	00f77563          	bleu	a5,a4,ffffffffc0204992 <wakeup_proc+0x10>
    proc->state = PROC_RUNNABLE;
ffffffffc020498c:	4789                	li	a5,2
ffffffffc020498e:	c11c                	sw	a5,0(a0)
ffffffffc0204990:	8082                	ret
wakeup_proc(struct proc_struct *proc) {
ffffffffc0204992:	1141                	addi	sp,sp,-16
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc0204994:	00002697          	auipc	a3,0x2
ffffffffc0204998:	46468693          	addi	a3,a3,1124 # ffffffffc0206df8 <default_pmm_manager+0x1168>
ffffffffc020499c:	00001617          	auipc	a2,0x1
ffffffffc02049a0:	f5c60613          	addi	a2,a2,-164 # ffffffffc02058f8 <commands+0x870>
ffffffffc02049a4:	45a5                	li	a1,9
ffffffffc02049a6:	00002517          	auipc	a0,0x2
ffffffffc02049aa:	49250513          	addi	a0,a0,1170 # ffffffffc0206e38 <default_pmm_manager+0x11a8>
wakeup_proc(struct proc_struct *proc) {
ffffffffc02049ae:	e406                	sd	ra,8(sp)
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc02049b0:	aa1fb0ef          	jal	ra,ffffffffc0200450 <__panic>

ffffffffc02049b4 <schedule>:
}

void
schedule(void) {
ffffffffc02049b4:	1141                	addi	sp,sp,-16
ffffffffc02049b6:	e406                	sd	ra,8(sp)
ffffffffc02049b8:	e022                	sd	s0,0(sp)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc02049ba:	100027f3          	csrr	a5,sstatus
ffffffffc02049be:	8b89                	andi	a5,a5,2
ffffffffc02049c0:	4401                	li	s0,0
ffffffffc02049c2:	e3d1                	bnez	a5,ffffffffc0204a46 <schedule+0x92>
    bool intr_flag;
...
ffffffffc02049c4:	00012797          	auipc	a5,0x12
ffffffffc02049c8:	ae478793          	addi	a5,a5,-1308 # ffffffffc02164a8 <current>
ffffffffc02049cc:	0007b883          	ld	a7,0(a5)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc02049d0:	00012797          	auipc	a5,0x12
ffffffffc02049d4:	ae078793          	addi	a5,a5,-1312 # ffffffffc02164b0 <idleproc>
ffffffffc02049d8:	6388                	ld	a0,0(a5)
        current->need_resched = 0;
ffffffffc02049da:	0008ac23          	sw	zero,24(a7) # 2018 <BASE_ADDRESS-0xffffffffc01fdfe8>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc02049de:	04a88e63          	beq	a7,a0,ffffffffc0204a3a <schedule+0x86>
ffffffffc02049e2:	0c888693          	addi	a3,a7,200
ffffffffc02049e6:	00012617          	auipc	a2,0x12
ffffffffc02049ea:	c0260613          	addi	a2,a2,-1022 # ffffffffc02165e8 <proc_list>
        le = last;
ffffffffc02049ee:	87b6                	mv	a5,a3
    struct proc_struct *next = NULL;
ffffffffc02049f0:	4581                	li	a1,0
        do {
            if ((le = list_next(le)) != &proc_list) {
                next = le2proc(le, list_link);
                if (next->state == PROC_RUNNABLE) {
ffffffffc02049f2:	4809                	li	a6,2
    return listelm->next;
ffffffffc02049f4:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc02049f6:	00c78863          	beq	a5,a2,ffffffffc0204a06 <schedule+0x52>
                if (next->state == PROC_RUNNABLE) {
ffffffffc02049fa:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc02049fe:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc0204a02:	01070463          	beq	a4,a6,ffffffffc0204a0a <schedule+0x56>
                    break;
                }
            }
        } while (le != last);
ffffffffc0204a06:	fef697e3          	bne	a3,a5,ffffffffc02049f4 <schedule+0x40>
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0204a0a:	c589                	beqz	a1,ffffffffc0204a14 <schedule+0x60>
ffffffffc0204a0c:	4198                	lw	a4,0(a1)
ffffffffc0204a0e:	4789                	li	a5,2
ffffffffc0204a10:	00f70e63          	beq	a4,a5,ffffffffc0204a2c <schedule+0x78>
            next = idleproc;
        }
        next->runs ++;
ffffffffc0204a14:	451c                	lw	a5,8(a0)
ffffffffc0204a16:	2785                	addiw	a5,a5,1
ffffffffc0204a18:	c51c                	sw	a5,8(a0)
        if (next != current) {
ffffffffc0204a1a:	00a88463          	beq	a7,a0,ffffffffc0204a22 <schedule+0x6e>
            proc_run(next);
ffffffffc0204a1e:	92bff0ef          	jal	ra,ffffffffc0204348 <proc_run>
    if (flag) {
ffffffffc0204a22:	e419                	bnez	s0,ffffffffc0204a30 <schedule+0x7c>
        }
    }
    local_intr_restore(intr_flag);
}
ffffffffc0204a24:	60a2                	ld	ra,8(sp)
ffffffffc0204a26:	6402                	ld	s0,0(sp)
ffffffffc0204a28:	0141                	addi	sp,sp,16
ffffffffc0204a2a:	8082                	ret
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0204a2c:	852e                	mv	a0,a1
ffffffffc0204a2e:	b7dd                	j	ffffffffc0204a14 <schedule+0x60>
}
ffffffffc0204a30:	6402                	ld	s0,0(sp)
ffffffffc0204a32:	60a2                	ld	ra,8(sp)
ffffffffc0204a34:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc0204a36:	b9dfb06f          	j	ffffffffc02005d2 <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0204a3a:	00012617          	auipc	a2,0x12
ffffffffc0204a3e:	bae60613          	addi	a2,a2,-1106 # ffffffffc02165e8 <proc_list>
ffffffffc0204a42:	86b2                	mv	a3,a2
ffffffffc0204a44:	b76d                	j	ffffffffc02049ee <schedule+0x3a>
        intr_disable();
ffffffffc0204a46:	b93fb0ef          	jal	ra,ffffffffc02005d8 <intr_disable>
        return 1;
ffffffffc0204a4a:	4405                	li	s0,1
ffffffffc0204a4c:	bfa5                	j	ffffffffc02049c4 <schedule+0x10>

ffffffffc0204a4e <hash32>:
 *
...
ffffffffc0204a4e:	9e3707b7          	lui	a5,0x9e370
ffffffffc0204a52:	2785                	addiw	a5,a5,1
ffffffffc0204a54:	02f5053b          	mulw	a0,a0,a5
    return (hash >> (32 - bits));
ffffffffc0204a58:	02000793          	li	a5,32
ffffffffc0204a5c:	40b785bb          	subw	a1,a5,a1
}
ffffffffc0204a60:	00b5553b          	srlw	a0,a0,a1
...
ffffffffc0204a88:	2a01                	sext.w	s4,s4
    ...
    if (num >= base) {
ffffffffc0204a8a:	03067e63          	bleu	a6,a2,ffffffffc0204ac6 <printnum+0x60>
...
ffffffffc0204aa8:	53c78793          	addi	a5,a5,1340 # ffffffffc0206fe0 <error_string+0x38>
...
ffffffffc0204ad8:	e8d2                	sd	s4,80(sp)
ffffffffc0204ada:	e4d6                	sd	s5,72(sp)
ffffffffc0204adc:	e0da                	sd	s6,64(sp)
ffffffffc0204ade:	fc5e                	sd	s7,56(sp)
...
ffffffffc0204ae8:	ecce                	sd	s3,88(sp)
...
ffffffffc0204af4:	8ab6                	mv	s5,a3
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0204af6:	5b7d                	li	s6,-1
        lflag = altflag = 0;

    reswitch:
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204af8:	00002a17          	auipc	s4,0x2
ffffffffc0204afc:	358a0a13          	addi	s4,s4,856 # ffffffffc0206e50 <default_pmm_manager+0x11c0>
            ...
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204b00:	05e00b93          	li	s7,94
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204b04:	00002c17          	auipc	s8,0x2
ffffffffc0204b08:	4a4c0c13          	addi	s8,s8,1188 # ffffffffc0206fa8 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204b0c:	000d4503          	lbu	a0,0(s10) # 1000 <BASE_ADDRESS-0xffffffffc01ff000>
ffffffffc0204b10:	02500793          	li	a5,37
ffffffffc0204b14:	001d0413          	addi	s0,s10,1
ffffffffc0204b18:	00f50e63          	beq	a0,a5,ffffffffc0204b34 <vprintfmt+0x62>
            if (ch == '\0') {
ffffffffc0204b1c:	c521                	beqz	a0,ffffffffc0204b64 <vprintfmt+0x92>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204b1e:	02500993          	li	s3,37
ffffffffc0204b22:	a011                	j	ffffffffc0204b26 <vprintfmt+0x54>
            if (ch == '\0') {
ffffffffc0204b24:	c121                	beqz	a0,ffffffffc0204b64 <vprintfmt+0x92>
            putch(ch, putdat);
ffffffffc0204b26:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204b28:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0204b2a:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204b2c:	fff44503          	lbu	a0,-1(s0)
ffffffffc0204b30:	ff351ae3          	bne	a0,s3,ffffffffc0204b24 <vprintfmt+0x52>
ffffffffc0204b34:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0204b38:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0204b3c:	4981                	li	s3,0
ffffffffc0204b3e:	4801                	li	a6,0
        width = precision = -1;
ffffffffc0204b40:	5cfd                	li	s9,-1
ffffffffc0204b42:	5dfd                	li	s11,-1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b44:	05500593          	li	a1,85
                if (ch < '0' || ch > '9') {
ffffffffc0204b48:	4525                	li	a0,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b4a:	fdd6069b          	addiw	a3,a2,-35
ffffffffc0204b4e:	0ff6f693          	andi	a3,a3,255
ffffffffc0204b52:	00140d13          	addi	s10,s0,1
ffffffffc0204b56:	20d5e563          	bltu	a1,a3,ffffffffc0204d60 <vprintfmt+0x28e>
ffffffffc0204b5a:	068a                	slli	a3,a3,0x2
ffffffffc0204b5c:	96d2                	add	a3,a3,s4
ffffffffc0204b5e:	4294                	lw	a3,0(a3)
ffffffffc0204b60:	96d2                	add	a3,a3,s4
ffffffffc0204b62:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0204b64:	70e6                	ld	ra,120(sp)
ffffffffc0204b66:	7446                	ld	s0,112(sp)
ffffffffc0204b68:	74a6                	ld	s1,104(sp)
ffffffffc0204b6a:	7906                	ld	s2,96(sp)
ffffffffc0204b6c:	69e6                	ld	s3,88(sp)
ffffffffc0204b6e:	6a46                	ld	s4,80(sp)
ffffffffc0204b70:	6aa6                	ld	s5,72(sp)
ffffffffc0204b72:	6b06                	ld	s6,64(sp)
ffffffffc0204b74:	7be2                	ld	s7,56(sp)
ffffffffc0204b76:	7c42                	ld	s8,48(sp)
ffffffffc0204b78:	7ca2                	ld	s9,40(sp)
ffffffffc0204b7a:	7d02                	ld	s10,32(sp)
ffffffffc0204b7c:	6de2                	ld	s11,24(sp)
ffffffffc0204b7e:	6109                	addi	sp,sp,128
ffffffffc0204b80:	8082                	ret
    if (lflag >= 2) {
ffffffffc0204b82:	4705                	li	a4,1
ffffffffc0204b84:	008a8593          	addi	a1,s5,8
ffffffffc0204b88:	01074463          	blt	a4,a6,ffffffffc0204b90 <vprintfmt+0xbe>
    else if (lflag) {
ffffffffc0204b8c:	26080363          	beqz	a6,ffffffffc0204df2 <vprintfmt+0x320>
        return va_arg(*ap, unsigned long);
ffffffffc0204b90:	000ab603          	ld	a2,0(s5)
ffffffffc0204b94:	46c1                	li	a3,16
ffffffffc0204b96:	8aae                	mv	s5,a1
ffffffffc0204b98:	a06d                	j	ffffffffc0204c42 <vprintfmt+0x170>
            goto reswitch;
ffffffffc0204b9a:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0204b9e:	4985                	li	s3,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204ba0:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204ba2:	b765                	j	ffffffffc0204b4a <vprintfmt+0x78>
            putch(va_arg(ap, int), putdat);
ffffffffc0204ba4:	000aa503          	lw	a0,0(s5)
ffffffffc0204ba8:	85a6                	mv	a1,s1
ffffffffc0204baa:	0aa1                	addi	s5,s5,8
ffffffffc0204bac:	9902                	jalr	s2
            break;
ffffffffc0204bae:	bfb9                	j	ffffffffc0204b0c <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204bb0:	4705                	li	a4,1
ffffffffc0204bb2:	008a8993          	addi	s3,s5,8
ffffffffc0204bb6:	01074463          	blt	a4,a6,ffffffffc0204bbe <vprintfmt+0xec>
    else if (lflag) {
ffffffffc0204bba:	22080463          	beqz	a6,ffffffffc0204de2 <vprintfmt+0x310>
        return va_arg(*ap, long);
ffffffffc0204bbe:	000ab403          	ld	s0,0(s5)
            if ((long long)num < 0) {
ffffffffc0204bc2:	24044463          	bltz	s0,ffffffffc0204e0a <vprintfmt+0x338>
            num = getint(&ap, lflag);
ffffffffc0204bc6:	8622                	mv	a2,s0
ffffffffc0204bc8:	8ace                	mv	s5,s3
ffffffffc0204bca:	46a9                	li	a3,10
ffffffffc0204bcc:	a89d                	j	ffffffffc0204c42 <vprintfmt+0x170>
            err = va_arg(ap, int);
ffffffffc0204bce:	000aa783          	lw	a5,0(s5)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204bd2:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0204bd4:	0aa1                	addi	s5,s5,8
            if (err < 0) {
ffffffffc0204bd6:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204bda:	8fb5                	xor	a5,a5,a3
ffffffffc0204bdc:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204be0:	1ad74363          	blt	a4,a3,ffffffffc0204d86 <vprintfmt+0x2b4>
ffffffffc0204be4:	00369793          	slli	a5,a3,0x3
ffffffffc0204be8:	97e2                	add	a5,a5,s8
ffffffffc0204bea:	639c                	ld	a5,0(a5)
ffffffffc0204bec:	18078d63          	beqz	a5,ffffffffc0204d86 <vprintfmt+0x2b4>
                printfmt(putch, putdat, "%s", p);
ffffffffc0204bf0:	86be                	mv	a3,a5
ffffffffc0204bf2:	00000617          	auipc	a2,0x0
ffffffffc0204bf6:	38e60613          	addi	a2,a2,910 # ffffffffc0204f80 <etext+0x2a>
ffffffffc0204bfa:	85a6                	mv	a1,s1
ffffffffc0204bfc:	854a                	mv	a0,s2
ffffffffc0204bfe:	240000ef          	jal	ra,ffffffffc0204e3e <printfmt>
ffffffffc0204c02:	b729                	j	ffffffffc0204b0c <vprintfmt+0x3a>
            lflag ++;
ffffffffc0204c04:	00144603          	lbu	a2,1(s0)
ffffffffc0204c08:	2805                	addiw	a6,a6,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c0a:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c0c:	bf3d                	j	ffffffffc0204b4a <vprintfmt+0x78>
    if (lflag >= 2) {
ffffffffc0204c0e:	4705                	li	a4,1
ffffffffc0204c10:	008a8593          	addi	a1,s5,8
ffffffffc0204c14:	01074463          	blt	a4,a6,ffffffffc0204c1c <vprintfmt+0x14a>
    else if (lflag) {
ffffffffc0204c18:	1e080263          	beqz	a6,ffffffffc0204dfc <vprintfmt+0x32a>
        return va_arg(*ap, unsigned long);
ffffffffc0204c1c:	000ab603          	ld	a2,0(s5)
ffffffffc0204c20:	46a1                	li	a3,8
ffffffffc0204c22:	8aae                	mv	s5,a1
ffffffffc0204c24:	a839                	j	ffffffffc0204c42 <vprintfmt+0x170>
            putch('0', putdat);
ffffffffc0204c26:	03000513          	li	a0,48
ffffffffc0204c2a:	85a6                	mv	a1,s1
ffffffffc0204c2c:	e03e                	sd	a5,0(sp)
ffffffffc0204c2e:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0204c30:	85a6                	mv	a1,s1
ffffffffc0204c32:	07800513          	li	a0,120
ffffffffc0204c36:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204c38:	0aa1                	addi	s5,s5,8
ffffffffc0204c3a:	ff8ab603          	ld	a2,-8(s5)
            goto number;
ffffffffc0204c3e:	6782                	ld	a5,0(sp)
ffffffffc0204c40:	46c1                	li	a3,16
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0204c42:	876e                	mv	a4,s11
ffffffffc0204c44:	85a6                	mv	a1,s1
ffffffffc0204c46:	854a                	mv	a0,s2
ffffffffc0204c48:	e1fff0ef          	jal	ra,ffffffffc0204a66 <printnum>
            break;
ffffffffc0204c4c:	b5c1                	j	ffffffffc0204b0c <vprintfmt+0x3a>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204c4e:	000ab603          	ld	a2,0(s5)
ffffffffc0204c52:	0aa1                	addi	s5,s5,8
ffffffffc0204c54:	1c060663          	beqz	a2,ffffffffc0204e20 <vprintfmt+0x34e>
            if (width > 0 && padc != '-') {
ffffffffc0204c58:	00160413          	addi	s0,a2,1
ffffffffc0204c5c:	17b05c63          	blez	s11,ffffffffc0204dd4 <vprintfmt+0x302>
ffffffffc0204c60:	02d00593          	li	a1,45
ffffffffc0204c64:	14b79263          	bne	a5,a1,ffffffffc0204da8 <vprintfmt+0x2d6>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204c68:	00064783          	lbu	a5,0(a2)
ffffffffc0204c6c:	0007851b          	sext.w	a0,a5
ffffffffc0204c70:	c905                	beqz	a0,ffffffffc0204ca0 <vprintfmt+0x1ce>
ffffffffc0204c72:	000cc563          	bltz	s9,ffffffffc0204c7c <vprintfmt+0x1aa>
ffffffffc0204c76:	3cfd                	addiw	s9,s9,-1
ffffffffc0204c78:	036c8263          	beq	s9,s6,ffffffffc0204c9c <vprintfmt+0x1ca>
                    putch('?', putdat);
ffffffffc0204c7c:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204c7e:	18098463          	beqz	s3,ffffffffc0204e06 <vprintfmt+0x334>
ffffffffc0204c82:	3781                	addiw	a5,a5,-32
ffffffffc0204c84:	18fbf163          	bleu	a5,s7,ffffffffc0204e06 <vprintfmt+0x334>
                    putch('?', putdat);
ffffffffc0204c88:	03f00513          	li	a0,63
ffffffffc0204c8c:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204c8e:	0405                	addi	s0,s0,1
ffffffffc0204c90:	fff44783          	lbu	a5,-1(s0)
ffffffffc0204c94:	3dfd                	addiw	s11,s11,-1
ffffffffc0204c96:	0007851b          	sext.w	a0,a5
ffffffffc0204c9a:	fd61                	bnez	a0,ffffffffc0204c72 <vprintfmt+0x1a0>
            for (; width > 0; width --) {
ffffffffc0204c9c:	e7b058e3          	blez	s11,ffffffffc0204b0c <vprintfmt+0x3a>
ffffffffc0204ca0:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0204ca2:	85a6                	mv	a1,s1
ffffffffc0204ca4:	02000513          	li	a0,32
ffffffffc0204ca8:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204caa:	e60d81e3          	beqz	s11,ffffffffc0204b0c <vprintfmt+0x3a>
...
ffffffffc0204cb6:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204cb8:	fe0d94e3          	bnez	s11,ffffffffc0204ca0 <vprintfmt+0x1ce>
ffffffffc0204cbc:	bd81                	j	ffffffffc0204b0c <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204cbe:	4705                	li	a4,1
ffffffffc0204cc0:	008a8593          	addi	a1,s5,8
ffffffffc0204cc4:	01074463          	blt	a4,a6,ffffffffc0204ccc <vprintfmt+0x1fa>
    else if (lflag) {
ffffffffc0204cc8:	12080063          	beqz	a6,ffffffffc0204de8 <vprintfmt+0x316>
        return va_arg(*ap, unsigned long);
ffffffffc0204ccc:	000ab603          	ld	a2,0(s5)
ffffffffc0204cd0:	46a9                	li	a3,10
ffffffffc0204cd2:	8aae                	mv	s5,a1
ffffffffc0204cd4:	b7bd                	j	ffffffffc0204c42 <vprintfmt+0x170>
ffffffffc0204cd6:	00144603          	lbu	a2,1(s0)
            padc = '-';
ffffffffc0204cda:	02d00793          	li	a5,45
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204cde:	846a                	mv	s0,s10
ffffffffc0204ce0:	b5ad                	j	ffffffffc0204b4a <vprintfmt+0x78>
            putch(ch, putdat);
ffffffffc0204ce2:	85a6                	mv	a1,s1
ffffffffc0204ce4:	02500513          	li	a0,37
ffffffffc0204ce8:	9902                	jalr	s2
            break;
ffffffffc0204cea:	b50d                	j	ffffffffc0204b0c <vprintfmt+0x3a>
            precision = va_arg(ap, int);
ffffffffc0204cec:	000aac83          	lw	s9,0(s5)
            goto process_precision;
ffffffffc0204cf0:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc0204cf4:	0aa1                	addi	s5,s5,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204cf6:	846a                	mv	s0,s10
            if (width < 0)
ffffffffc0204cf8:	e40dd9e3          	bgez	s11,ffffffffc0204b4a <vprintfmt+0x78>
                width = precision, precision = -1;
ffffffffc0204cfc:	8de6                	mv	s11,s9
ffffffffc0204cfe:	5cfd                	li	s9,-1
ffffffffc0204d00:	b5a9                	j	ffffffffc0204b4a <vprintfmt+0x78>
            goto reswitch;
ffffffffc0204d02:	00144603          	lbu	a2,1(s0)
            padc = '0';
ffffffffc0204d06:	03000793          	li	a5,48
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204d0a:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204d0c:	bd3d                	j	ffffffffc0204b4a <vprintfmt+0x78>
                precision = precision * 10 + ch - '0';
ffffffffc0204d0e:	fd060c9b          	addiw	s9,a2,-48
                ch = *fmt;
ffffffffc0204d12:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204d16:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0204d18:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0204d1c:	0006089b          	sext.w	a7,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204d20:	fcd56ce3          	bltu	a0,a3,ffffffffc0204cf8 <vprintfmt+0x226>
            for (precision = 0; ; ++ fmt) {
ffffffffc0204d24:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0204d26:	002c969b          	slliw	a3,s9,0x2
                ch = *fmt;
ffffffffc0204d2a:	00044603          	lbu	a2,0(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0204d2e:	0196873b          	addw	a4,a3,s9
ffffffffc0204d32:	0017171b          	slliw	a4,a4,0x1
ffffffffc0204d36:	0117073b          	addw	a4,a4,a7
                if (ch < '0' || ch > '9') {
ffffffffc0204d3a:	fd06069b          	addiw	a3,a2,-48
                precision = precision * 10 + ch - '0';
ffffffffc0204d3e:	fd070c9b          	addiw	s9,a4,-48
                ch = *fmt;
ffffffffc0204d42:	0006089b          	sext.w	a7,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204d46:	fcd57fe3          	bleu	a3,a0,ffffffffc0204d24 <vprintfmt+0x252>
ffffffffc0204d4a:	b77d                	j	ffffffffc0204cf8 <vprintfmt+0x226>
            if (width < 0)
ffffffffc0204d4c:	fffdc693          	not	a3,s11
ffffffffc0204d50:	96fd                	srai	a3,a3,0x3f
ffffffffc0204d52:	00ddfdb3          	and	s11,s11,a3
ffffffffc0204d56:	00144603          	lbu	a2,1(s0)
ffffffffc0204d5a:	2d81                	sext.w	s11,s11
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204d5c:	846a                	mv	s0,s10
ffffffffc0204d5e:	b3f5                	j	ffffffffc0204b4a <vprintfmt+0x78>
            putch('%', putdat);
ffffffffc0204d60:	85a6                	mv	a1,s1
ffffffffc0204d62:	02500513          	li	a0,37
ffffffffc0204d66:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0204d68:	fff44703          	lbu	a4,-1(s0)
ffffffffc0204d6c:	02500793          	li	a5,37
ffffffffc0204d70:	8d22                	mv	s10,s0
ffffffffc0204d72:	d8f70de3          	beq	a4,a5,ffffffffc0204b0c <vprintfmt+0x3a>
ffffffffc0204d76:	02500713          	li	a4,37
ffffffffc0204d7a:	1d7d                	addi	s10,s10,-1
ffffffffc0204d7c:	fffd4783          	lbu	a5,-1(s10)
ffffffffc0204d80:	fee79de3          	bne	a5,a4,ffffffffc0204d7a <vprintfmt+0x2a8>
ffffffffc0204d84:	b361                	j	ffffffffc0204b0c <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0204d86:	00002617          	auipc	a2,0x2
ffffffffc0204d8a:	2fa60613          	addi	a2,a2,762 # ffffffffc0207080 <error_string+0xd8>
ffffffffc0204d8e:	85a6                	mv	a1,s1
ffffffffc0204d90:	854a                	mv	a0,s2
ffffffffc0204d92:	0ac000ef          	jal	ra,ffffffffc0204e3e <printfmt>
ffffffffc0204d96:	bb9d                	j	ffffffffc0204b0c <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0204d98:	00002617          	auipc	a2,0x2
ffffffffc0204d9c:	2e060613          	addi	a2,a2,736 # ffffffffc0207078 <error_string+0xd0>
            if (width > 0 && padc != '-') {
ffffffffc0204da0:	00002417          	auipc	s0,0x2
ffffffffc0204da4:	2d940413          	addi	s0,s0,729 # ffffffffc0207079 <error_string+0xd1>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204da8:	8532                	mv	a0,a2
ffffffffc0204daa:	85e6                	mv	a1,s9
ffffffffc0204dac:	e032                	sd	a2,0(sp)
ffffffffc0204dae:	e43e                	sd	a5,8(sp)
ffffffffc0204db0:	0cc000ef          	jal	ra,ffffffffc0204e7c <strnlen>
ffffffffc0204db4:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0204db8:	6602                	ld	a2,0(sp)
ffffffffc0204dba:	01b05d63          	blez	s11,ffffffffc0204dd4 <vprintfmt+0x302>
ffffffffc0204dbe:	67a2                	ld	a5,8(sp)
ffffffffc0204dc0:	2781                	sext.w	a5,a5
ffffffffc0204dc2:	e43e                	sd	a5,8(sp)
                    putch(padc, putdat);
ffffffffc0204dc4:	6522                	ld	a0,8(sp)
ffffffffc0204dc6:	85a6                	mv	a1,s1
ffffffffc0204dc8:	e032                	sd	a2,0(sp)
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204dca:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0204dcc:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204dce:	6602                	ld	a2,0(sp)
ffffffffc0204dd0:	fe0d9ae3          	bnez	s11,ffffffffc0204dc4 <vprintfmt+0x2f2>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204dd4:	00064783          	lbu	a5,0(a2)
ffffffffc0204dd8:	0007851b          	sext.w	a0,a5
ffffffffc0204ddc:	e8051be3          	bnez	a0,ffffffffc0204c72 <vprintfmt+0x1a0>
ffffffffc0204de0:	b335                	j	ffffffffc0204b0c <vprintfmt+0x3a>
        return va_arg(*ap, int);
ffffffffc0204de2:	000aa403          	lw	s0,0(s5)
ffffffffc0204de6:	bbf1                	j	ffffffffc0204bc2 <vprintfmt+0xf0>
        return va_arg(*ap, unsigned int);
ffffffffc0204de8:	000ae603          	lwu	a2,0(s5)
ffffffffc0204dec:	46a9                	li	a3,10
ffffffffc0204dee:	8aae                	mv	s5,a1
ffffffffc0204df0:	bd89                	j	ffffffffc0204c42 <vprintfmt+0x170>
ffffffffc0204df2:	000ae603          	lwu	a2,0(s5)
ffffffffc0204df6:	46c1                	li	a3,16
ffffffffc0204df8:	8aae                	mv	s5,a1
ffffffffc0204dfa:	b5a1                	j	ffffffffc0204c42 <vprintfmt+0x170>
ffffffffc0204dfc:	000ae603          	lwu	a2,0(s5)
ffffffffc0204e00:	46a1                	li	a3,8
ffffffffc0204e02:	8aae                	mv	s5,a1
ffffffffc0204e04:	bd3d                	j	ffffffffc0204c42 <vprintfmt+0x170>
                    putch(ch, putdat);
ffffffffc0204e06:	9902                	jalr	s2
ffffffffc0204e08:	b559                	j	ffffffffc0204c8e <vprintfmt+0x1bc>
                putch('-', putdat);
ffffffffc0204e0a:	85a6                	mv	a1,s1
ffffffffc0204e0c:	02d00513          	li	a0,45
ffffffffc0204e10:	e03e                	sd	a5,0(sp)
ffffffffc0204e12:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0204e14:	8ace                	mv	s5,s3
ffffffffc0204e16:	40800633          	neg	a2,s0
ffffffffc0204e1a:	46a9                	li	a3,10
ffffffffc0204e1c:	6782                	ld	a5,0(sp)
ffffffffc0204e1e:	b515                	j	ffffffffc0204c42 <vprintfmt+0x170>
            if (width > 0 && padc != '-') {
ffffffffc0204e20:	01b05663          	blez	s11,ffffffffc0204e2c <vprintfmt+0x35a>
ffffffffc0204e24:	02d00693          	li	a3,45
ffffffffc0204e28:	f6d798e3          	bne	a5,a3,ffffffffc0204d98 <vprintfmt+0x2c6>
ffffffffc0204e2c:	00002417          	auipc	s0,0x2
ffffffffc0204e30:	24d40413          	addi	s0,s0,589 # ffffffffc0207079 <error_string+0xd1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204e34:	02800513          	li	a0,40
ffffffffc0204e38:	02800793          	li	a5,40
ffffffffc0204e3c:	bd1d                	j	ffffffffc0204c72 <vprintfmt+0x1a0>

ffffffffc0204e3e <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204e3e:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0204e40:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204e44:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204e46:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204e48:	ec06                	sd	ra,24(sp)
ffffffffc0204e4a:	f83a                	sd	a4,48(sp)
ffffffffc0204e4c:	fc3e                	sd	a5,56(sp)
ffffffffc0204e4e:	e0c2                	sd	a6,64(sp)
ffffffffc0204e50:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0204e52:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204e54:	c7fff0ef          	jal	ra,ffffffffc0204ad2 <vprintfmt>
}
ffffffffc0204e58:	60e2                	ld	ra,24(sp)
ffffffffc0204e5a:	6161                	addi	sp,sp,80
ffffffffc0204e5c:	8082                	ret

ffffffffc0204e5e <strlen>:
...
ffffffffc0204e62:	cb91                	beqz	a5,ffffffffc0204e76 <strlen+0x18>
    size_t cnt = 0;
ffffffffc0204e64:	4781                	li	a5,0
        cnt ++;
ffffffffc0204e66:	0785                	addi	a5,a5,1
    while (*s ++ != '\0') {
ffffffffc0204e68:	00f50733          	add	a4,a0,a5
ffffffffc0204e6c:	00074703          	lbu	a4,0(a4)
ffffffffc0204e70:	fb7d                	bnez	a4,ffffffffc0204e66 <strlen+0x8>
    }
    return cnt;
}
ffffffffc0204e72:	853e                	mv	a0,a5
ffffffffc0204e74:	8082                	ret
    size_t cnt = 0;
ffffffffc0204e76:	4781                	li	a5,0
}
ffffffffc0204e78:	853e                	mv	a0,a5
ffffffffc0204e7a:	8082                	ret

ffffffffc0204e7c <strnlen>:
 * pointed by @s.
 * */
size_t
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e7c:	c185                	beqz	a1,ffffffffc0204e9c <strnlen+0x20>
ffffffffc0204e7e:	00054783          	lbu	a5,0(a0)
ffffffffc0204e82:	cf89                	beqz	a5,ffffffffc0204e9c <strnlen+0x20>
    size_t cnt = 0;
ffffffffc0204e84:	4781                	li	a5,0
ffffffffc0204e86:	a021                	j	ffffffffc0204e8e <strnlen+0x12>
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e88:	00074703          	lbu	a4,0(a4)
ffffffffc0204e8c:	c711                	beqz	a4,ffffffffc0204e98 <strnlen+0x1c>
        cnt ++;
ffffffffc0204e8e:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e90:	00f50733          	add	a4,a0,a5
ffffffffc0204e94:	fef59ae3          	bne	a1,a5,ffffffffc0204e88 <strnlen+0xc>
    }
    return cnt;
}
...
ffffffffc0204e9e:	853e                	mv	a0,a5
ffffffffc0204ea0:	8082                	ret

ffffffffc0204ea2 <strcpy>:
char *
...
#else
    char *p = dst;
ffffffffc0204ea2:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc0204ea4:	0585                	addi	a1,a1,1
ffffffffc0204ea6:	fff5c703          	lbu	a4,-1(a1)
ffffffffc0204eaa:	0785                	addi	a5,a5,1
ffffffffc0204eac:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0204eb0:	fb75                	bnez	a4,ffffffffc0204ea4 <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc0204ebc:	cb91                	beqz	a5,ffffffffc0204ed0 <strcmp+0x1c>
ffffffffc0204ebe:	00e79c63          	bne	a5,a4,ffffffffc0204ed6 <strcmp+0x22>
        s1 ++, s2 ++;
ffffffffc0204ec2:	0505                	addi	a0,a0,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204ec4:	00054783          	lbu	a5,0(a0)
        s1 ++, s2 ++;
ffffffffc0204ec8:	0585                	addi	a1,a1,1
ffffffffc0204eca:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204ece:	fbe5                	bnez	a5,ffffffffc0204ebe <strcmp+0xa>
    }
...
ffffffffc0204ed6:	0007851b          	sext.w	a0,a5
ffffffffc0204eda:	9d19                	subw	a0,a0,a4
ffffffffc0204edc:	8082                	ret

ffffffffc0204ede <strchr>:
...
strchr(const char *s, char c) {
    while (*s != '\0') {
ffffffffc0204ede:	00054783          	lbu	a5,0(a0)
ffffffffc0204ee2:	cb91                	beqz	a5,ffffffffc0204ef6 <strchr+0x18>
        if (*s == c) {
ffffffffc0204ee4:	00b79563          	bne	a5,a1,ffffffffc0204eee <strchr+0x10>
ffffffffc0204ee8:	a809                	j	ffffffffc0204efa <strchr+0x1c>
ffffffffc0204eea:	00b78763          	beq	a5,a1,ffffffffc0204ef8 <strchr+0x1a>
            return (char *)s;
        }
        s ++;
ffffffffc0204eee:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0204ef0:	00054783          	lbu	a5,0(a0)
ffffffffc0204ef4:	fbfd                	bnez	a5,ffffffffc0204eea <strchr+0xc>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0204efc:	ca01                	beqz	a2,ffffffffc0204f0c <memset+0x10>
ffffffffc0204efe:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0204f00:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0204f02:	0785                	addi	a5,a5,1
ffffffffc0204f04:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0204f08:	fec79de3          	bne	a5,a2,ffffffffc0204f02 <memset+0x6>
    }
    return s;
...
ffffffffc0204f0e <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0204f0e:	ca19                	beqz	a2,ffffffffc0204f24 <memcpy+0x16>
ffffffffc0204f10:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc0204f12:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc0204f14:	0585                	addi	a1,a1,1
ffffffffc0204f16:	fff5c703          	lbu	a4,-1(a1)
ffffffffc0204f1a:	0785                	addi	a5,a5,1
ffffffffc0204f1c:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0204f20:	fec59ae3          	bne	a1,a2,ffffffffc0204f14 <memcpy+0x6>
    }
    return dst;
#endif /* __HAVE_ARCH_MEMCPY */
}
ffffffffc0204f24:	8082                	ret

ffffffffc0204f26 <memcmp>:
 * */
int
memcmp(const void *v1, const void *v2, size_t n) {
    ...
    while (n -- > 0) {
ffffffffc0204f26:	c21d                	beqz	a2,ffffffffc0204f4c <memcmp+0x26>
        if (*s1 != *s2) {
ffffffffc0204f28:	00054783          	lbu	a5,0(a0)
ffffffffc0204f2c:	0005c703          	lbu	a4,0(a1)
ffffffffc0204f30:	962a                	add	a2,a2,a0
ffffffffc0204f32:	00f70963          	beq	a4,a5,ffffffffc0204f44 <memcmp+0x1e>
ffffffffc0204f36:	a829                	j	ffffffffc0204f50 <memcmp+0x2a>
ffffffffc0204f38:	00054783          	lbu	a5,0(a0)
ffffffffc0204f3c:	0005c703          	lbu	a4,0(a1)
ffffffffc0204f40:	00e79863          	bne	a5,a4,ffffffffc0204f50 <memcmp+0x2a>
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
        }
        s1 ++, s2 ++;
ffffffffc0204f44:	0505                	addi	a0,a0,1
ffffffffc0204f46:	0585                	addi	a1,a1,1
    while (n -- > 0) {
ffffffffc0204f48:	fea618e3          	bne	a2,a0,ffffffffc0204f38 <memcmp+0x12>
    }
    return 0;
ffffffffc0204f4c:	4501                	li	a0,0
}
ffffffffc0204f4e:	8082                	ret
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204f50:	40e7853b          	subw	a0,a5,a4
